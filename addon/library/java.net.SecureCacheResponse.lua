...
function SecureCacheResponse.getCipherSuite() end
...
function SecureCacheResponse.getLocalCertificateChain() end

---@return java.util.List # an immutable List of Certificate representing the server's         certificate chain.
function SecureCacheResponse.getServerCertificateChain() end
...
function SecureCacheResponse.getPeerPrincipal() end
