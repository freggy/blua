...
function FallbackLocaleProviderAdapter.getAdapterType() end

---@param locale java.util.Locale 
---@return sun.util.locale.provider.LocaleResources # 
function FallbackLocaleProviderAdapter.getLocaleResources(locale) end

---@param category java.lang.String 
---@return java.util.Set # 
function FallbackLocaleProviderAdapter.createLanguageTagSet(category) end

---@param locale java.util.Locale 
---@param langtags java.util.Set 
---@return boolean # 
function FallbackLocaleProviderAdapter.isSupportedProviderLocale(locale,langtags) end
