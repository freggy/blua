...
function AnnotationSupport.getDirectlyAndIndirectlyPresent(annotations,annoClass) end
...
function AnnotationSupport.getIndirectlyPresent(annotations,annoClass) end
...
function AnnotationSupport.containerBeforeContainee(annotations,annoClass) end
...
---@param annoClass java.lang.Class the type of annotation to search for
---@return A[] # an array of instances of {@code annoClass} or an empty array if none were found.
function AnnotationSupport.getAssociatedAnnotations(declaredAnnotations,decl,annoClass) end

---@param container java.lang.annotation.Annotation 
---@return A[] # 
function AnnotationSupport.getValueArray(container) end
...
function AnnotationSupport.invalidContainerException(anno,cause) end

---@param annotations A[] 
---@param container java.lang.annotation.Annotation 
---@param annoClass java.lang.Class 
---@return void # 
function AnnotationSupport.checkTypes(annotations,container,annoClass) end

---@param a java.lang.annotation.Annotation 
---@return java.util.Map # a map from element names to element values
function AnnotationSupport.memberValues(a) end
