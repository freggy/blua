...
function PBKDF2Core.engineGenerateSecret(keySpec) end
...
function PBKDF2Core.engineGetKeySpec(key,keySpecCl) end
...
function PBKDF2Core.engineTranslateKey(key) end
