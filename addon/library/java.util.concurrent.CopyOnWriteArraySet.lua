...
function CopyOnWriteArraySet.size() end

---@return boolean # {@code true} if this set contains no elements
function CopyOnWriteArraySet.isEmpty() end
...
function CopyOnWriteArraySet.contains(o) end

---@return Object[] # an array containing all the elements in this set
function CopyOnWriteArraySet.toArray() end
...
function CopyOnWriteArraySet.toArray(a) end

---@return void # 
function CopyOnWriteArraySet.clear() end
...
function CopyOnWriteArraySet.remove(o) end
...
function CopyOnWriteArraySet.add(e) end
...
function CopyOnWriteArraySet.containsAll(c) end
...
function CopyOnWriteArraySet.compareSets(snapshot,set) end
...
function CopyOnWriteArraySet.equals(o) end

---@param filter java.util.function.Predicate 
---@return boolean # 
function CopyOnWriteArraySet.removeIf(filter) end

---@param action java.util.function.Consumer 
---@return void # 
function CopyOnWriteArraySet.forEach(action) end

---@return java.util.Spliterator # a {@code Spliterator} over the elements in this set
function CopyOnWriteArraySet.spliterator() end
