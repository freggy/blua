...
---@return void # 
function CookieStore.add(uri,cookie) end
...
function CookieStore.getURIs() end
...
function CookieStore.remove(uri,cookie) end

---@return boolean # {@code true} if this store changed as a result of the call
function CookieStore.removeAll() end
