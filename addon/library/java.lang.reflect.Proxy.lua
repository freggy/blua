...
function Proxy.getProxyClass(loader,interfaces) end
...
function Proxy.getProxyConstructor(caller,loader,interfaces) end

---@param caller java.lang.Class 
---@param loader java.lang.ClassLoader 
---@param interfaces java.lang.Class 
---@return void # 
function Proxy.checkProxyAccess(caller,loader,interfaces) end
...
function Proxy.newProxyInstance(loader,interfaces,h) end

---@param caller java.lang.Class 
---@param cons java.lang.reflect.Constructor 
---@param h java.lang.reflect.InvocationHandler 
---@return java.lang.Object # 
function Proxy.newProxyInstance(caller,cons,h) end

---@param caller java.lang.Class 
---@param proxyClass java.lang.Class 
---@return void # 
function Proxy.checkNewProxyPermission(caller,proxyClass) end

---@param m java.lang.Module 
---@return java.lang.ClassLoader # 
function Proxy.getLoader(m) end
...
function Proxy.isProxyClass(cl) end
...
function Proxy.getInvocationHandler(proxy) end

---@param proxyClass java.lang.Class 
---@return java.util.concurrent.ConcurrentHashMap # 
function Proxy.defaultMethodMap(proxyClass) end

---@param proxyClass java.lang.Class 
---@param method java.lang.reflect.Method 
---@return java.lang.invoke.MethodHandle # 
function Proxy.defaultMethodHandle(proxyClass,method) end

---@param proxyClass java.lang.Class 
---@param method java.lang.reflect.Method 
---@return java.lang.Class # 
function Proxy.findProxyInterfaceOrElseThrow(proxyClass,method) end
...
function Proxy.proxyClassLookup(caller,proxyClass) end
...
---@param caller java.lang.Class 
---@return java.lang.Object # 
function Proxy.invokeDefault(proxy,method,args,caller) end
