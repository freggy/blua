...
---@return void # 
function MethodVisitor.visitParameter(name,access) end
...
function MethodVisitor.visitAnnotationDefault() end
...
function MethodVisitor.visitAnnotation(descriptor,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function MethodVisitor.visitTypeAnnotation(typeRef,typePath,descriptor,visible) end
...
---@return void # 
function MethodVisitor.visitAnnotableParameterCount(parameterCount,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function MethodVisitor.visitParameterAnnotation(parameter,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute an attribute.
---@return void # 
function MethodVisitor.visitAttribute(attribute) end

---@return void # 
function MethodVisitor.visitCode() end
...
---@return void # 
function MethodVisitor.visitFrame(type,numLocal,local,numStack,stack) end
...
---@return void # 
function MethodVisitor.visitInsn(opcode) end
...
---@return void # 
function MethodVisitor.visitIntInsn(opcode,operand) end
...
---@return void # 
function MethodVisitor.visitVarInsn(opcode,varIndex) end
...
---@return void # 
function MethodVisitor.visitTypeInsn(opcode,type) end
...
---@return void # 
function MethodVisitor.visitFieldInsn(opcode,owner,name,descriptor) end
...
---@return void # 
function MethodVisitor.visitMethodInsn(opcode,owner,name,descriptor) end
...
---@return void # 
function MethodVisitor.visitMethodInsn(opcode,owner,name,descriptor,isInterface) end
...
---@return void # 
function MethodVisitor.visitInvokeDynamicInsn(name,descriptor,bootstrapMethodHandle,bootstrapMethodArguments) end
...
---@return void # 
function MethodVisitor.visitJumpInsn(opcode,label) end

---@param label jdk.internal.org.objectweb.asm.Label a {@link Label} object.
---@return void # 
function MethodVisitor.visitLabel(label) end
...
---@return void # 
function MethodVisitor.visitLdcInsn(value) end
...
---@return void # 
function MethodVisitor.visitIincInsn(varIndex,increment) end
...
---@return void # 
function MethodVisitor.visitTableSwitchInsn(min,max,dflt,labels) end
...
---@return void # 
function MethodVisitor.visitLookupSwitchInsn(dflt,keys,labels) end
...
---@return void # 
function MethodVisitor.visitMultiANewArrayInsn(descriptor,numDimensions) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function MethodVisitor.visitInsnAnnotation(typeRef,typePath,descriptor,visible) end
...
---@return void # 
function MethodVisitor.visitTryCatchBlock(start,end,handler,type) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function MethodVisitor.visitTryCatchAnnotation(typeRef,typePath,descriptor,visible) end
...
---@return void # 
function MethodVisitor.visitLocalVariable(name,descriptor,signature,start,end,index) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function MethodVisitor.visitLocalVariableAnnotation(typeRef,typePath,start,end,index,descriptor,visible) end
...
---@return void # 
function MethodVisitor.visitLineNumber(line,start) end

---@param maxStack int maximum stack size of the method.
---@param maxLocals int maximum number of local variables for the method.
---@return void # 
function MethodVisitor.visitMaxs(maxStack,maxLocals) end

---@return void # 
function MethodVisitor.visitEnd() end
