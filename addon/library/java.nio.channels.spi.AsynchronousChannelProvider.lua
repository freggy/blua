...
function AsynchronousChannelProvider.openAsynchronousChannelGroup(nThreads,threadFactory) end
...
---@return java.nio.channels.AsynchronousChannelGroup # A new asynchronous channel group
function AsynchronousChannelProvider.openAsynchronousChannelGroup(executor,initialSize) end
...
function AsynchronousChannelProvider.openAsynchronousServerSocketChannel(group) end

---@param group java.nio.channels.AsynchronousChannelGroup The group to which the channel is bound, or {@code null} to          bind to the default group
---@return java.nio.channels.AsynchronousSocketChannel # The new channel
function AsynchronousChannelProvider.openAsynchronousSocketChannel(group) end
