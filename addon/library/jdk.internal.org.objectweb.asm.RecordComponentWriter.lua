...
function RecordComponentWriter.visitAnnotation(descriptor,visible) end
...
---@param visible boolean 
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # 
function RecordComponentWriter.visitTypeAnnotation(typeRef,typePath,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute 
---@return void # 
function RecordComponentWriter.visitAttribute(attribute) end

---@return void # 
function RecordComponentWriter.visitEnd() end

---@return int # the size in bytes of the record_component_info of the Record attribute.
function RecordComponentWriter.computeRecordComponentInfoSize() end

---@param output jdk.internal.org.objectweb.asm.ByteVector where the record_component_info structure must be put.
---@return void # 
function RecordComponentWriter.putRecordComponentInfo(output) end

---@param attributePrototypes jdk.internal.org.objectweb.asm.Attribute.Set a set of attribute prototypes.
---@return void # 
function RecordComponentWriter.collectAttributePrototypes(attributePrototypes) end
