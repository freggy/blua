...
---@return void # 
function PBEWithMD5AndDESCipher.engineSetMode(mode) end

---@param paddingScheme java.lang.String the padding mechanism
---@return void # 
function PBEWithMD5AndDESCipher.engineSetPadding(paddingScheme) end

---@return int # the block size (in bytes)
function PBEWithMD5AndDESCipher.engineGetBlockSize() end

---@param inputLen int the input length (in bytes)
---@return int # the required output buffer size (in bytes)
function PBEWithMD5AndDESCipher.engineGetOutputSize(inputLen) end
...
function PBEWithMD5AndDESCipher.engineGetIV() end
...
function PBEWithMD5AndDESCipher.engineGetParameters() end
...
---@return void # 
function PBEWithMD5AndDESCipher.engineInit(opmode,key,random) end
...
---@param random java.security.SecureRandom the source of randomness
---@return void # 
function PBEWithMD5AndDESCipher.engineInit(opmode,key,params,random) end
...
function PBEWithMD5AndDESCipher.engineUpdate(input,inputOffset,inputLen) end
...
function PBEWithMD5AndDESCipher.engineUpdate(input,inputOffset,inputLen,output,outputOffset) end

---@param input byte[] the input buffer
---@param inputOffset int the offset in <code>input</code> where the input starts
---@param inputLen int the input length
---@return byte[] # the new buffer with the result
function PBEWithMD5AndDESCipher.engineDoFinal(input,inputOffset,inputLen) end
...
---@param outputOffset int the offset in <code>output</code> where the result is stored
---@return int # the number of bytes stored in <code>output</code>
function PBEWithMD5AndDESCipher.engineDoFinal(input,inputOffset,inputLen,output,outputOffset) end

---@param key java.security.Key the key object.
---@return int # the key size of the given key object.
function PBEWithMD5AndDESCipher.engineGetKeySize(key) end

---@param key java.security.Key the key to be wrapped.
---@return byte[] # the wrapped key.
function PBEWithMD5AndDESCipher.engineWrap(key) end
...
function PBEWithMD5AndDESCipher.engineUnwrap(wrappedKey,wrappedKeyAlgorithm,wrappedKeyType) end
