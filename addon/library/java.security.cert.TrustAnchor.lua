...
function TrustAnchor.getTrustedCert() end
...
function TrustAnchor.getCA() end
...
function TrustAnchor.getCAName() end
...
function TrustAnchor.getCAPublicKey() end

---@param bytes byte[] 
---@return void # 
function TrustAnchor.setNameConstraints(bytes) end
...
function TrustAnchor.getNameConstraints() end

---@return java.lang.String # a formatted string describing the {@code TrustAnchor}
function TrustAnchor.toString() end

---@return boolean # 
function TrustAnchor.isJdkCA() end
