...
function ClassHierarchyImpl.resolve(classDesc) end
...
function ClassHierarchyImpl.isInterface(classDesc) end
...
function ClassHierarchyImpl.commonAncestor(symbol1,symbol2) end

---@param thisClass java.lang.constant.ClassDesc 
---@param fromClass java.lang.constant.ClassDesc 
---@return boolean # 
function ClassHierarchyImpl.isAssignableFrom(thisClass,fromClass) end
