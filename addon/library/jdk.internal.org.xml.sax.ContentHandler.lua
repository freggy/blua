...
---@return void # 
function ContentHandler.setDocumentLocator(locator) end

---@return void # 
function ContentHandler.startDocument() end

---@return void # 
function ContentHandler.endDocument() end
...
---@return void # 
function ContentHandler.startPrefixMapping(prefix,uri) end
...
---@return void # 
function ContentHandler.endPrefixMapping(prefix) end
...
---@return void # 
function ContentHandler.startElement(uri,localName,qName,atts) end

---@param uri java.lang.String the Namespace URI, or the empty string if the        element has no Namespace URI or if Namespace        processing is not being performed
---@param localName java.lang.String the local name (without prefix), or the        empty string if Namespace processing is not being        performed
---@param qName java.lang.String the qualified XML name (with prefix), or the        empty string if qualified names are not available
---@return void # 
function ContentHandler.endElement(uri,localName,qName) end
...
---@return void # 
function ContentHandler.characters(ch,start,length) end

---@param ch char[] the characters from the XML document
---@param start int the start position in the array
---@param length int the number of characters to read from the array
---@return void # 
function ContentHandler.ignorableWhitespace(ch,start,length) end
...
---@return void # 
function ContentHandler.processingInstruction(target,data) end
...
---@return void # 
function ContentHandler.skippedEntity(name) end
