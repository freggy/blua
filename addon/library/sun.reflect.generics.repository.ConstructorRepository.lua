...
function ConstructorRepository.parse(s) end
...
function ConstructorRepository.make(rawSig,f) end

---@return Type[] # 
function ConstructorRepository.getParameterTypes() end

---@return Type[] # 
function ConstructorRepository.getExceptionTypes() end

---@return Type[] # 
function ConstructorRepository.computeParameterTypes() end

---@return Type[] # 
function ConstructorRepository.computeExceptionTypes() end
