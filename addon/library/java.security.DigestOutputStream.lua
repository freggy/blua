...
---@return void # 
function DigestOutputStream.write(b,off,len) end

---@param on boolean {@code true} to turn the digest function on, {@code false} to turn it off.
---@return void # 
function DigestOutputStream.on(on) end

---@return java.lang.String # 
function DigestOutputStream.toString() end
