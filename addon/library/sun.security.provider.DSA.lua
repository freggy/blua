...
---@return void # 
function DSA.checkKey(params,digestLen,mdAlgo) end

---@param privateKey java.security.PrivateKey the DSA private key
---@return void # 
function DSA.engineInitSign(privateKey) end

---@param publicKey java.security.PublicKey the DSA public key.
---@return void # 
function DSA.engineInitVerify(publicKey) end

---@param b byte 
---@return void # 
function DSA.engineUpdate(b) end

---@param data byte[] 
---@param off int 
---@param len int 
---@return void # 
function DSA.engineUpdate(data,off,len) end
...
---@return boolean # 
function DSA.engineVerify(signature,offset,length) end

---@param key java.lang.String 
---@param param java.lang.Object 
---@return void # 
function DSA.engineSetParameter(key,param) end

---@param params java.security.spec.AlgorithmParameterSpec 
---@return void # 
function DSA.engineSetParameter(params) end

---@param key java.lang.String 
---@return java.lang.Object # 
function DSA.engineGetParameter(key) end

---@return java.security.AlgorithmParameters # 
function DSA.engineGetParameters() end
...
function DSA.generateR(p,q,g,k) end
...
---@param k java.math.BigInteger 
---@return java.math.BigInteger # 
function DSA.generateS(x,q,r,k) end
...
---@return java.math.BigInteger # 
function DSA.generateW(p,q,g,s) end
...
---@param r java.math.BigInteger 
---@return java.math.BigInteger # 
function DSA.generateV(y,p,q,g,w,r) end

---@param q java.math.BigInteger 
---@return java.math.BigInteger # 
function DSA.generateK(q) end

---@return java.security.SecureRandom # 
function DSA.getSigningRandom() end

---@return java.lang.String # 
function DSA.toString() end
