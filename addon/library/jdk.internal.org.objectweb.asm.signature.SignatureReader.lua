...
---@return void # 
function SignatureReader.accept(signatureVistor) end
...
---@return void # 
function SignatureReader.acceptType(signatureVisitor) end
...
function SignatureReader.parseType(signature,startOffset,signatureVisitor) end
