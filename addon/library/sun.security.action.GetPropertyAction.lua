...
function GetPropertyAction.run() end

---@param theProp java.lang.String the name of the system property.
---@return java.lang.String # 
function GetPropertyAction.privilegedGetProperty(theProp) end

---@param theProp java.lang.String the name of the system property.
---@param defaultVal java.lang.String the default value.
---@return java.lang.String # 
function GetPropertyAction.privilegedGetProperty(theProp,defaultVal) end

---@return java.util.Properties # 
function GetPropertyAction.privilegedGetProperties() end
...
function GetPropertyAction.privilegedGetTimeoutProp(prop,def,dbg) end
