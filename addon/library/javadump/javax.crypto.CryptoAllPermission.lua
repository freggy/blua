...
function CryptoAllPermission.implies(self, p) end
...
function CryptoAllPermission.equals(self, obj) end

---@return int # a hash code value for this object.
function CryptoAllPermission.hashCode(self, ) end
...
function CryptoAllPermission.newPermissionCollection(self, ) end
