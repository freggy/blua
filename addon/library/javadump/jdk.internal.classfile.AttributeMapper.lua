...
function AttributeMapper.name(self, ) end
...
function AttributeMapper.readAttribute(self, enclosing,cf,pos) end
...
---@return void # 
function AttributeMapper.writeAttribute(self, buf,attr) end

---@return int # 
function AttributeMapper.validSince(self, ) end

---@return boolean # 
function AttributeMapper.allowMultiple(self, ) end
