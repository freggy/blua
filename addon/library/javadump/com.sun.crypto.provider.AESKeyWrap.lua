...
function AESKeyWrap.getFeedback() end

---@return void # 
function AESKeyWrap.save() end

---@return void # 
function AESKeyWrap.restore() end
...
---@return void # 
function AESKeyWrap.init(decrypting,algorithm,key,iv) end

---@return void # 
function AESKeyWrap.reset() end
...
---@param ctOfs int 
---@return int # 
function AESKeyWrap.encrypt(pt,ptOfs,ptLen,ct,ctOfs) end
...
---@param ptOfs int 
---@return int # 
function AESKeyWrap.decrypt(ct,ctOfs,ctLen,pt,ptOfs) end
...
function AESKeyWrap.encryptFinal(pt,dummy1,ptLen,dummy2,dummy3) end
...
function AESKeyWrap.decryptFinal(ct,dummy1,ctLen,dummy2,dummy3) end
