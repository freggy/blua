...
---@return void # 
function DESedeWrapCipher.engineSetMode(self, mode) end

---@param padding java.lang.String the padding mechanism.
---@return void # 
function DESedeWrapCipher.engineSetPadding(self, padding) end

---@return int # the block size (in bytes), i.e. 8 bytes.
function DESedeWrapCipher.engineGetBlockSize(self, ) end

---@param inputLen int the input length (in bytes).
---@return int # the required output buffer size (in bytes).
function DESedeWrapCipher.engineGetOutputSize(self, inputLen) end
...
function DESedeWrapCipher.engineGetIV(self, ) end
...
---@return void # 
function DESedeWrapCipher.engineInit(self, opmode,key,random) end
...
---@param random java.security.SecureRandom the source of randomness.
---@return void # 
function DESedeWrapCipher.engineInit(self, opmode,key,params,random) end
...
---@return byte[] # n/a.
function DESedeWrapCipher.engineUpdate(self, in,inOffset,inLen) end
...
---@return int # n/a.
function DESedeWrapCipher.engineUpdate(self, in,inOffset,inLen,out,outOffset) end

---@param in byte[] the input buffer.
---@param inOffset int the offset in <code>in</code> where the input starts.
---@param inLen int the input length.
---@return byte[] # the new buffer with the result.
function DESedeWrapCipher.engineDoFinal(self, in,inOffset,inLen) end
...
function DESedeWrapCipher.engineUnwrap(self, wrappedKey,wrappedKeyAlgorithm,wrappedKeyType) end

---@param in byte[] 
---@return byte[] # 
function DESedeWrapCipher.getChecksum(self, in) end

---@param in byte[] 
---@param offset int 
---@param len int 
---@return byte[] # 
function DESedeWrapCipher.getChecksum(self, in,offset,len) end
