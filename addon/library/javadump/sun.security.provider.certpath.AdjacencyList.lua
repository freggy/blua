...
function AdjacencyList.iterator() end

---@return int # 
function AdjacencyList.numAttemptedPaths() end

---@param theList java.util.List 
---@param index int 
---@param follow sun.security.provider.certpath.BuildStep 
---@return boolean # 
function AdjacencyList.buildList(theList,index,follow) end

---@return java.lang.String # String representation
function AdjacencyList.toString() end
