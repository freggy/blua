...
function KeyStoreSpi.engineGetKey(self, alias,password) end
...
function KeyStoreSpi.engineGetCertificateChain(self, alias) end
...
function KeyStoreSpi.engineGetCertificate(self, alias) end

---@param alias java.lang.String the alias name
---@return java.util.Date # the creation date of this entry, or {@code null} if the given alias does not exist
function KeyStoreSpi.engineGetCreationDate(self, alias) end
...
---@return void # 
function KeyStoreSpi.engineSetKeyEntry(self, alias,key,password,chain) end
...
---@return void # 
function KeyStoreSpi.engineSetKeyEntry(self, alias,key,chain) end

---@param alias java.lang.String the alias name
---@param cert java.security.cert.Certificate the certificate
---@return void # 
function KeyStoreSpi.engineSetCertificateEntry(self, alias,cert) end

---@param alias java.lang.String the alias name
---@return void # 
function KeyStoreSpi.engineDeleteEntry(self, alias) end

---@return java.util.Enumeration # enumeration of the alias names
function KeyStoreSpi.engineAliases(self, ) end

---@param alias java.lang.String the alias name
---@return boolean # {@code true} if the alias exists, {@code false} otherwise
function KeyStoreSpi.engineContainsAlias(self, alias) end

---@return int # the number of entries in this keystore
function KeyStoreSpi.engineSize(self, ) end
...
function KeyStoreSpi.engineGetCertificateAlias(self, cert) end
...
---@return void # 
function KeyStoreSpi.engineStore(self, stream,password) end
...
---@return void # 
function KeyStoreSpi.engineStore(self, param) end
...
---@return void # 
function KeyStoreSpi.engineLoad(self, stream,password) end
...
---@return void # 
function KeyStoreSpi.engineLoad(self, param) end

---@param stream java.io.InputStream 
---@param param java.security.KeyStore.LoadStoreParameter 
---@return void # 
function KeyStoreSpi.engineLoad(self, stream,param) end
...
function KeyStoreSpi.engineGetAttributes(self, alias) end
...
function KeyStoreSpi.engineGetEntry(self, alias,protParam) end
...
---@param protParam java.security.KeyStore.ProtectionParameter the {@code ProtectionParameter}          used to protect the {@code Entry},          which may be {@code null}
---@return void # 
function KeyStoreSpi.engineSetEntry(self, alias,entry,protParam) end
...
function KeyStoreSpi.engineEntryInstanceOf(self, alias,entryClass) end
...
function KeyStoreSpi.engineProbe(self, stream) end
