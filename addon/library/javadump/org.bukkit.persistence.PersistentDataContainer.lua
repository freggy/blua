...
---@return void # 
function PersistentDataContainer.set(self, key,type,value) end

---@param key org.bukkit.NamespacedKey the key to remove
---@return void # 
function PersistentDataContainer.remove(self, key) end
...
---@return void # 
function PersistentDataContainer.readFromBytes(self, bytes,clear) end

---@param bytes byte[] the byte array to read from
---@return void # 
function PersistentDataContainer.readFromBytes(self, bytes) end
