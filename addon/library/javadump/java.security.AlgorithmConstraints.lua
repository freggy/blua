...
function AlgorithmConstraints.permits(primitives,algorithm,parameters) end
...
function AlgorithmConstraints.permits(primitives,key) end
...
function AlgorithmConstraints.permits(primitives,algorithm,key,parameters) end
