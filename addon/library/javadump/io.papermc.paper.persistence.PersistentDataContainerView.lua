...
function PersistentDataContainerView.has(self, key,type) end

---@param key org.bukkit.NamespacedKey the key the value is stored under
---@return boolean # if a value with the provided key exists
function PersistentDataContainerView.has(self, key) end
...
function PersistentDataContainerView.get(self, key,type) end
...
function PersistentDataContainerView.getOrDefault(self, key,type,defaultValue) end

---@return java.util.Set # the key set
function PersistentDataContainerView.getKeys(self, ) end

---@return boolean # the boolean
function PersistentDataContainerView.isEmpty(self, ) end
...
---@return void # 
function PersistentDataContainerView.copyTo(self, other,replace) end

---@return org.bukkit.persistence.PersistentDataAdapterContext # the tag context
function PersistentDataContainerView.getAdapterContext(self, ) end

---@return byte[] # a binary representation of this container
function PersistentDataContainerView.serializeToBytes(self, ) end
