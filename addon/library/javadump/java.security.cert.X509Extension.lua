...
function X509Extension.hasUnsupportedCriticalExtension() end
...
function X509Extension.getCriticalExtensionOIDs() end
...
function X509Extension.getNonCriticalExtensionOIDs() end
...
function X509Extension.getExtensionValue(oid) end
