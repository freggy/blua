...
function PolicyNode.getValidPolicy(self, ) end
...
function PolicyNode.getPolicyQualifiers(self, ) end
...
function PolicyNode.getExpectedPolicies(self, ) end
...
function PolicyNode.isCritical(self, ) end
