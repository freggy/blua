...
function ModuleResolutionAttribute.read(self, classReader,offset,length,charBuffer,codeOffset,labels) end
...
function ModuleResolutionAttribute.write(self, classWriter,code,codeLength,maxStack,maxLocals) end
