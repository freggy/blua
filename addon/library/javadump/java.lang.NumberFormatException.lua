...
function NumberFormatException.forInputString(self, s,radix) end
...
---@return java.lang.NumberFormatException # 
function NumberFormatException.forCharSequence(self, s,beginIndex,endIndex,errorIndex) end
