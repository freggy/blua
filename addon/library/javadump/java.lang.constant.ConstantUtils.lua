...
function ConstantUtils.validateBinaryClassName(name) end

---@param name java.lang.String the class name
---@return java.lang.String # the class name passed if valid
function ConstantUtils.validateInternalClassName(name) end

---@param name java.lang.String the package name
---@return java.lang.String # the package name passed if valid
function ConstantUtils.validateBinaryPackageName(name) end

---@param name java.lang.String the package name
---@return java.lang.String # the package name passed if valid
function ConstantUtils.validateInternalPackageName(name) end

---@param name java.lang.String the module name
---@return java.lang.String # the module name passed if valid
function ConstantUtils.validateModuleName(name) end

---@param name java.lang.String the name of the member
---@param method boolean 
---@return java.lang.String # the name passed if valid
function ConstantUtils.validateMemberName(name,method) end

---@param classDesc java.lang.constant.ClassDesc 
---@return void # 
function ConstantUtils.validateClassOrInterface(classDesc) end

---@param descriptorString java.lang.String 
---@return int # 
function ConstantUtils.arrayDepth(descriptorString) end

---@param name java.lang.String 
---@return java.lang.String # 
function ConstantUtils.binaryToInternal(name) end

---@param name java.lang.String 
---@return java.lang.String # 
function ConstantUtils.internalToBinary(name) end

---@param s java.lang.String 
---@return java.lang.String # 
function ConstantUtils.dropLastChar(s) end

---@param s java.lang.String 
---@return java.lang.String # 
function ConstantUtils.dropFirstAndLastChar(s) end

---@param descriptor java.lang.String the descriptor string
---@return java.util.List # the list of types
function ConstantUtils.parseMethodDescriptor(descriptor) end
...
function ConstantUtils.skipOverFieldSignature(descriptor,start,end,voidOK) end
