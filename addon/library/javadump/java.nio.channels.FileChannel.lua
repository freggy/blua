...
function FileChannel.open(path,options,attrs) end

---@param path java.nio.file.Path The path of the file to open or create
---@param options java.nio.file.OpenOption Options specifying how the file is opened
---@return java.nio.channels.FileChannel # A new file channel
function FileChannel.open(path,options) end

---@param dst java.nio.ByteBuffer 
---@return int # 
function FileChannel.read(dst) end

---@param dsts ByteBuffer[] 
---@param offset int 
---@param length int 
---@return long # 
function FileChannel.read(dsts,offset,length) end

---@param dsts ByteBuffer[] 
---@return long # 
function FileChannel.read(dsts) end

---@param src java.nio.ByteBuffer 
---@return int # 
function FileChannel.write(src) end

---@param srcs ByteBuffer[] 
---@param offset int 
---@param length int 
---@return long # 
function FileChannel.write(srcs,offset,length) end

---@param srcs ByteBuffer[] 
---@return long # 
function FileChannel.write(srcs) end
...
function FileChannel.position(newPosition) end
...
---@return java.nio.channels.FileChannel # This file channel
function FileChannel.truncate(size) end
...
---@return void # 
function FileChannel.force(metaData) end
...
function FileChannel.transferTo(position,count,target) end
...
---@param count long The maximum number of bytes to be transferred; must be         non-negative
---@return long # The number of bytes, possibly zero,          that were actually transferred
function FileChannel.transferFrom(src,position,count) end
...
function FileChannel.read(dst,position) end
...
function FileChannel.write(src,position) end
...
function FileChannel.map(mode,position,size) end
...
function FileChannel.map(mode,offset,size,arena) end
...
function FileChannel.lock(position,size,shared) end
...
function FileChannel.tryLock(position,size,shared) end
