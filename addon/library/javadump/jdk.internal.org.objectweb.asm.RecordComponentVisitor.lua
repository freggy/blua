...
function RecordComponentVisitor.getDelegate() end
...
function RecordComponentVisitor.visitAnnotation(descriptor,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function RecordComponentVisitor.visitTypeAnnotation(typeRef,typePath,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute an attribute.
---@return void # 
function RecordComponentVisitor.visitAttribute(attribute) end

---@return void # 
function RecordComponentVisitor.visitEnd() end
