...
function Preconditions.outOfBounds(self, oobef,checkKind,args) end

---@param oobe java.util.function.BiFunction 
---@param index int 
---@param length int 
---@return java.lang.RuntimeException # 
function Preconditions.outOfBoundsCheckIndex(self, oobe,index,length) end
...
---@param length int 
---@return java.lang.RuntimeException # 
function Preconditions.outOfBoundsCheckFromToIndex(self, oobe,fromIndex,toIndex,length) end
...
---@param length int 
---@return java.lang.RuntimeException # 
function Preconditions.outOfBoundsCheckFromIndexSize(self, oobe,fromIndex,size,length) end
...
function Preconditions.outOfBoundsExceptionFormatter(self, f) end

---@param checkKind java.lang.String 
---@param args java.util.List 
---@return java.lang.String # 
function Preconditions.outOfBoundsMessage(self, checkKind,args) end
...
function Preconditions.checkIndex(self, index,length,oobef) end
...
function Preconditions.checkFromToIndex(self, fromIndex,toIndex,length,oobef) end
...
---@param oobef java.util.function.BiFunction the exception formatter that when applied with this        method name and out-of-bounds arguments returns a runtime        exception.  If {@code null} or returns {@code null} then, it is as        if an exception formatter produced from an invocation of        {@code outOfBoundsExceptionFormatter(IndexOutOfBounds::new)} is used        instead (though it may be more efficient).        Exceptions thrown by the formatter are relayed to the caller.
---@return int # {@code fromIndex} if the sub-range within bounds of the range
function Preconditions.checkFromIndexSize(self, fromIndex,size,length,oobef) end
