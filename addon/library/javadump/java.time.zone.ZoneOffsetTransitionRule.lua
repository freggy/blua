...
function ZoneOffsetTransitionRule.of(self, month,dayOfMonthIndicator,dayOfWeek,time,timeEndOfDay,timeDefinition,standardOffset,offsetBefore,offsetAfter) end

---@param s java.io.ObjectInputStream the stream to read
---@return void # 
function ZoneOffsetTransitionRule.readObject(self, s) end

---@return java.lang.Object # the replacing object, not null
function ZoneOffsetTransitionRule.writeReplace(self, ) end

---@param out java.io.DataOutput the output stream, not null
---@return void # 
function ZoneOffsetTransitionRule.writeExternal(self, out) end
...
function ZoneOffsetTransitionRule.createTransition(self, year) end

---@param otherRule java.lang.Object the other object to compare to, null returns false
---@return boolean # true if equal
function ZoneOffsetTransitionRule.equals(self, otherRule) end

---@return int # the hash code
function ZoneOffsetTransitionRule.hashCode(self, ) end

---@return java.lang.String # a string for debugging, not null
function ZoneOffsetTransitionRule.toString(self, ) end
