...
function CompactNumberFormat.format(self, number,toAppendTo,fieldPosition) end
...
function CompactNumberFormat.format(self, number,result,fieldPosition) end

---@param number double 
---@param result java.lang.StringBuffer 
---@param delegate java.text.Format.FieldDelegate 
---@return java.lang.StringBuffer # 
function CompactNumberFormat.format(self, number,result,delegate) end
...
---@return java.lang.StringBuffer # 
function CompactNumberFormat.format(self, number,result,delegate,formatLong) end
...
function CompactNumberFormat.getAffix(self, isExpanded,isPrefix,isNegative,compactDataIndex,val) end
...
---@return void # 
function CompactNumberFormat.appendPrefix(self, result,prefix,delegate) end
...
---@return void # 
function CompactNumberFormat.appendSuffix(self, result,suffix,delegate) end
...
---@return void # 
function CompactNumberFormat.append(self, result,string,delegate,positions) end

---@param pattern java.lang.String a compact number pattern affix
---@return java.lang.String # an expanded affix
function CompactNumberFormat.expandAffix(self, pattern) end
...
function CompactNumberFormat.getFieldPositions(self, pattern,field) end

---@param number long number to be formatted
---@return int # index of matched compact pattern;         -1 if no compact patterns specified
function CompactNumberFormat.selectCompactPattern(self, number) end
...
function CompactNumberFormat.formatToCharacterIterator(self, obj) end
...
function CompactNumberFormat.computeDivisor(self, minIntDigits,patternIndex) end

---@return void # 
function CompactNumberFormat.processCompactPatterns(self, ) end

---@return java.util.Map # 
function CompactNumberFormat.buildPluralRulesMap(self, ) end

---@param rule java.lang.String rule to validate
---@return java.lang.String # the input rule (trimmed)
function CompactNumberFormat.validateRule(self, rule) end
...
---@return void # 
function CompactNumberFormat.applyPattern(self, count,pattern,index) end

---@return void # 
function CompactNumberFormat.expandAffixPatterns(self, ) end
...
function CompactNumberFormat.parse(self, text,pos) end

---@param text java.lang.String input text to be parsed
---@param position int starting position
---@return double # the number
function CompactNumberFormat.parseNumberPart(self, text,position) end
...
function CompactNumberFormat.generateParseResult(self, number,gotDouble,gotLongMin,status,cnfMultiplier) end

---@param number java.lang.Number parsed value
---@param status boolean[] boolean status flags indicating whether the               value is infinite and whether it is positive
---@param gotLongMin boolean whether the parsed number is Long.MIN
---@return java.lang.Number # the resulting value
function CompactNumberFormat.convertIfNegative(self, number,status,gotLongMin) end
...
---@return boolean # 
function CompactNumberFormat.matchAffix(self, text,position,affix,defaultAffix,matchedAffix) end
...
---@return boolean # 
function CompactNumberFormat.matchPrefixAndSuffix(self, text,position,prefix,matchedPrefix,defaultPrefix,suffix,matchedSuffix,defaultSuffix) end
...
function CompactNumberFormat.equals(self, obj) end

---@return int # hash code for this {@code CompactNumberFormat}
function CompactNumberFormat.hashCode(self, ) end

---@return java.text.CompactNumberFormat # a clone of this instance
function CompactNumberFormat.clone(self, ) end

---@param number double 
---@param divisor double 
---@return double # 
function CompactNumberFormat.getNumberValue(self, number,divisor) end

---@param val double 
---@param index int 
---@param divisor double 
---@return boolean # 
function CompactNumberFormat.checkIncrement(self, val,index,divisor) end

---@param input double input number in double type
---@return java.lang.String # LDML "count" tag
function CompactNumberFormat.getPluralCategory(self, input) end

---@param condition java.lang.String 
---@param input double 
---@return boolean # 
function CompactNumberFormat.matchPluralRule(self, condition,input) end
...
function CompactNumberFormat.valOrRangeMatches(self, valueOrRange,input) end
...
function CompactNumberFormat.relationCheck(self, relation,input) end

---@param expr java.util.regex.Matcher Match result
---@param input double value to examine in double
---@return double # resulting double value
function CompactNumberFormat.evalLOperand(self, expr,input) end
