...
function TimeZoneNameProvider.getDisplayName(self, ID,daylight,style,locale) end
...
function TimeZoneNameProvider.getGenericDisplayName(self, ID,style,locale) end
