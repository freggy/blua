...
function ChatRenderer.render(self, source,sourceDisplayName,message,viewer) end

---@return io.papermc.paper.chat.ChatRenderer # a new {@link ChatRenderer}
function ChatRenderer.defaultRenderer(self, ) end

---@param renderer io.papermc.paper.chat.ChatRenderer.ViewerUnaware the viewer unaware renderer
---@return io.papermc.paper.chat.ChatRenderer # a new {@link ChatRenderer}
function ChatRenderer.viewerUnaware(self, renderer) end
