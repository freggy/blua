...
function JavaLangModuleAccess.newModuleBuilder(self, mn,strict,ms) end

---@param builder java.lang.module.ModuleDescriptor.Builder 
---@return java.util.Set # 
function JavaLangModuleAccess.packages(self, builder) end
...
---@return void # 
function JavaLangModuleAccess.requires(self, builder,ms,mn,rawCompiledVersion) end

---@param ms java.util.Set 
---@param mn java.lang.String 
---@param v java.lang.module.ModuleDescriptor.Version 
---@return java.lang.module.ModuleDescriptor.Requires # 
function JavaLangModuleAccess.newRequires(self, ms,mn,v) end

---@param ms java.util.Set 
---@param source java.lang.String 
---@return java.lang.module.ModuleDescriptor.Exports # 
function JavaLangModuleAccess.newExports(self, ms,source) end

---@param ms java.util.Set 
---@param source java.lang.String 
---@param targets java.util.Set 
---@return java.lang.module.ModuleDescriptor.Exports # 
function JavaLangModuleAccess.newExports(self, ms,source,targets) end

---@param ms java.util.Set 
---@param source java.lang.String 
---@return java.lang.module.ModuleDescriptor.Opens # 
function JavaLangModuleAccess.newOpens(self, ms,source) end

---@param ms java.util.Set 
---@param source java.lang.String 
---@param targets java.util.Set 
---@return java.lang.module.ModuleDescriptor.Opens # 
function JavaLangModuleAccess.newOpens(self, ms,source,targets) end

---@param service java.lang.String 
---@param providers java.util.List 
---@return java.lang.module.ModuleDescriptor.Provides # 
function JavaLangModuleAccess.newProvides(self, service,providers) end
...
function JavaLangModuleAccess.newModuleDescriptor(self, name,version,ms,requires,exports,opens,uses,provides,packages,mainClass,hashCode) end
...
function JavaLangModuleAccess.resolveAndBind(self, finder,roots,traceOutput) end

---@param finder java.lang.module.ModuleFinder 
---@param graph java.util.Map 
---@return java.lang.module.Configuration # 
function JavaLangModuleAccess.newConfiguration(self, finder,graph) end
