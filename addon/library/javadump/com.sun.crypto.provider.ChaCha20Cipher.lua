...
function ChaCha20Cipher.engineGetParameters() end
...
---@return void # 
function ChaCha20Cipher.engineInit(opmode,key,random) end
...
---@return void # 
function ChaCha20Cipher.engineInit(opmode,key,params,random) end
...
---@return void # 
function ChaCha20Cipher.engineUpdateAAD(src,offset,len) end

---@param src java.nio.ByteBuffer the ByteBuffer containing the authentication data.
---@return void # 
function ChaCha20Cipher.engineUpdateAAD(src) end
...
function ChaCha20Cipher.createRandomNonce(random) end

---@param opmode int the type of operation to do.  This value must be either      {@code Cipher.ENCRYPT_MODE} or {@code Cipher.DECRYPT_MODE}
---@param key java.security.Key a 256-bit key suitable for ChaCha20
---@param newNonce byte[] the new nonce value for this initialization.
---@return void # 
function ChaCha20Cipher.init(opmode,key,newNonce) end
...
---@return void # 
function ChaCha20Cipher.checkKeyAndNonce(newKeyBytes,newNonce) end

---@param key java.security.Key the {@code Key} object used for this {@code Cipher}
---@return byte[] # the key bytes
function ChaCha20Cipher.getEncodedKey(key) end
...
function ChaCha20Cipher.engineUpdate(in,inOfs,inLen) end
...
function ChaCha20Cipher.engineUpdate(in,inOfs,inLen,out,outOfs) end

---@param in byte[] the plaintext or ciphertext input bytes (depending on the      operation type).
---@param inOfs int the offset into the input array
---@param inLen int the length of the data to use for the update operation.
---@return byte[] # the resulting plaintext or ciphertext bytes (depending on      the operation type)
function ChaCha20Cipher.engineDoFinal(in,inOfs,inLen) end
...
---@param outOfs int the offset for the {@code out} buffer to begin writing      the resulting data.
---@return int # the length in bytes of the data written into the {@code out}      buffer.
function ChaCha20Cipher.engineDoFinal(in,inOfs,inLen,out,outOfs) end
...
function ChaCha20Cipher.engineWrap(key) end
...
function ChaCha20Cipher.engineUnwrap(wrappedKey,algorithm,type) end

---@param key java.security.Key the key to be evaluated
---@return int # the length of the key in bits
function ChaCha20Cipher.engineGetKeySize(key) end

---@return void # 
function ChaCha20Cipher.setInitialState() end

---@param initState int[] 
---@param counter long 
---@param result byte[] 
---@return int # 
function ChaCha20Cipher.chaCha20Block(initState,counter,result) end
...
function ChaCha20Cipher.implChaCha20Block(initState,result) end
...
---@return void # 
function ChaCha20Cipher.chaCha20Transform(in,inOff,inLen,out,outOff) end
...
---@param len int 
---@return void # 
function ChaCha20Cipher.xor(in1,off1,in2,off2,out,outOff,len) end

---@return void # 
function ChaCha20Cipher.initAuthenticator() end
...
function ChaCha20Cipher.authUpdate(data,offset,length) end
...
---@return void # 
function ChaCha20Cipher.authFinalizeData(data,dataOff,length,out,outOff) end

---@param dataLen long the starting length to be padded.
---@return void # 
function ChaCha20Cipher.authPad16(dataLen) end
...
---@return void # 
function ChaCha20Cipher.authWriteLengths(aLen,dLen,buf) end

---@return void # 
function ChaCha20Cipher.resetStartState() end
