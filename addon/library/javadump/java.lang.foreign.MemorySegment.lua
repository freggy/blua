...
function MemorySegment.spliterator(self, elementLayout) end

---@param elementLayout java.lang.foreign.MemoryLayout the layout to be used for splitting.
---@return java.util.stream.Stream # a sequential {@code Stream} over disjoint slices in this segment.
function MemorySegment.elements(self, elementLayout) end

---@return java.lang.foreign.MemorySegment.Scope # 
function MemorySegment.scope(self, ) end

---@param thread java.lang.Thread the thread to be tested.
---@return boolean # 
function MemorySegment.isAccessibleBy(self, thread) end

---@return long # 
function MemorySegment.byteSize(self, ) end
...
function MemorySegment.asSlice(self, offset,newSize) end

---@param offset long The new segment base offset (relative to the address of this segment), specified in bytes.
---@param newSize long The new segment size, specified in bytes.
---@param byteAlignment long The alignment constraint (in bytes) of the returned slice.
---@return java.lang.foreign.MemorySegment # a slice of this memory segment.
function MemorySegment.asSlice(self, offset,newSize,byteAlignment) end

---@param offset long The new segment base offset (relative to the address of this segment), specified in bytes.
---@param layout java.lang.foreign.MemoryLayout The layout of the segment slice.
---@return java.lang.foreign.MemorySegment # a slice of this memory segment.
function MemorySegment.asSlice(self, offset,layout) end

---@param offset long The new segment base offset (relative to the address of this segment), specified in bytes.
---@return java.lang.foreign.MemorySegment # a slice of this memory segment.
function MemorySegment.asSlice(self, offset) end
...
function MemorySegment.reinterpret(self, newSize) end
...
function MemorySegment.reinterpret(self, arena,cleanup) end
...
function MemorySegment.reinterpret(self, newSize,arena,cleanup) end

---@return boolean # 
function MemorySegment.isReadOnly(self, ) end

---@return java.lang.foreign.MemorySegment # a read-only view of this segment
function MemorySegment.asReadOnly(self, ) end

---@return boolean # {@code true} if this segment is native segment.
function MemorySegment.isNative(self, ) end

---@return boolean # {@code true} if this segment is a mapped segment.
function MemorySegment.isMapped(self, ) end
...
function MemorySegment.asOverlappingSlice(self, other) end
...
function MemorySegment.mismatch(self, other) end

---@return boolean # {@code true} if it is likely that the contents of this segment          is resident in physical memory
function MemorySegment.isLoaded(self, ) end

---@return void # 
function MemorySegment.load(self, ) end

---@return void # 
function MemorySegment.unload(self, ) end

---@return void # 
function MemorySegment.force(self, ) end

---@return java.nio.ByteBuffer # a {@link ByteBuffer} view of this memory segment.
function MemorySegment.asByteBuffer(self, ) end
...
function MemorySegment.toArray(self, elementLayout) end
...
function MemorySegment.getUtf8String(self, offset) end
...
---@return void # 
function MemorySegment.setUtf8String(self, offset,str) end
...
function MemorySegment.ofBuffer(self, buffer) end
...
function MemorySegment.ofArray(self, byteArray) end
...
function MemorySegment.ofArray(self, charArray) end
...
function MemorySegment.ofArray(self, shortArray) end
...
function MemorySegment.ofArray(self, intArray) end
...
function MemorySegment.ofArray(self, floatArray) end
...
function MemorySegment.ofArray(self, longArray) end
...
function MemorySegment.ofArray(self, doubleArray) end
...
function MemorySegment.ofAddress(self, address) end
...
---@return void # 
function MemorySegment.copy(self, srcSegment,srcOffset,dstSegment,dstOffset,bytes) end
...
---@return void # 
function MemorySegment.copy(self, srcSegment,srcElementLayout,srcOffset,dstSegment,dstElementLayout,dstOffset,elementCount) end
...
function MemorySegment.get(self, layout,offset) end
...
---@return void # 
function MemorySegment.set(self, layout,offset,value) end
...
---@return byte # a byte value read from this segment.
function MemorySegment.getAtIndex(self, layout,index) end
...
---@param value char the char value to be written.
---@return void # 
function MemorySegment.setAtIndex(self, layout,index,value) end
...
function MemorySegment.equals(self, that) end

---@return int # 
function MemorySegment.hashCode(self, ) end
...
---@return void # 
function MemorySegment.copy(self, srcSegment,srcLayout,srcOffset,dstArray,dstIndex,elementCount) end
...
---@param elementCount int the number of array elements to be copied.
---@return void # 
function MemorySegment.copy(self, srcArray,srcIndex,dstSegment,dstLayout,dstOffset,elementCount) end
...
function MemorySegment.mismatch(self, srcSegment,srcFromOffset,srcToOffset,dstSegment,dstFromOffset,dstToOffset) end
