...
function PBEKeyFactory.engineGenerateSecret(self, keySpec) end
...
function PBEKeyFactory.engineGetKeySpec(self, key,keySpecCl) end
...
function PBEKeyFactory.engineTranslateKey(self, key) end
