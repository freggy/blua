...
---@return void # 
function CryptoAllPermissionCollection.add(self, permission) end
...
function CryptoAllPermissionCollection.implies(self, permission) end

---@return java.util.Enumeration # an enumeration of all {@code CryptoAllPermission} objects.
function CryptoAllPermissionCollection.elements(self, ) end
