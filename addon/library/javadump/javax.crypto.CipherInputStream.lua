...
---@return void # 
function CipherInputStream.ensureCapacity(self, inLen) end

---@return int # 
function CipherInputStream.getMoreData(self, ) end

---@return int # the next byte of data, or {@code -1} if the end of the          stream is reached.
function CipherInputStream.read(self, ) end
...
function CipherInputStream.read(self, b) end
