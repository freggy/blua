...
function CertStore.getCertificates(selector) end
...
function CertStore.getCRLs(selector) end
...
function CertStore.getInstance(type,params) end

---@param e java.security.NoSuchAlgorithmException 
---@return java.security.cert.CertStore # 
function CertStore.handleException(e) end
...
function CertStore.getInstance(type,params,provider) end
...
function CertStore.getDefaultType() end
