...
function Exchanger.arenaExchange(self, item,timed,ns) end
...
function Exchanger.slotExchange(self, item,timed,ns) end

---@param x V the object to exchange
---@return V # the object provided by the other thread
function Exchanger.exchange(self, x) end
...
---@return V # the object provided by the other thread
function Exchanger.exchange(self, x,timeout,unit) end
