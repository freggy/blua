...
function AbstractResourceBundleProvider.toBundleName(self, baseName,locale) end
...
function AbstractResourceBundleProvider.getBundle(self, baseName,locale) end

---@param module java.lang.Module 
---@param bundleName java.lang.String 
---@return java.util.ResourceBundle # 
function AbstractResourceBundleProvider.getBundle0(self, module,bundleName) end

---@param module java.lang.Module 
---@param bundleName java.lang.String 
---@return java.util.ResourceBundle # 
function AbstractResourceBundleProvider.loadResourceBundle(self, module,bundleName) end

---@param module java.lang.Module 
---@param bundleName java.lang.String 
---@return java.util.ResourceBundle # 
function AbstractResourceBundleProvider.loadPropertyResourceBundle(self, module,bundleName) end

---@param bundleName java.lang.String 
---@param suffix java.lang.String 
---@return java.lang.String # 
function AbstractResourceBundleProvider.toResourceName(self, bundleName,suffix) end
