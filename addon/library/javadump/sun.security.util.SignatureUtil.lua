...
function SignatureUtil.checkName(self, algName) end

---@param algName java.lang.String 
---@param paramBytes byte[] 
---@return java.security.AlgorithmParameters # 
function SignatureUtil.createAlgorithmParameters(self, algName,paramBytes) end
...
function SignatureUtil.getParamSpec(self, sigName,params) end
...
function SignatureUtil.getParamSpec(self, sigName,paramBytes) end

---@param s java.security.Signature 
---@param key java.security.PublicKey 
---@param params java.security.spec.AlgorithmParameterSpec 
---@return void # 
function SignatureUtil.initVerifyWithParam(self, s,key,params) end

---@param s java.security.Signature 
---@param cert java.security.cert.Certificate 
---@param params java.security.spec.AlgorithmParameterSpec 
---@return void # 
function SignatureUtil.initVerifyWithParam(self, s,cert,params) end
...
---@return void # 
function SignatureUtil.initSignWithParam(self, s,key,params,sr) end
...
function SignatureUtil.getDigestAlgInPkcs7SignerInfo(self, signer,sigalg,privateKey,directsign) end

---@param signatureAlgorithm java.lang.String 
---@return java.lang.String # 
function SignatureUtil.extractDigestAlgFromDwithE(self, signatureAlgorithm) end

---@param signatureAlgorithm java.lang.String 
---@return java.lang.String # the key algorithm name, or null if the input      is not in either of the formats.
function SignatureUtil.extractKeyAlgFromDwithE(self, signatureAlgorithm) end

---@param sigAlg java.lang.String 
---@param k java.security.Key 
---@return java.security.spec.AlgorithmParameterSpec # 
function SignatureUtil.getDefaultParamSpec(self, sigAlg,k) end
...
function SignatureUtil.fromKey(self, sigAlg,key,provider) end
...
---@param s java.security.Signature 
---@return java.security.Signature # 
function SignatureUtil.autoInitInternal(self, alg,key,s) end
...
function SignatureUtil.fromSignature(self, sigEngine,key) end

---@param key java.security.PrivateKey must not be null
---@param sAlg java.lang.String must not be null
---@return void # 
function SignatureUtil.checkKeyAndSigAlgMatch(self, key,sAlg) end

---@param k java.security.PrivateKey cannot be null
---@return java.lang.String # the default alg, might be null if unsupported
function SignatureUtil.getDefaultSigAlgForKey(self, k) end

---@param bitLength int 
---@return java.lang.String # 
function SignatureUtil.ecStrength(self, bitLength) end

---@param bitLength int 
---@return java.lang.String # 
function SignatureUtil.ifcFfcStrength(self, bitLength) end
