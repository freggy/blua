...
---@return void # 
function GlobalRegionScheduler.execute(self, plugin,run) end
...
function GlobalRegionScheduler.run(self, plugin,task) end

---@param plugin org.bukkit.plugin.Plugin The plugin that owns the task
---@param task java.util.function.Consumer The task to execute
---@param delayTicks long The delay, in ticks.
---@return io.papermc.paper.threadedregions.scheduler.ScheduledTask # The {@link ScheduledTask} that represents the scheduled task.
function GlobalRegionScheduler.runDelayed(self, plugin,task,delayTicks) end
...
---@return io.papermc.paper.threadedregions.scheduler.ScheduledTask # The {@link ScheduledTask} that represents the scheduled task.
function GlobalRegionScheduler.runAtFixedRate(self, plugin,task,initialDelayTicks,periodTicks) end

---@param plugin org.bukkit.plugin.Plugin Specified plugin.
---@return void # 
function GlobalRegionScheduler.cancelTasks(self, plugin) end
