...
function PolicyInformation.getPolicyQualifiers() end

---@return java.lang.String # 
function PolicyInformation.toString() end

---@param out sun.security.util.DerOutputStream the DerOutputStream to write the extension to.
---@return void # 
function PolicyInformation.encode(out) end
