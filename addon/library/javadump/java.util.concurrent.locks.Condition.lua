...
local Condition = {}
---@return void # 
function Condition.await(self, ) end

---@return void # 
function Condition.awaitUninterruptibly(self, ) end
...
function Condition.awaitNanos(self, nanosTimeout) end
...
function Condition.await(self, time,unit) end
...
function Condition.awaitUntil(self, deadline) end

---@return void # 
function Condition.signal(self, ) end

---@return void # 
function Condition.signalAll(self, ) end
