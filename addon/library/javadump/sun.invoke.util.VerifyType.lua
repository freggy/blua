...
function VerifyType.isNullConversion(self, src,dst,keepInterfaces) end

---@param type java.lang.Class 
---@return boolean # 
function VerifyType.isNullType(self, type) end
...
---@return boolean # whether the retyping can be done without motion or reformatting
function VerifyType.isNullConversion(self, call,recv,keepInterfaces) end
