...
---@param varIndex int 
---@return void # 
function LocalVariablesSorter.visitVarInsn(self, opcode,varIndex) end

---@param varIndex int 
---@param increment int 
---@return void # 
function LocalVariablesSorter.visitIincInsn(self, varIndex,increment) end

---@param maxStack int 
---@param maxLocals int 
---@return void # 
function LocalVariablesSorter.visitMaxs(self, maxStack,maxLocals) end
...
---@param index int 
---@return void # 
function LocalVariablesSorter.visitLocalVariable(self, name,descriptor,signature,start,end,index) end
...
function LocalVariablesSorter.visitLocalVariableAnnotation(self, typeRef,typePath,start,end,index,descriptor,visible) end
...
---@param stack Object[] 
---@return void # 
function LocalVariablesSorter.visitFrame(self, type,numLocal,local,numStack,stack) end
...
function LocalVariablesSorter.newLocal(self, type) end
...
---@return void # 
function LocalVariablesSorter.updateNewLocals(self, newLocals) end
...
---@return void # 
function LocalVariablesSorter.setLocalType(self, local,type) end

---@param local int 
---@param type java.lang.Object 
---@return void # 
function LocalVariablesSorter.setFrameLocal(self, local,type) end

---@param varIndex int 
---@param type jdk.internal.org.objectweb.asm.Type 
---@return int # 
function LocalVariablesSorter.remap(self, varIndex,type) end

---@param type jdk.internal.org.objectweb.asm.Type 
---@return int # 
function LocalVariablesSorter.newLocalMapping(self, type) end
