...
function ExtendedSSLSession.getLocalSupportedSignatureAlgorithms(self, ) end
...
function ExtendedSSLSession.getPeerSupportedSignatureAlgorithms(self, ) end
...
function ExtendedSSLSession.getRequestedServerNames(self, ) end
...
function ExtendedSSLSession.getStatusResponses(self, ) end
