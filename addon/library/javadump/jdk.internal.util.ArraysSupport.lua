...
---@param scale int 
---@return int # 
function ArraysSupport.exactLog2(self, scale) end
...
function ArraysSupport.vectorizedMismatch(self, a,aOffset,b,bOffset,length,log2ArrayIndexScale) end
...
function ArraysSupport.vectorizedHashCode(self, array,fromIndex,length,initialValue,basicType) end
...
---@param length int 
---@return int # 
function ArraysSupport.signedHashCode(self, result,a,fromIndex,length) end
...
---@param length int 
---@return int # 
function ArraysSupport.hashCode(self, result,a,fromIndex,length) end
...
---@param length int 
---@return int # 
function ArraysSupport.utf16hashCode(self, result,value,fromIndex,length) end

---@param a boolean[] 
---@param b boolean[] 
---@param length int 
---@return int # 
function ArraysSupport.mismatch(self, a,b,length) end
...
---@param length int 
---@return int # 
function ArraysSupport.mismatch(self, a,aFromIndex,b,bFromIndex,length) end
...
function ArraysSupport.newLength(self, oldLength,minGrowth,prefGrowth) end

---@param oldLength int 
---@param minGrowth int 
---@return int # 
function ArraysSupport.hugeLength(self, oldLength,minGrowth) end

---@param a T[] the array to be reversed
---@return T[] # the reversed array, always the same array as the argument
function ArraysSupport.reverse(self, a) end

---@param coll java.util.Collection 
---@param array T[] 
---@return T[] # 
function ArraysSupport.toArrayReversed(self, coll,array) end
