...
function Path.subpath(self, beginIndex,endIndex) end
...
function Path.startsWith(self, other) end
...
function Path.endsWith(self, other) end
...
---@return java.nio.file.Path # the resulting path
function Path.resolveSibling(self, other) end
...
function Path.toRealPath(self, options) end

---@return java.io.File # a {@code File} object representing this path
function Path.toFile(self, ) end
...
function Path.compareTo(self, other) end
