...
function AESCipher.engineGetIV(self, ) end
...
function AESCipher.engineGetParameters(self, ) end
...
---@return void # 
function AESCipher.engineInit(self, opmode,key,random) end
...
---@param random java.security.SecureRandom the source of randomness
---@return void # 
function AESCipher.engineInit(self, opmode,key,params,random) end
...
function AESCipher.engineUpdate(self, input,inputOffset,inputLen) end
...
function AESCipher.engineUpdate(self, input,inputOffset,inputLen,output,outputOffset) end

---@param input byte[] the input buffer
---@param inputOffset int the offset in <code>input</code> where the input starts
---@param inputLen int the input length
---@return byte[] # the new buffer with the result
function AESCipher.engineDoFinal(self, input,inputOffset,inputLen) end
...
---@param outputOffset int the offset in <code>output</code> where the result is stored
---@return int # the number of bytes stored in <code>output</code>
function AESCipher.engineDoFinal(self, input,inputOffset,inputLen,output,outputOffset) end

---@param key java.security.Key the key object.
---@return int # the key size of the given key object.
function AESCipher.engineGetKeySize(self, key) end

---@param key java.security.Key the key to be wrapped.
---@return byte[] # the wrapped key.
function AESCipher.engineWrap(self, key) end
...
function AESCipher.engineUnwrap(self, wrappedKey,wrappedKeyAlgorithm,wrappedKeyType) end
