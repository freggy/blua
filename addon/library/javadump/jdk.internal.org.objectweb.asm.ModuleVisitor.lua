...
---@return void # 
function ModuleVisitor.visitMainClass(mainClass) end

---@param packaze java.lang.String the internal name of a package.
---@return void # 
function ModuleVisitor.visitPackage(packaze) end
...
---@return void # 
function ModuleVisitor.visitRequire(module,access,version) end
...
---@return void # 
function ModuleVisitor.visitExport(packaze,access,modules) end
...
---@return void # 
function ModuleVisitor.visitOpen(packaze,access,modules) end

---@param service java.lang.String the internal name of the service.
---@return void # 
function ModuleVisitor.visitUse(service) end

---@param service java.lang.String the internal name of the service.
---@param providers java.lang.String the internal names of the implementations of the service (there is at least     one provider).
---@return void # 
function ModuleVisitor.visitProvide(service,providers) end

---@return void # 
function ModuleVisitor.visitEnd() end
