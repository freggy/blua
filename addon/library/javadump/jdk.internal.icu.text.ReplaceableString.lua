...
---@return int # 
function ReplaceableString.length() end

---@param offset int offset into the contents, from 0 to <code>length()</code> - 1
---@return char # 
function ReplaceableString.charAt(offset) end
...
---@return void # 
function ReplaceableString.getChars(srcStart,srcLimit,dst,dstStart) end
