...
function ExemptionMechanismSpi.engineGetOutputSize(inputLen) end

---@param key java.security.Key the key for this exemption mechanism
---@return void # 
function ExemptionMechanismSpi.engineInit(key) end

---@param key java.security.Key the key for this exemption mechanism
---@param params java.security.spec.AlgorithmParameterSpec the algorithm parameters
---@return void # 
function ExemptionMechanismSpi.engineInit(key,params) end
...
function ExemptionMechanismSpi.engineGenExemptionBlob() end
...
function ExemptionMechanismSpi.engineGenExemptionBlob(output,outputOffset) end
