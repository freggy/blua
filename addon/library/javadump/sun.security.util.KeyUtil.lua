...
function KeyUtil.getKeySize(self, key) end
...
function KeyUtil.getKeySize(self, parameters) end
...
function KeyUtil.fullDisplayAlgName(self, key) end

---@param key java.security.Key the key object, cannot be null
---@return void # 
function KeyUtil.validate(self, key) end

---@param keySpec java.security.spec.KeySpec the key spec object, cannot be null
---@return void # 
function KeyUtil.validate(self, keySpec) end
...
function KeyUtil.isOracleJCEProvider(self, providerName) end
...
function KeyUtil.checkTlsPreMasterSecretKey(self, clientVersion,serverVersion,random,encoded,isFailOver) end

---@param publicKey javax.crypto.interfaces.DHPublicKey 
---@return void # 
function KeyUtil.validateDHPublicKey(self, publicKey) end

---@param publicKeySpec javax.crypto.spec.DHPublicKeySpec 
---@return void # 
function KeyUtil.validateDHPublicKey(self, publicKeySpec) end

---@param p java.math.BigInteger 
---@param g java.math.BigInteger 
---@param y java.math.BigInteger 
---@return void # 
function KeyUtil.validateDHPublicKey(self, p,g,y) end

---@param b byte[] 
---@return byte[] # 
function KeyUtil.trimZeroes(self, b) end
