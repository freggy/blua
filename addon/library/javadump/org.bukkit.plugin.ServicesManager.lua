...
---@return void # 
function ServicesManager.register(self, service,provider,plugin,priority) end

---@param plugin org.bukkit.plugin.Plugin The plugin
---@return void # 
function ServicesManager.unregisterAll(self, plugin) end

---@param service java.lang.Class The service interface
---@param provider java.lang.Object The service provider implementation
---@return void # 
function ServicesManager.unregister(self, service,provider) end

---@param provider java.lang.Object The service provider implementation
---@return void # 
function ServicesManager.unregister(self, provider) end

---@param service java.lang.Class The service interface
---@return T # provider or null
function ServicesManager.load(self, service) end

---@param service java.lang.Class The service interface
---@return org.bukkit.plugin.RegisteredServiceProvider # provider registration or null
function ServicesManager.getRegistration(self, service) end

---@param plugin org.bukkit.plugin.Plugin The plugin
---@return java.util.List # provider registrations
function ServicesManager.getRegistrations(self, plugin) end

---@param service java.lang.Class The service interface
---@return java.util.Collection # list of registrations
function ServicesManager.getRegistrations(self, service) end

---@return java.util.Collection # list of known services
function ServicesManager.getKnownServices(self, ) end

---@param service java.lang.Class service to check
---@return boolean # whether there has been a registered provider
function ServicesManager.isProvidedFor(self, service) end
