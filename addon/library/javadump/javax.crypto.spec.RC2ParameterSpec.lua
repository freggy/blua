...
function RC2ParameterSpec.getEffectiveKeyBits() end
...
function RC2ParameterSpec.getIV() end
...
function RC2ParameterSpec.equals(obj) end

---@return int # 
function RC2ParameterSpec.hashCode() end
