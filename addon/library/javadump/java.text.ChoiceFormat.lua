...
---@return void # 
function ChoiceFormat.applyPattern(self, newPattern) end

---@return java.lang.String # the pattern string
function ChoiceFormat.toPattern(self, ) end
...
---@return void # 
function ChoiceFormat.setChoices(self, limits,formats) end

---@return double[] # the limits.
function ChoiceFormat.getLimits(self, ) end

---@return Object[] # the formats.
function ChoiceFormat.getFormats(self, ) end

---@param number long 
---@param toAppendTo java.lang.StringBuffer 
---@param status java.text.FieldPosition 
---@return java.lang.StringBuffer # 
function ChoiceFormat.format(self, number,toAppendTo,status) end
...
function ChoiceFormat.parse(self, text,status) end

---@param d double the reference value
---@return double # the least double value greater than {@code d}
function ChoiceFormat.nextDouble(self, d) end

---@param d double the reference value
---@return double # the greatest double value less than {@code d}
function ChoiceFormat.previousDouble(self, d) end

---@return java.lang.Object # 
function ChoiceFormat.clone(self, ) end

---@return int # 
function ChoiceFormat.hashCode(self, ) end

---@param obj java.lang.Object 
---@return boolean # 
function ChoiceFormat.equals(self, obj) end

---@param in java.io.ObjectInputStream 
---@return void # 
function ChoiceFormat.readObject(self, in) end
...
function ChoiceFormat.nextDouble(self, d,positive) end

---@param array double[] 
---@return double[] # 
function ChoiceFormat.doubleArraySize(self, array) end
