...
---@return void # 
function CustomItemTagContainer.setCustomTag(self, key,type,value) end
...
function CustomItemTagContainer.hasCustomTag(self, key,type) end
...
function CustomItemTagContainer.getCustomTag(self, key,type) end

---@param key org.bukkit.NamespacedKey the key
---@return void # 
function CustomItemTagContainer.removeCustomTag(self, key) end

---@return boolean # the boolean
function CustomItemTagContainer.isEmpty(self, ) end

---@return org.bukkit.inventory.meta.tags.ItemTagAdapterContext # the tag context
function CustomItemTagContainer.getAdapterContext(self, ) end
