...
function CipherTextStealing.getFeedback() end
...
function CipherTextStealing.encryptFinal(plain,plainOffset,plainLen,cipher,cipherOffset) end
...
function CipherTextStealing.decryptFinal(cipher,cipherOffset,cipherLen,plain,plainOffset) end
