...
function EnchantmentStorageMeta.hasStoredEnchant(self, ench) end

---@param ench org.bukkit.enchantments.Enchantment enchantment to check
---@return int # The level that the specified stored enchantment has, or 0 if     none
function EnchantmentStorageMeta.getStoredEnchantLevel(self, ench) end
...
function EnchantmentStorageMeta.addStoredEnchant(self, ench,level,ignoreLevelRestriction) end

---@param ench org.bukkit.enchantments.Enchantment Enchantment to remove
---@return boolean # true if the item meta changed as a result of this call, false     otherwise
function EnchantmentStorageMeta.removeStoredEnchant(self, ench) end
...
function EnchantmentStorageMeta.hasConflictingStoredEnchant(self, ench) end
