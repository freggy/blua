...
function AsynchronousServerSocketChannel.provider(self, ) end
...
function AsynchronousServerSocketChannel.open(self, group) end

---@return java.nio.channels.AsynchronousServerSocketChannel # A new asynchronous server socket channel
function AsynchronousServerSocketChannel.open(self, ) end
...
function AsynchronousServerSocketChannel.bind(self, local) end

---@param local java.net.SocketAddress The local address to bind the socket, or {@code null} to bind          to an automatically assigned socket address
---@param backlog int The maximum number of pending connections
---@return java.nio.channels.AsynchronousServerSocketChannel # This channel
function AsynchronousServerSocketChannel.bind(self, local,backlog) end

---@param name java.net.SocketOption 
---@param value T 
---@return java.nio.channels.AsynchronousServerSocketChannel # 
function AsynchronousServerSocketChannel.setOption(self, name,value) end
...
---@return void # 
function AsynchronousServerSocketChannel.accept(self, attachment,handler) end

---@return java.util.concurrent.Future # a {@code Future} object representing the pending result
function AsynchronousServerSocketChannel.accept(self, ) end
...
function AsynchronousServerSocketChannel.getLocalAddress(self, ) end
