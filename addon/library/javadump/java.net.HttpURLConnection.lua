...
---@return void # 
function HttpURLConnection.setFixedLengthStreamingMode(contentLength) end
...
---@return void # 
function HttpURLConnection.setChunkedStreamingMode(chunklen) end
...
function HttpURLConnection.getRequestMethod() end

---@return int # the HTTP Status-Code, or -1
function HttpURLConnection.getResponseCode() end

---@return java.lang.String # the HTTP response message, or {@code null}
function HttpURLConnection.getResponseMessage() end

---@param name java.lang.String 
---@param defaultValue long 
---@return long # 
function HttpURLConnection.getHeaderFieldDate(name,defaultValue) end
...
function HttpURLConnection.getPermission() end
