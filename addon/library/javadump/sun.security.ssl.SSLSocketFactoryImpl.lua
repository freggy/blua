...
---@return java.net.Socket # 
function SSLSocketFactoryImpl.createSocket(s,host,port,autoClose) end

---@param s java.net.Socket 
---@param consumed java.io.InputStream 
---@param autoClose boolean 
---@return java.net.Socket # 
function SSLSocketFactoryImpl.createSocket(s,consumed,autoClose) end

---@param address java.net.InetAddress the server's host
---@param port int its port
---@return java.net.Socket # 
function SSLSocketFactoryImpl.createSocket(address,port) end
...
---@return java.net.Socket # 
function SSLSocketFactoryImpl.createSocket(host,port,clientAddress,clientPort) end
...
---@param clientPort int 
---@return java.net.Socket # 
function SSLSocketFactoryImpl.createSocket(address,port,clientAddress,clientPort) end

---@return String[] # 
function SSLSocketFactoryImpl.getDefaultCipherSuites() end

---@return String[] # 
function SSLSocketFactoryImpl.getSupportedCipherSuites() end
