...
---@return void # 
function TimSort.sort(self, a,lo,hi,c,work,workBase,workLen) end
...
---@return void # 
function TimSort.binarySort(self, a,lo,hi,start,c) end
...
function TimSort.countRunAndMakeAscending(self, a,lo,hi,c) end
...
function TimSort.gallopLeft(self, key,a,base,len,hint,c) end
...
function TimSort.gallopRight(self, key,a,base,len,hint,c) end
...
---@return void # 
function TimSort.mergeLo(self, base1,len1,base2,len2) end
...
---@param len2 int length of second run to be merged (must be > 0)
---@return void # 
function TimSort.mergeHi(self, base1,len1,base2,len2) end

---@param minCapacity int the minimum required capacity of the tmp array
---@return T[] # tmp, whether or not it grew
function TimSort.ensureCapacity(self, minCapacity) end
