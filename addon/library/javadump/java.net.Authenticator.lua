...
local Authenticator = {}
---@return void # 
function Authenticator.reset(self, ) end
...
---@return void # 
function Authenticator.setDefault(self, a) end

---@return java.net.Authenticator # The default authenticator, if set, {@code null} otherwise.
function Authenticator.getDefault(self, ) end
...
function Authenticator.requestPasswordAuthentication(self, addr,port,protocol,prompt,scheme) end
...
---@param scheme java.lang.String The authentication scheme
---@return java.net.PasswordAuthentication # The username/password, or null if one can't be gotten.
function Authenticator.requestPasswordAuthentication(self, host,addr,port,protocol,prompt,scheme) end
...
---@return java.net.PasswordAuthentication # The username/password, or null if one can't be gotten.
function Authenticator.requestPasswordAuthentication(self, host,addr,port,protocol,prompt,scheme,url,reqType) end
...
function Authenticator.requestPasswordAuthentication(self, authenticator,host,addr,port,protocol,prompt,scheme,url,reqType) end
