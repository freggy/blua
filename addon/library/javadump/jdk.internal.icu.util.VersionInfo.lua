...
function VersionInfo.getInstance(version) end
...
function VersionInfo.getInstance(major,minor,milli,micro) end
...
function VersionInfo.compareTo(other) end
...
---@return int # 
function VersionInfo.getInt(major,minor,milli,micro) end
