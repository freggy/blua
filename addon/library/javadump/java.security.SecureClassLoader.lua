...
function SecureClassLoader.defineClass(self, name,b,off,len,cs) end
...
---@param cs java.security.CodeSource the associated CodeSource, or {@code null} if none
---@return java.lang.Class # the {@code Class} object created from the data,         and optional CodeSource.
function SecureClassLoader.defineClass(self, name,b,cs) end
...
function SecureClassLoader.getPermissions(self, codesource) end

---@param cs java.security.CodeSource 
---@return java.security.ProtectionDomain # 
function SecureClassLoader.getProtectionDomain(self, cs) end

---@return void # 
function SecureClassLoader.resetArchivedStates(self, ) end
