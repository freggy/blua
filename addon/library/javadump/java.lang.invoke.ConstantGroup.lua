...
function ConstantGroup.get(index,ifNotPresent) end
...
function ConstantGroup.asList(ifNotPresent) end
...
function ConstantGroup.subGroup(start,end) end
...
function ConstantGroup.copyConstants(start,end,buf,pos) end
...
---@return int # the limiting index, {@code end}
function ConstantGroup.copyConstants(start,end,buf,pos,ifNotPresent) end
...
function ConstantGroup.makeConstantGroup(constants,ifNotPresent,constantProvider) end
...
function ConstantGroup.makeConstantGroup(constants) end
