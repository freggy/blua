...
---@return void # 
function DigestAuthentication.processPropValue(self, input,theSet,consumer) end

---@return boolean # true if this authentication supports preemptive authorization
function DigestAuthentication.supportsPreemptiveAuthorization(self, ) end
...
function DigestAuthentication.getHeaderValue(self, url,method) end

---@param requestURI java.lang.String the Request-URI from the HTTP request line
---@param method java.lang.String the HTTP method
---@return java.lang.String # the value of the HTTP header this authentication wants set
function DigestAuthentication.getHeaderValue(self, requestURI,method) end

---@param header java.lang.String 
---@return boolean # 
function DigestAuthentication.isAuthorizationStale(self, header) end
...
function DigestAuthentication.setHeaders(self, conn,p,raw) end

---@param p sun.net.www.HeaderParser 
---@param params sun.net.www.protocol.http.DigestAuthentication.Parameters 
---@return boolean # 
function DigestAuthentication.setAlgorithmNames(self, p,params) end

---@param uri java.lang.String 
---@param method java.lang.String 
---@return java.lang.String # 
function DigestAuthentication.getHeaderValueImpl(self, uri,method) end

---@param header java.lang.String 
---@param method java.lang.String 
---@param url java.net.URL 
---@return void # 
function DigestAuthentication.checkResponse(self, header,method,url) end

---@param msg java.lang.String 
---@return void # 
function DigestAuthentication.log(self, msg) end

---@param name java.lang.String 
---@return void # 
function DigestAuthentication.validateDigest(self, name) end

---@param header java.lang.String 
---@param method java.lang.String 
---@param uri java.lang.String 
---@return void # 
function DigestAuthentication.checkResponse(self, header,method,uri) end
...
---@return java.lang.String # 
function DigestAuthentication.computeUserhash(self, digest,user,realm,charset) end
...
---@param charset java.nio.charset.Charset 
---@return java.lang.String # 
function DigestAuthentication.computeDigest(self, isRequest,userName,password,realm,connMethod,requestURI,nonceString,cnonce,ncValue,algorithm,session,charset) end
...
---@param charset java.nio.charset.Charset 
---@return java.lang.String # 
function DigestAuthentication.encode(self, src,passwd,md,charset) end

---@param passwd char[] 
---@return byte[] # 
function DigestAuthentication.getUtf8Bytes(self, passwd) end
