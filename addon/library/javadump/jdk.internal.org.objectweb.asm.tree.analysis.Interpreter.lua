...
function Interpreter.newValue(type) end
...
---@return V # a value that represents the given type. The size of the returned value must be equal to     the size of the given type.
function Interpreter.newParameterValue(isInstanceMethod,local,type) end

---@param type jdk.internal.org.objectweb.asm.Type a primitive or reference type.
---@return V # a value that represents the given type. The size of the returned value must be equal to     the size of the given type.
function Interpreter.newReturnTypeValue(type) end

---@param local int the local variable index.
---@return V # a value representing an uninitialized value. The size of the returned value must be     equal to 1.
function Interpreter.newEmptyValue(local) end
...
function Interpreter.newExceptionValue(tryCatchBlockNode,handlerFrame,exceptionType) end
...
function Interpreter.newOperation(insn) end
...
function Interpreter.copyOperation(insn,value) end

---@param insn jdk.internal.org.objectweb.asm.tree.AbstractInsnNode the bytecode instruction to be interpreted.
---@param value V the argument of the instruction to be interpreted.
---@return V # the result of the interpretation of the given instruction.
function Interpreter.unaryOperation(insn,value) end
...
---@return V # the result of the interpretation of the given instruction.
function Interpreter.binaryOperation(insn,value1,value2) end
...
---@return V # the result of the interpretation of the given instruction.
function Interpreter.ternaryOperation(insn,value1,value2,value3) end

---@param insn jdk.internal.org.objectweb.asm.tree.AbstractInsnNode the bytecode instruction to be interpreted.
---@param values java.util.List the arguments of the instruction to be interpreted.
---@return V # the result of the interpretation of the given instruction.
function Interpreter.naryOperation(insn,values) end

---@param insn jdk.internal.org.objectweb.asm.tree.AbstractInsnNode the bytecode instruction to be interpreted.
---@param value V the argument of the instruction to be interpreted.
---@param expected V the expected return type of the analyzed method.
---@return void # 
function Interpreter.returnOperation(insn,value,expected) end
...
function Interpreter.merge(value1,value2) end
