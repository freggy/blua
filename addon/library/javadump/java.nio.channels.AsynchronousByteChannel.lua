...
---@return void # 
function AsynchronousByteChannel.read(dst,attachment,handler) end

---@param dst java.nio.ByteBuffer The buffer into which bytes are to be transferred
---@return java.util.concurrent.Future # A Future representing the result of the operation
function AsynchronousByteChannel.read(dst) end
...
---@return void # 
function AsynchronousByteChannel.write(src,attachment,handler) end

---@param src java.nio.ByteBuffer The buffer from which bytes are to be retrieved
---@return java.util.concurrent.Future # A Future representing the result of the operation
function AsynchronousByteChannel.write(src) end
