...
function ClassWriter.hasFlags(self, flags) end
...
---@return void # 
function ClassWriter.visit(self, version,access,name,signature,superName,interfaces) end

---@param file java.lang.String 
---@param debug java.lang.String 
---@return void # 
function ClassWriter.visitSource(self, file,debug) end

---@param name java.lang.String 
---@param access int 
---@param version java.lang.String 
---@return jdk.internal.org.objectweb.asm.ModuleVisitor # 
function ClassWriter.visitModule(self, name,access,version) end

---@param nestHost java.lang.String 
---@return void # 
function ClassWriter.visitNestHost(self, nestHost) end

---@param owner java.lang.String 
---@param name java.lang.String 
---@param descriptor java.lang.String 
---@return void # 
function ClassWriter.visitOuterClass(self, owner,name,descriptor) end

---@param descriptor java.lang.String 
---@param visible boolean 
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # 
function ClassWriter.visitAnnotation(self, descriptor,visible) end
...
---@param visible boolean 
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # 
function ClassWriter.visitTypeAnnotation(self, typeRef,typePath,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute 
---@return void # 
function ClassWriter.visitAttribute(self, attribute) end

---@param nestMember java.lang.String 
---@return void # 
function ClassWriter.visitNestMember(self, nestMember) end

---@param permittedSubclass java.lang.String 
---@return void # 
function ClassWriter.visitPermittedSubclass(self, permittedSubclass) end
...
---@param access int 
---@return void # 
function ClassWriter.visitInnerClass(self, name,outerName,innerName,access) end

---@param name java.lang.String 
---@param descriptor java.lang.String 
---@param signature java.lang.String 
---@return jdk.internal.org.objectweb.asm.RecordComponentVisitor # 
function ClassWriter.visitRecordComponent(self, name,descriptor,signature) end
...
function ClassWriter.visitField(self, access,name,descriptor,signature,value) end
...
function ClassWriter.visitMethod(self, access,name,descriptor,signature,exceptions) end

---@return void # 
function ClassWriter.visitEnd(self, ) end

---@return byte[] # the binary content of the JVMS ClassFile structure that was built by this ClassWriter.
function ClassWriter.toByteArray(self, ) end
...
function ClassWriter.replaceAsmInstructions(self, classFile,hasFrames) end

---@return Attribute[] # the prototypes of the attributes used by this class, its fields and its methods.
function ClassWriter.getAttributePrototypes(self, ) end
...
function ClassWriter.newConst(self, value) end

---@param value java.lang.String 
---@return int # 
function ClassWriter.newUTF8(self, value) end
...
function ClassWriter.newClass(self, value) end
...
function ClassWriter.newMethodType(self, methodDescriptor) end
...
function ClassWriter.newModule(self, moduleName) end

---@param packageName java.lang.String name of the package in its internal form.
---@return int # the index of a new or already existing module reference item.
function ClassWriter.newPackage(self, packageName) end
...
---@return int # the index of a new or already existing method type reference item.
function ClassWriter.newHandle(self, tag,owner,name,descriptor) end
...
---@return int # the index of a new or already existing method type reference item.
function ClassWriter.newHandle(self, tag,owner,name,descriptor,isInterface) end
...
function ClassWriter.newConstantDynamic(self, name,descriptor,bootstrapMethodHandle,bootstrapMethodArguments) end
...
function ClassWriter.newInvokeDynamic(self, name,descriptor,bootstrapMethodHandle,bootstrapMethodArguments) end
...
function ClassWriter.newField(self, owner,name,descriptor) end
...
function ClassWriter.newMethod(self, owner,name,descriptor,isInterface) end
...
function ClassWriter.newNameType(self, name,descriptor) end
...
function ClassWriter.getCommonSuperClass(self, type1,type2) end

---@return java.lang.ClassLoader # ClassLoader
function ClassWriter.getClassLoader(self, ) end
