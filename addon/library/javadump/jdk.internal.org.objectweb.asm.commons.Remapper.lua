...
function Remapper.mapDesc(descriptor) end
...
function Remapper.mapType(type) end
...
function Remapper.mapType(internalName) end
...
function Remapper.mapTypes(internalNames) end
...
function Remapper.mapMethodDesc(methodDescriptor) end
...
function Remapper.mapValue(value) end
...
function Remapper.mapSignature(signature,typeSignature) end
...
function Remapper.createRemappingSignatureAdapter(signatureVisitor) end

---@param signatureVisitor jdk.internal.org.objectweb.asm.signature.SignatureVisitor the SignatureVisitor the remapper must delegate to.
---@return jdk.internal.org.objectweb.asm.signature.SignatureVisitor # the newly created remapper.
function Remapper.createSignatureRemapper(signatureVisitor) end
...
function Remapper.mapAnnotationAttributeName(descriptor,name) end
...
function Remapper.mapInnerClassName(name,ownerName,innerName) end
...
function Remapper.mapMethodName(owner,name,descriptor) end

---@param name java.lang.String the name of the method.
---@param descriptor java.lang.String the descriptor of the method.
---@return java.lang.String # the new name of the method.
function Remapper.mapInvokeDynamicMethodName(name,descriptor) end
...
function Remapper.mapRecordComponentName(owner,name,descriptor) end

---@param owner java.lang.String the internal name of the owner class of the field.
---@param name java.lang.String the name of the field.
---@param descriptor java.lang.String the descriptor of the field.
---@return java.lang.String # the new name of the field.
function Remapper.mapFieldName(owner,name,descriptor) end
...
function Remapper.mapPackageName(name) end
