...
function ConcurrentLinkedQueue.skipDeadNodes(pred,c,p,q) end

---@param e E 
---@return boolean # {@code true} (as specified by {@link Queue#offer})
function ConcurrentLinkedQueue.offer(e) end
...
---@return java.util.concurrent.ConcurrentLinkedQueue.Node # 
function ConcurrentLinkedQueue.first() end
...
function ConcurrentLinkedQueue.contains(o) end
...
function ConcurrentLinkedQueue.remove(o) end

---@param c java.util.Collection the elements to be inserted into this queue
---@return boolean # {@code true} if this queue changed as a result of the call
function ConcurrentLinkedQueue.addAll(c) end
...
---@param a Object[] 
---@return Object[] # 
function ConcurrentLinkedQueue.toArrayInternal(a) end
...
function ConcurrentLinkedQueue.toArray(a) end
...
---@return void # 
function ConcurrentLinkedQueue.writeObject(s) end

---@param s java.io.ObjectInputStream the stream
---@return void # 
function ConcurrentLinkedQueue.readObject(s) end
...
---@return boolean # 
function ConcurrentLinkedQueue.removeIf(filter) end

---@param c java.util.Collection 
---@return boolean # 
function ConcurrentLinkedQueue.removeAll(c) end

---@param c java.util.Collection 
---@return boolean # 
function ConcurrentLinkedQueue.retainAll(c) end
...
---@param filter java.util.function.Predicate 
---@return boolean # 
function ConcurrentLinkedQueue.bulkRemove(filter) end

---@param action java.util.function.Consumer 
---@param p java.util.concurrent.ConcurrentLinkedQueue.Node 
---@return void # 
function ConcurrentLinkedQueue.forEachFrom(action,p) end

---@param action java.util.function.Consumer 
---@return void # 
function ConcurrentLinkedQueue.forEach(action) end
