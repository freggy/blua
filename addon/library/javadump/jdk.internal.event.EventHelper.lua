...
---@return void # 
function EventHelper.logTLSHandshakeEvent(self, start,peerHost,peerPort,cipherSuite,protocolVersion,peerCertId) end

---@param key java.lang.String 
---@param value java.lang.String 
---@return void # 
function EventHelper.logSecurityPropertyEvent(self, key,value) end

---@param anchorCertId long 
---@param certIds long[] 
---@return void # 
function EventHelper.logX509ValidationEvent(self, anchorCertId,certIds) end
...
---@param endDate long 
---@return void # 
function EventHelper.logX509CertificateEvent(self, algId,serialNum,subject,issuer,keyType,length,certId,beginDate,endDate) end
...
function EventHelper.getDurationString(self, start) end

---@return boolean # boolean indicating whether an event should be logged
function EventHelper.isLoggingSecurity(self, ) end
