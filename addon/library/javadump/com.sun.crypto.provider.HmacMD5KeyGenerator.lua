...
---@return void # 
function HmacMD5KeyGenerator.engineInit(self, random) end
...
---@return void # 
function HmacMD5KeyGenerator.engineInit(self, params,random) end

---@param keysize int the keysize. This is an algorithm-specific metric specified in number of bits.
---@param random java.security.SecureRandom the source of randomness for this key generator
---@return void # 
function HmacMD5KeyGenerator.engineInit(self, keysize,random) end

---@return javax.crypto.SecretKey # the new HMAC-MD5 key
function HmacMD5KeyGenerator.engineGenerateKey(self, ) end
