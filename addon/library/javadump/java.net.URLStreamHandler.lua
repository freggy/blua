...
function URLStreamHandler.openConnection(u) end
...
---@return java.net.URLConnection # a {@code URLConnection} object for the {@code URL}.
function URLStreamHandler.openConnection(u,p) end
...
---@return void # 
function URLStreamHandler.parseURL(u,spec,start,limit) end

---@return int # the default port for a {@code URL} parsed by this handler.
function URLStreamHandler.getDefaultPort() end
...
---@return void # 
function URLStreamHandler.setURL(u,protocol,host,port,authority,userInfo,path,query,ref) end
...
---@param ref java.lang.String the reference.
---@return void # 
function URLStreamHandler.setURL(u,protocol,host,port,file,ref) end
