...
function Builder.getMatchingCerts(currentState,certStores) end
...
---@return void # 
function Builder.verifyCert(cert,currentState,certPathList) end
...
function Builder.isPathCompleted(cert) end
...
---@return void # 
function Builder.addCertToPath(cert,certPathList) end

---@param certPathList java.util.LinkedList the certification path list
---@return void # 
function Builder.removeFinalCertFromPath(certPathList) end
...
function Builder.distance(base,test,incomparable) end
...
function Builder.hops(base,test,incomparable) end
...
function Builder.targetDistance(constraints,cert,target) end
...
function Builder.getMatchingPolicies() end
...
---@return boolean # 
function Builder.addMatchingCerts(selector,certStores,resultCerts,checkAll) end
