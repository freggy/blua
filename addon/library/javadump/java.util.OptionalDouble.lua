...
function OptionalDouble.of(value) end
...
---@return void # 
function OptionalDouble.ifPresent(action) end

---@param action java.util.function.DoubleConsumer the action to be performed, if a value is present
---@param emptyAction java.lang.Runnable the empty-based action to be performed, if no value is present
---@return void # 
function OptionalDouble.ifPresentOrElse(action,emptyAction) end
...
function OptionalDouble.orElse(other) end
...
function OptionalDouble.orElseGet(supplier) end
...
function OptionalDouble.orElseThrow(exceptionSupplier) end
...
function OptionalDouble.equals(obj) end
