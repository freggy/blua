...
---@return void # 
function JumpInsnNode.setOpcode(self, opcode) end

---@return int # 
function JumpInsnNode.getType(self, ) end

---@param methodVisitor jdk.internal.org.objectweb.asm.MethodVisitor 
---@return void # 
function JumpInsnNode.accept(self, methodVisitor) end

---@param clonedLabels java.util.Map 
---@return jdk.internal.org.objectweb.asm.tree.AbstractInsnNode # 
function JumpInsnNode.clone(self, clonedLabels) end
