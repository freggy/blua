...
function ProfileBanList.addBan(self, target,reason,expires,source) end
...
---@return E # 
function ProfileBanList.getBanEntry(self, target) end

---@param target org.bukkit.profile.PlayerProfile 
---@return boolean # 
function ProfileBanList.isBanned(self, target) end

---@param target org.bukkit.profile.PlayerProfile 
---@return void # 
function ProfileBanList.pardon(self, target) end
...
---@param source java.lang.String 
---@return E # 
function ProfileBanList.addBan(self, target,reason,duration,source) end
