...
---@return void # 
function KeyManagerFactorySpi.engineInit(ks,password) end

---@param spec javax.net.ssl.ManagerFactoryParameters an implementation of a provider-specific parameter          specification
---@return void # 
function KeyManagerFactorySpi.engineInit(spec) end

---@return KeyManager[] # the key managers
function KeyManagerFactorySpi.engineGetKeyManagers() end
