...
function PollingWatchService.register(self, path,events,modifiers) end

---@param path java.nio.file.Path 
---@param events java.util.Set 
---@return sun.nio.fs.PollingWatchService.PollingWatchKey # 
function PollingWatchService.doPrivilegedRegister(self, path,events) end

---@return void # 
function PollingWatchService.implClose(self, ) end
