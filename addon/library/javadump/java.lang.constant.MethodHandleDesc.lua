...
function MethodHandleDesc.of(self, kind,owner,name,lookupDescriptor) end
...
---@return java.lang.constant.DirectMethodHandleDesc # the {@linkplain MethodHandleDesc}
function MethodHandleDesc.ofMethod(self, kind,owner,name,lookupMethodType) end
...
---@return java.lang.constant.DirectMethodHandleDesc # the {@linkplain MethodHandleDesc}
function MethodHandleDesc.ofField(self, kind,owner,fieldName,fieldType) end
...
---@return java.lang.constant.DirectMethodHandleDesc # the {@linkplain MethodHandleDesc}
function MethodHandleDesc.ofConstructor(self, owner,paramTypes) end
