...
function TemplateRuntime.newStringTemplate(self, lookup,name,type,fragments) end
...
function TemplateRuntime.newLargeStringTemplate(self, lookup,name,type) end
...
function TemplateRuntime.processStringTemplate(self, lookup,name,type,processorGetter,fragments) end
...
function TemplateRuntime.defaultProcess(self, fragments,processor,values) end
...
function TemplateRuntime.defaultProcessMethodHandle(self, type,processor,fragments) end
