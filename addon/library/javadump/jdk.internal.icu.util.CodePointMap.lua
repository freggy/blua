...
function CodePointMap.get(self, c) end
...
function CodePointMap.getRange(self, start,filter,range) end
...
---@param range jdk.internal.icu.util.CodePointMap.Range the range object that will be set to the code point range and value
---@return boolean # true if start is 0..U+10FFFF; otherwise no new range is fetched
function CodePointMap.getRange(self, start,option,surrogateValue,filter,range) end

---@return java.util.Iterator # a Range iterator
function CodePointMap.iterator(self, ) end
...
function CodePointMap.stringIterator(self, s,sIndex) end
