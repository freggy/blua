...
function CookieHandler.getDefault() end

---@param cHandler java.net.CookieHandler The HTTP cookie handler, or       {@code null} to unset.
---@return void # 
function CookieHandler.setDefault(cHandler) end
...
function CookieHandler.get(uri,requestHeaders) end
...
---@return void # 
function CookieHandler.put(uri,responseHeaders) end
