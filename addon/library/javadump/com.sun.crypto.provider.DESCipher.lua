...
function DESCipher.engineGetIV() end
...
function DESCipher.engineGetParameters() end
...
---@return void # 
function DESCipher.engineInit(opmode,key,random) end
...
---@param random java.security.SecureRandom the source of randomness
---@return void # 
function DESCipher.engineInit(opmode,key,params,random) end
...
function DESCipher.engineUpdate(input,inputOffset,inputLen) end
...
function DESCipher.engineUpdate(input,inputOffset,inputLen,output,outputOffset) end

---@param input byte[] the input buffer
---@param inputOffset int the offset in <code>input</code> where the input starts
---@param inputLen int the input length
---@return byte[] # the new buffer with the result
function DESCipher.engineDoFinal(input,inputOffset,inputLen) end
...
function DESCipher.engineUnwrap(wrappedKey,wrappedKeyAlgorithm,wrappedKeyType) end
