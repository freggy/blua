...
function SSLTransport.getPeerHost() end

---@return int # the port number of the peer, or -1 if nothing is          available.
function SSLTransport.getPeerPort() end

---@return void # 
function SSLTransport.shutdown() end

---@return boolean # true if delegated tasks used for handshaking operations.
function SSLTransport.useDelegatedTask() end
...
function SSLTransport.decode(context,srcs,srcsOffset,srcsLength,dsts,dstsOffset,dstsLength) end
