...
function ByteVector.size(self, ) end

---@param byteValue int a byte.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.putByte(self, byteValue) end

---@param byteValue1 int a byte.
---@param byteValue2 int another byte.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.put11(self, byteValue1,byteValue2) end

---@param shortValue int a short.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.putShort(self, shortValue) end

---@param byteValue int a byte.
---@param shortValue int a short.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.put12(self, byteValue,shortValue) end

---@param byteValue1 int a byte.
---@param byteValue2 int another byte.
---@param shortValue int a short.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.put112(self, byteValue1,byteValue2,shortValue) end

---@param intValue int an int.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.putInt(self, intValue) end

---@param byteValue int a byte.
---@param shortValue1 int a short.
---@param shortValue2 int another short.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.put122(self, byteValue,shortValue1,shortValue2) end

---@param longValue long a long.
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.putLong(self, longValue) end

---@param stringValue java.lang.String 
---@return jdk.internal.org.objectweb.asm.ByteVector # 
function ByteVector.putUTF8(self, stringValue) end
...
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.encodeUtf8(self, stringValue,offset,maxByteLength) end
...
---@return jdk.internal.org.objectweb.asm.ByteVector # this byte vector.
function ByteVector.putByteArray(self, byteArrayValue,byteOffset,byteLength) end

---@param size int number of additional bytes that this byte vector should be able to receive.
---@return void # 
function ByteVector.enlarge(self, size) end
