...
function Temporal.isSupported(self, unit) end
...
function Temporal.with(self, adjuster) end
...
function Temporal.with(self, field,newValue) end

---@param amount java.time.temporal.TemporalAmount the amount to add, not null
---@return java.time.temporal.Temporal # an object of the same type with the specified adjustment made, not null
function Temporal.plus(self, amount) end
...
function Temporal.plus(self, amountToAdd,unit) end

---@param amount java.time.temporal.TemporalAmount the amount to subtract, not null
---@return java.time.temporal.Temporal # an object of the same type with the specified adjustment made, not null
function Temporal.minus(self, amount) end
...
function Temporal.minus(self, amountToSubtract,unit) end
...
function Temporal.until(self, endExclusive,unit) end
