...
function LoggingProviderImpl.demandJULLoggerFor(self, name,module) end

---@param name java.lang.String 
---@param module java.lang.Module 
---@return java.lang.System.Logger # {@inheritDoc}
function LoggingProviderImpl.demandLoggerFor(self, name,module) end

---@return sun.util.logging.internal.LoggingProviderImpl.LogManagerAccess # 
function LoggingProviderImpl.getLogManagerAccess(self, ) end

---@param accesLoggers sun.util.logging.internal.LoggingProviderImpl.LogManagerAccess 
---@return void # 
function LoggingProviderImpl.setLogManagerAccess(self, accesLoggers) end
