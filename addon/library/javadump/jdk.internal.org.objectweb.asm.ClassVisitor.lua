...
---@return void # 
function ClassVisitor.visit(self, version,access,name,signature,superName,interfaces) end
...
---@return void # 
function ClassVisitor.visitSource(self, source,debug) end
...
function ClassVisitor.visitModule(self, name,access,version) end

---@param nestHost java.lang.String the internal name of the host class of the nest.
---@return void # 
function ClassVisitor.visitNestHost(self, nestHost) end
...
---@return void # 
function ClassVisitor.visitOuterClass(self, owner,name,descriptor) end
...
function ClassVisitor.visitAnnotation(self, descriptor,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function ClassVisitor.visitTypeAnnotation(self, typeRef,typePath,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute an attribute.
---@return void # 
function ClassVisitor.visitAttribute(self, attribute) end

---@param nestMember java.lang.String the internal name of a nest member.
---@return void # 
function ClassVisitor.visitNestMember(self, nestMember) end

---@param permittedSubclass java.lang.String the internal name of a permitted subclass.
---@return void # 
function ClassVisitor.visitPermittedSubclass(self, permittedSubclass) end
...
---@return void # 
function ClassVisitor.visitInnerClass(self, name,outerName,innerName,access) end
...
function ClassVisitor.visitRecordComponent(self, name,descriptor,signature) end
...
function ClassVisitor.visitField(self, access,name,descriptor,signature,value) end
...
function ClassVisitor.visitMethod(self, access,name,descriptor,signature,exceptions) end

---@return void # 
function ClassVisitor.visitEnd(self, ) end
