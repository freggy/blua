...
function SwitchPoint.hasBeenInvalidated(self, ) end
...
function SwitchPoint.guardWithTest(self, target,fallback) end

---@param switchPoints SwitchPoint[] an array of call sites to be synchronized
---@return void # 
function SwitchPoint.invalidateAll(self, switchPoints) end
