...
---@return void # 
function SequenceInputStream.nextStream(self, ) end

---@return void # 
function SequenceInputStream.peekNextStream(self, ) end
...
function SequenceInputStream.available(self, ) end

---@return int # {@inheritDoc}
function SequenceInputStream.read(self, ) end
...
function SequenceInputStream.read(self, b,off,len) end

---@return void # 
function SequenceInputStream.close(self, ) end

---@param out java.io.OutputStream 
---@return long # 
function SequenceInputStream.transferTo(self, out) end
