...
function ClassBuilder.original() end
...
function ClassBuilder.withVersion(major,minor) end

---@param flags int the access flags, as a bit mask
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withFlags(flags) end
...
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withSuperclass(superclassEntry) end

---@param desc java.lang.constant.ClassDesc the superclass
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withSuperclass(desc) end

---@param interfaces java.util.List the interfaces
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withInterfaces(interfaces) end
...
---@param interfaces java.util.List the interfaces
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withInterfaceSymbols(interfaces) end
...
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withField(name,descriptor,handler) end

---@param name jdk.internal.classfile.constantpool.Utf8Entry the name of the field
---@param descriptor jdk.internal.classfile.constantpool.Utf8Entry the field descriptor
---@param flags int the access flags for this field
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withField(name,descriptor,flags) end
...
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.transformField(field,transform) end
...
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withMethod(name,descriptor,methodFlags,handler) end
...
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.withMethodBody(name,descriptor,methodFlags,handler) end
...
---@return jdk.internal.classfile.ClassBuilder # this builder
function ClassBuilder.transformMethod(method,transform) end
