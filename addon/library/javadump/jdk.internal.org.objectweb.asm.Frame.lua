...
---@return void # 
function Frame.copyFrom(self, frame) end
...
function Frame.getAbstractTypeFromApiFormat(self, symbolTable,type) end
...
function Frame.getAbstractTypeFromInternalName(self, symbolTable,internalName) end
...
function Frame.getAbstractTypeFromDescriptor(self, symbolTable,buffer,offset) end
...
---@return void # 
function Frame.setInputFrameFromDescriptor(self, symbolTable,access,descriptor,maxLocals) end
...
---@return void # 
function Frame.setInputFrameFromApiFormat(self, symbolTable,numLocal,local,numStack,stack) end

---@return int # 
function Frame.getInputStackSize(self, ) end
...
function Frame.getLocal(self, localIndex) end
...
---@return void # 
function Frame.setLocal(self, localIndex,abstractType) end

---@param abstractType int an abstract type.
---@return void # 
function Frame.push(self, abstractType) end

---@param symbolTable jdk.internal.org.objectweb.asm.SymbolTable the type table to use to lookup and store type {@link Symbol}.
---@param descriptor java.lang.String a type or method descriptor (in which case its return type is pushed).
---@return void # 
function Frame.push(self, symbolTable,descriptor) end
...
function Frame.getInitializedType(self, symbolTable,abstractType) end
...
---@param symbolTable jdk.internal.org.objectweb.asm.SymbolTable the type table to use to lookup and store type {@link Symbol}.
---@return void # 
function Frame.execute(self, opcode,arg,argSymbol,symbolTable) end
...
function Frame.getConcreteOutputType(self, abstractOutputType,numStack) end
...
function Frame.merge(self, symbolTable,dstFrame,catchTypeIndex) end
...
function Frame.merge(self, symbolTable,sourceType,dstTypes,dstIndex) end
...
---@return void # 
function Frame.accept(self, methodWriter) end
...
---@return void # 
function Frame.putAbstractType(self, symbolTable,abstractType,output) end
