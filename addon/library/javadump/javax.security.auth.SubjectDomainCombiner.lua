...
function SubjectDomainCombiner.getSubject(self, ) end
...
function SubjectDomainCombiner.combine(self, currentDomains,assignedDomains) end

---@param domains ProtectionDomain[] 
---@return ProtectionDomain[] # 
function SubjectDomainCombiner.optimize(self, domains) end

---@param currentDomains ProtectionDomain[] 
---@param assignedDomains ProtectionDomain[] 
---@return void # 
function SubjectDomainCombiner.printInputDomains(self, currentDomains,assignedDomains) end

---@param pd java.security.ProtectionDomain 
---@return java.lang.String # 
function SubjectDomainCombiner.printDomain(self, pd) end
