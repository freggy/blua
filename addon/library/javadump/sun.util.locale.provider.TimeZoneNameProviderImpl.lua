...
function TimeZoneNameProviderImpl.getAvailableLocales(self, ) end

---@param locale java.util.Locale 
---@return boolean # 
function TimeZoneNameProviderImpl.isSupportedLocale(self, locale) end
...
function TimeZoneNameProviderImpl.getDisplayName(self, id,daylight,style,locale) end

---@param id java.lang.String 
---@param style int 
---@param locale java.util.Locale 
---@return java.lang.String # 
function TimeZoneNameProviderImpl.getGenericDisplayName(self, id,style,locale) end

---@param id java.lang.String 
---@param locale java.util.Locale 
---@return String[] # 
function TimeZoneNameProviderImpl.getDisplayNameArray(self, id,locale) end

---@param locale java.util.Locale a Locale for time zone names
---@return String[][] # an array of time zone names arrays
function TimeZoneNameProviderImpl.getZoneStrings(self, locale) end
