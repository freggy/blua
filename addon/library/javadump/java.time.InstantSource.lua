...
function InstantSource.tick(baseSource,tickDuration) end
...
function InstantSource.fixed(fixedInstant) end
...
function InstantSource.offset(baseSource,offsetDuration) end
...
function InstantSource.withZone(zone) end
