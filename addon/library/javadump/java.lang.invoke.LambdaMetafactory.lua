...
function LambdaMetafactory.metafactory(self, caller,interfaceMethodName,factoryType,interfaceMethodType,implementation,dynamicMethodType) end
...
---@return java.lang.invoke.CallSite # a CallSite whose target can be used to perform capture, generating         instances of the interface named by {@code factoryType}
function LambdaMetafactory.altMetafactory(self, caller,interfaceMethodName,factoryType,args) end

---@param args Object[] 
---@param index int 
---@param type java.lang.Class 
---@return T # 
function LambdaMetafactory.extractArg(self, args,index,type) end
...
---@param count int 
---@return T[] # 
function LambdaMetafactory.extractArgs(self, args,index,type,count) end
