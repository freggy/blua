...
function CalendarUtils.isGregorianLeapYear(self, gregorianYear) end
...
function CalendarUtils.isJulianLeapYear(self, normalizedJulianYear) end

---@param n long the numerator
---@param d long a divisor that must be greater than 0
---@return long # the floor of the quotient
function CalendarUtils.floorDivide(self, n,d) end
...
---@return int # the floor of the quotient.
function CalendarUtils.floorDivide(self, n,d,r) end

---@param x long 
---@param y long 
---@return long # 
function CalendarUtils.mod(self, x,y) end
...
---@param y int 
---@return int # 
function CalendarUtils.amod(self, x,y) end
...
function CalendarUtils.sprintf0d(self, sb,value,width) end
