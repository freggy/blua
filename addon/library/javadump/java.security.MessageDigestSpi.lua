...
function MessageDigestSpi.engineGetDigestLength(self, ) end

---@param input byte the byte to use for the update.
---@return void # 
function MessageDigestSpi.engineUpdate(self, input) end
...
---@return void # 
function MessageDigestSpi.engineUpdate(self, input,offset,len) end
...
function MessageDigestSpi.engineDigest(self, ) end
...
function MessageDigestSpi.engineDigest(self, buf,offset,len) end

---@return void # 
function MessageDigestSpi.engineReset(self, ) end

---@return java.lang.Object # a clone if the implementation is cloneable.
function MessageDigestSpi.clone(self, ) end
