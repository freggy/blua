...
---@param keys byte[] 
---@return void # 
function DESedeCrypt.init(self, decrypting,algorithm,keys) end
...
---@return void # 
function DESedeCrypt.encryptBlock(self, plain,plainOffset,cipher,cipherOffset) end
...
---@param plainOffset int the offset in <code>plain</code>
---@return void # 
function DESedeCrypt.decryptBlock(self, cipher,cipherOffset,plain,plainOffset) end
...
---@param len int 
---@return boolean # 
function DESedeCrypt.keyEquals(self, key1,off1,key2,off2,len) end
