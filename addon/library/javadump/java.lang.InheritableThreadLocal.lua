...
function InheritableThreadLocal.childValue(parentValue) end

---@param t java.lang.Thread the current thread
---@return java.lang.ThreadLocal.ThreadLocalMap # 
function InheritableThreadLocal.getMap(t) end

---@param t java.lang.Thread the current thread
---@param firstValue T value for the initial entry of the table.
---@return void # 
function InheritableThreadLocal.createMap(t,firstValue) end
