...
function DigestInputStream.getMessageDigest() end

---@param digest java.security.MessageDigest the message digest to be associated with this stream.
---@return void # 
function DigestInputStream.setMessageDigest(digest) end

---@return int # the byte read.
function DigestInputStream.read() end
...
function DigestInputStream.read(b,off,len) end

---@param on boolean {@code true} to turn the digest function on, {@code false} to turn it off.
---@return void # 
function DigestInputStream.on(on) end

---@return java.lang.String # 
function DigestInputStream.toString() end
