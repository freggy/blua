...
function DESedeCipher.engineGetIV() end
...
---@return void # 
function DESedeCipher.engineInit(opmode,key,random) end
...
---@param random java.security.SecureRandom the source of randomness
---@return void # 
function DESedeCipher.engineInit(opmode,key,params,random) end
...
function DESedeCipher.engineUpdate(input,inputOffset,inputLen) end
...
function DESedeCipher.engineUpdate(input,inputOffset,inputLen,output,outputOffset) end

---@param input byte[] the input buffer
---@param inputOffset int the offset in <code>input</code> where the input starts
---@param inputLen int the input length
---@return byte[] # the new buffer with the result
function DESedeCipher.engineDoFinal(input,inputOffset,inputLen) end
...
---@param outputOffset int the offset in <code>output</code> where the result is stored
---@return int # the number of bytes stored in <code>output</code>
function DESedeCipher.engineDoFinal(input,inputOffset,inputLen,output,outputOffset) end
...
function DESedeCipher.engineUnwrap(wrappedKey,wrappedKeyAlgorithm,wrappedKeyType) end
