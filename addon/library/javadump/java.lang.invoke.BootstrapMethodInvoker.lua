...
function BootstrapMethodInvoker.invoke(resultType,bootstrapMethod,name,type,info,callerClass) end

---@param result java.lang.Object 
---@param resultType java.lang.Class 
---@return T # 
function BootstrapMethodInvoker.widenAndCast(result,resultType) end
...
function BootstrapMethodInvoker.invokeWithManyArguments(bootstrapMethod,caller,name,type,argv) end
...
function BootstrapMethodInvoker.isStringConcatFactoryBSM(bsmType) end
...
function BootstrapMethodInvoker.isLambdaMetafactoryCondyBSM(bsmType) end
...
function BootstrapMethodInvoker.isLambdaMetafactoryIndyBSM(bsmType) end
...
function BootstrapMethodInvoker.isLambdaMetafactoryAltMetafactoryBSM(bsmType) end

---@param x java.lang.Object 
---@return java.lang.Object # 
function BootstrapMethodInvoker.maybeReBox(x) end

---@param xa Object[] 
---@return void # 
function BootstrapMethodInvoker.maybeReBoxElements(xa) end

---@param bsm java.lang.invoke.MethodHandle 
---@param goToPushMode boolean 
---@return java.lang.invoke.MethodHandle # 
function BootstrapMethodInvoker.pushMePullYou(bsm,goToPushMode) end
