...
function BootstrapCallInfo.bootstrapMethod(self, ) end

---@return java.lang.String # the method name or constant name
function BootstrapCallInfo.invocationName(self, ) end

---@return T # the method type or constant type
function BootstrapCallInfo.invocationType(self, ) end
...
function BootstrapCallInfo.makeBootstrapCallInfo(self, bsm,name,type,constants) end
