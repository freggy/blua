...
---@return boolean # 
function MainMethodFinder.correctArgs(self, method) end
...
---@return void # 
function MainMethodFinder.gatherMains(self, refc,mains,isMainClass) end
...
function MainMethodFinder.compareMethods(self, a,b) end

---@param mainClass java.lang.Class main class
---@return java.lang.reflect.Method # main method or null
function MainMethodFinder.getTraditionalMain(self, mainClass) end

---@param mainClass java.lang.Class main class
---@return java.lang.reflect.Method # 
function MainMethodFinder.findMainMethod(self, mainClass) end
