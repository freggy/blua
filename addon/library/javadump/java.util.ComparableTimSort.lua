...
---@return void # 
function ComparableTimSort.sort(self, a,lo,hi,work,workBase,workLen) end
...
---@return void # 
function ComparableTimSort.binarySort(self, a,lo,hi,start) end
...
function ComparableTimSort.countRunAndMakeAscending(self, a,lo,hi) end
...
---@return void # 
function ComparableTimSort.reverseRange(self, a,lo,hi) end

---@param n int the length of the array to be sorted
---@return int # the length of the minimum run to be merged
function ComparableTimSort.minRunLength(self, n) end

---@param runBase int index of the first element in the run
---@param runLen int the number of elements in the run
---@return void # 
function ComparableTimSort.pushRun(self, runBase,runLen) end

---@return void # 
function ComparableTimSort.mergeCollapse(self, ) end

---@return void # 
function ComparableTimSort.mergeForceCollapse(self, ) end

---@param i int stack index of the first of the two runs to merge
---@return void # 
function ComparableTimSort.mergeAt(self, i) end
...
function ComparableTimSort.gallopLeft(self, key,a,base,len,hint) end
...
function ComparableTimSort.gallopRight(self, key,a,base,len,hint) end
...
---@return void # 
function ComparableTimSort.mergeLo(self, base1,len1,base2,len2) end
...
---@param len2 int length of second run to be merged (must be > 0)
---@return void # 
function ComparableTimSort.mergeHi(self, base1,len1,base2,len2) end

---@param minCapacity int the minimum required capacity of the tmp array
---@return Object[] # tmp, whether or not it grew
function ComparableTimSort.ensureCapacity(self, minCapacity) end
