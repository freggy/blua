...
function Predicate.test(self, t) end
...
function Predicate.or(self, other) end
...
function Predicate.isEqual(self, targetRef) end
...
function Predicate.not(self, target) end
