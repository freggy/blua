...
---@return boolean # 
function PreSharedKeyExtension.canRejoin(self, clientHello,shc,s) end
...
---@param binder byte[] 
---@return void # 
function PreSharedKeyExtension.checkBinder(self, shc,session,pskBinderHash,binder) end
...
---@param pskBinderHash sun.security.ssl.HandshakeHash 
---@return byte[] # 
function PreSharedKeyExtension.computeBinder(self, context,binderKey,session,pskBinderHash) end
...
---@return byte[] # 
function PreSharedKeyExtension.computeBinder(self, context,binderKey,hash,session,ctx,hello,pskPrototype) end
...
---@param digest byte[] 
---@return byte[] # 
function PreSharedKeyExtension.computeBinder(self, context,binderKey,session,digest) end

---@param context sun.security.ssl.HandshakeContext 
---@param psk javax.crypto.SecretKey 
---@param session sun.security.ssl.SSLSessionImpl 
---@return javax.crypto.SecretKey # 
function PreSharedKeyExtension.deriveBinderKey(self, context,psk,session) end
