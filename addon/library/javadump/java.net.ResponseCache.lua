...
function ResponseCache.getDefault(self, ) end

---@param responseCache java.net.ResponseCache The response cache, or          {@code null} to unset the cache.
---@return void # 
function ResponseCache.setDefault(self, responseCache) end
...
function ResponseCache.get(self, uri,rqstMethod,rqstHeaders) end
...
function ResponseCache.put(self, uri,conn) end
