...
function FileSystemProvider.checkPermission() end

---@return java.util.List # 
function FileSystemProvider.loadInstalledProviders() end
...
function FileSystemProvider.newFileSystem(uri,env) end

---@param uri java.net.URI URI reference
---@return java.nio.file.FileSystem # The file system
function FileSystemProvider.getFileSystem(uri) end

---@param uri java.net.URI The URI to convert
---@return java.nio.file.Path # The resulting {@code Path}
function FileSystemProvider.getPath(uri) end

---@param path java.nio.file.Path The path to the file
---@param env java.util.Map A map of provider specific properties to configure the file system;          may be empty
---@return java.nio.file.FileSystem # A new file system
function FileSystemProvider.newFileSystem(path,env) end
...
function FileSystemProvider.newInputStream(path,options) end

---@param path java.nio.file.Path the path to the file to open or create
---@param options java.nio.file.OpenOption options specifying how the file is opened
---@return java.io.OutputStream # a new output stream
function FileSystemProvider.newOutputStream(path,options) end
...
function FileSystemProvider.newFileChannel(path,options,attrs) end
...
function FileSystemProvider.newAsynchronousFileChannel(path,options,executor,attrs) end

---@param path java.nio.file.Path the path to the file to open or create
---@param options java.util.Set options specifying how the file is opened
---@param attrs java.nio.file.attribute.FileAttribute an optional list of file attributes to set atomically when          creating the file
---@return java.nio.channels.SeekableByteChannel # a new seekable byte channel
function FileSystemProvider.newByteChannel(path,options,attrs) end
...
function FileSystemProvider.newDirectoryStream(dir,filter) end
...
---@return void # 
function FileSystemProvider.createDirectory(dir,attrs) end
...
---@return void # 
function FileSystemProvider.createSymbolicLink(link,target,attrs) end
...
---@return void # 
function FileSystemProvider.createLink(link,existing) end

---@param path java.nio.file.Path the path to the file to delete
---@return void # 
function FileSystemProvider.delete(path) end
...
---@return void # 
function FileSystemProvider.copy(source,target,options) end
...
---@return void # 
function FileSystemProvider.move(source,target,options) end
...
---@return void # 
function FileSystemProvider.checkAccess(path,modes) end
...
function FileSystemProvider.getFileAttributeView(path,type,options) end

---@param path java.nio.file.Path the path to the file
---@param type java.lang.Class the {@code Class} of the file attributes required          to read
---@param options java.nio.file.LinkOption options indicating how symbolic links are handled
---@return A # the file attributes
function FileSystemProvider.readAttributes(path,type,options) end
...
function FileSystemProvider.readAttributes(path,attributes,options) end
...
---@param options java.nio.file.LinkOption options indicating how symbolic links are handled
---@return void # 
function FileSystemProvider.setAttribute(path,attribute,value,options) end

---@param path java.nio.file.Path the path to the file to test
---@param options java.nio.file.LinkOption options indicating how symbolic links are handled
---@return boolean # {@code true} if the file exists; {@code false} if the file does          not exist or its existence cannot be determined.
function FileSystemProvider.exists(path,options) end

---@param path java.nio.file.Path the path to the file
---@param type java.lang.Class the {@code Class} of the file attributes required          to read
---@param options java.nio.file.LinkOption options indicating how symbolic links are handled
---@return A # the file attributes or null if the file does not exist
function FileSystemProvider.readAttributesIfExists(path,type,options) end

---@param options java.nio.file.LinkOption 
---@return boolean # 
function FileSystemProvider.followLinks(options) end
