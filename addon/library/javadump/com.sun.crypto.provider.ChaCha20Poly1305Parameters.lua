...
---@return void # 
function ChaCha20Poly1305Parameters.engineInit(self, paramSpec) end

---@param encoded byte[] the DER encoding of the nonce as an OCTET STRING.
---@return void # 
function ChaCha20Poly1305Parameters.engineInit(self, encoded) end
...
---@return void # 
function ChaCha20Poly1305Parameters.engineInit(self, encoded,decodingMethod) end
...
function ChaCha20Poly1305Parameters.engineGetParameterSpec(self, paramSpec) end
...
function ChaCha20Poly1305Parameters.engineGetEncoded(self, ) end
...
function ChaCha20Poly1305Parameters.engineGetEncoded(self, encodingMethod) end

---@return java.lang.String # a string representation of the ChaCha20 parameters.
function ChaCha20Poly1305Parameters.engineToString(self, ) end
