...
function Bundles.of(baseName,locale,strategy) end

---@param baseName java.lang.String 
---@param targetLocale java.util.Locale 
---@param strategy sun.util.resources.Bundles.Strategy 
---@return java.util.ResourceBundle # 
function Bundles.loadBundleOf(baseName,targetLocale,strategy) end
...
---@param index int 
---@return java.util.ResourceBundle # 
function Bundles.findBundleOf(cacheKey,strategy,baseName,candidateLocales,index) end

---@return void # 
function Bundles.cleanupCache() end
...
---@param cacheKey sun.util.resources.Bundles.CacheKey 
---@return java.util.ResourceBundle # 
function Bundles.loadBundleFromProviders(baseName,locale,providers,cacheKey) end

---@param bundle java.util.ResourceBundle 
---@return boolean # 
function Bundles.isValidBundle(bundle) end

---@param baseName java.lang.String 
---@param locale java.util.Locale 
---@param cause java.lang.Throwable 
---@return void # 
function Bundles.throwMissingResourceException(baseName,locale,cause) end
...
function Bundles.findBundleInCache(cacheKey) end
...
function Bundles.putBundleInCache(cacheKey,bundle) end
...
function Bundles.toOtherBundleName(baseName,bundleName,locale) end
