...
function BanList.getBanEntry(self, target) end
...
function BanList.addBan(self, target,reason,expires,source) end
...
---@param source java.lang.String source of the ban, null indicates implementation default
---@return org.bukkit.BanEntry # the entry for the newly created ban, or the entry for the     (updated) previous ban
function BanList.addBan(self, target,reason,duration,source) end

---@return java.util.Set # an immutable set containing every entry tracked by this list
function BanList.getBanEntries(self, ) end

---@return java.util.Set # an immutable set containing every entry tracked by this list
function BanList.getEntries(self, ) end
...
function BanList.isBanned(self, target) end
...
---@return void # 
function BanList.pardon(self, target) end
