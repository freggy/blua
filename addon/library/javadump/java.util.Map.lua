...
function Map.containsKey(self, key) end
...
function Map.containsValue(self, value) end
...
function Map.put(self, key,value) end
...
function Map.equals(self, o) end

---@return int # the hash code value for this map
function Map.hashCode(self, ) end
...
function Map.putIfAbsent(self, key,value) end
...
function Map.remove(self, key,value) end
...
function Map.replace(self, key,oldValue,newValue) end

---@param key K key with which the specified value is associated
---@param value V value to be associated with the specified key
---@return V # the previous value associated with the specified key, or         {@code null} if there was no mapping for the key.         (A {@code null} return can also indicate that the map         previously associated {@code null} with the key,         if the implementation supports null values.)
function Map.replace(self, key,value) end
...
function Map.computeIfAbsent(self, key,mappingFunction) end
...
function Map.computeIfPresent(self, key,remappingFunction) end

---@param key K key with which the specified value is to be associated
---@param remappingFunction java.util.function.BiFunction the remapping function to compute a value
---@return V # the new value associated with the specified key, or null if none
function Map.compute(self, key,remappingFunction) end
...
function Map.merge(self, key,value,remappingFunction) end

---@return java.util.Map # an empty {@code Map}
function Map.of(self, ) end
...
function Map.of(self, k1,v1) end
...
function Map.of(self, k1,v1,k2,v2) end
...
---@return java.util.Map # a {@code Map} containing the specified mappings
function Map.of(self, k1,v1,k2,v2,k3,v3) end
...
---@return java.util.Map # a {@code Map} containing the specified mappings
function Map.of(self, k1,v1,k2,v2,k3,v3,k4,v4) end
...
---@return java.util.Map # a {@code Map} containing the specified mappings
function Map.of(self, k1,v1,k2,v2,k3,v3,k4,v4,k5,v5) end
...
---@return java.util.Map # a {@code Map} containing the specified mappings
function Map.of(self, k1,v1,k2,v2,k3,v3,k4,v4,k5,v5,k6,v6) end
...
---@return java.util.Map # a {@code Map} containing the specified mappings
function Map.of(self, k1,v1,k2,v2,k3,v3,k4,v4,k5,v5,k6,v6,k7,v7) end
...
---@return java.util.Map # a {@code Map} containing the specified mappings
function Map.of(self, k1,v1,k2,v2,k3,v3,k4,v4,k5,v5,k6,v6,k7,v7,k8,v8) end
...
---@return java.util.Map # a {@code Map} containing the specified mappings
function Map.of(self, k1,v1,k2,v2,k3,v3,k4,v4,k5,v5,k6,v6,k7,v7,k8,v8,k9,v9) end
...
function Map.copyOf(self, map) end
