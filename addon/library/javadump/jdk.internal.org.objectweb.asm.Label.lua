...
function Label.getOffset(self, ) end
...
function Label.getCanonicalInstance(self, ) end

---@param lineNumber int a source line number (which should be strictly positive).
---@return void # 
function Label.addLineNumber(self, lineNumber) end
...
---@return void # 
function Label.accept(self, methodVisitor,visitLineNumbers) end
...
---@return void # 
function Label.put(self, code,sourceInsnBytecodeOffset,wideReference) end
...
---@return void # 
function Label.addForwardReference(self, sourceInsnBytecodeOffset,referenceType,referenceHandle) end
...
---@return void # 
function Label.addSubroutineRetSuccessors(self, subroutineCaller) end
...
function Label.pushSuccessors(self, listOfLabelsToProcess) end

---@return java.lang.String # a string representation of this label.
function Label.toString(self, ) end
