...
function StringTemplateImplFactory.createStringTemplateImplMH(self, fragments,type) end
...
function StringTemplateImplFactory.newTrustedStringTemplate(self, fragments,values) end
...
function StringTemplateImplFactory.newStringTemplate(self, fragments,values) end

---@param elements Object[] elements to place in list
---@return java.util.List # unmodifiable list.
function StringTemplateImplFactory.toList(self, elements) end
