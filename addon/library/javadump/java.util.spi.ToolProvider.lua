...
function ToolProvider.name(self, ) end

---@return java.util.Optional # 
function ToolProvider.description(self, ) end
...
function ToolProvider.run(self, out,err,args) end
...
function ToolProvider.findFirst(self, name) end
