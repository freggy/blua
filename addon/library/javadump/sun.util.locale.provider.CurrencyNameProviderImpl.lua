...
function CurrencyNameProviderImpl.getAvailableLanguageTags(self, ) end

---@return Locale[] # An array of all locales for which this locale service provider can provide localized objects or names.
function CurrencyNameProviderImpl.getAvailableLocales(self, ) end
...
function CurrencyNameProviderImpl.getSymbol(self, currencyCode,locale) end
...
function CurrencyNameProviderImpl.getDisplayName(self, currencyCode,locale) end

---@param key java.lang.String 
---@param locale java.util.Locale 
---@return java.lang.String # 
function CurrencyNameProviderImpl.getString(self, key,locale) end
