...
function CertificateFactory.getInstance(self, type) end
...
---@return java.security.cert.CertificateFactory # a certificate factory object for the specified type
function CertificateFactory.getInstance(self, type,provider) end
...
function CertificateFactory.generateCertificate(self, inStream) end

---@return java.util.Iterator # an {@code Iterator} over the names of the supported         {@code CertPath} encodings (as {@code String}s)
function CertificateFactory.getCertPathEncodings(self, ) end
...
function CertificateFactory.generateCertPath(self, inStream) end

---@param inStream java.io.InputStream an {@code InputStream} containing the data
---@param encoding java.lang.String the encoding used for the data
---@return java.security.cert.CertPath # a {@code CertPath} initialized with the data from the   {@code InputStream}
function CertificateFactory.generateCertPath(self, inStream,encoding) end
...
function CertificateFactory.generateCertPath(self, certificates) end
...
function CertificateFactory.generateCertificates(self, inStream) end
...
function CertificateFactory.generateCRL(self, inStream) end
...
function CertificateFactory.generateCRLs(self, inStream) end
