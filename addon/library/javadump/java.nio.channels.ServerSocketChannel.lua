...
function ServerSocketChannel.open(self, ) end

---@param family java.net.ProtocolFamily The protocol family
---@return java.nio.channels.ServerSocketChannel # A new socket channel
function ServerSocketChannel.open(self, family) end

---@return int # The valid-operation set
function ServerSocketChannel.validOps(self, ) end
...
function ServerSocketChannel.bind(self, local) end
...
---@return java.nio.channels.ServerSocketChannel # This channel
function ServerSocketChannel.bind(self, local,backlog) end

---@param name java.net.SocketOption 
---@param value T 
---@return java.nio.channels.ServerSocketChannel # 
function ServerSocketChannel.setOption(self, name,value) end

---@return java.net.ServerSocket # A server socket associated with this channel
function ServerSocketChannel.socket(self, ) end
...
function ServerSocketChannel.accept(self, ) end
...
function ServerSocketChannel.getLocalAddress(self, ) end
