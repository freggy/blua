...
function CalendarNameProvider.getDisplayName(calendarType,field,value,style,locale) end
...
function CalendarNameProvider.getDisplayNames(calendarType,field,style,locale) end
