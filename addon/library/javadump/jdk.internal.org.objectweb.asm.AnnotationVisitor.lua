...
---@return void # 
function AnnotationVisitor.visit(self, name,value) end
...
---@return void # 
function AnnotationVisitor.visitEnum(self, name,descriptor,value) end
...
function AnnotationVisitor.visitAnnotation(self, name,descriptor) end
...
function AnnotationVisitor.visitArray(self, name) end

---@return void # 
function AnnotationVisitor.visitEnd(self, ) end
