...
function TransferQueue.tryTransfer(e) end

---@param e E the element to transfer
---@return void # 
function TransferQueue.transfer(e) end
...
function TransferQueue.tryTransfer(e,timeout,unit) end

---@return boolean # {@code true} if there is at least one waiting consumer
function TransferQueue.hasWaitingConsumer() end

---@return int # the number of consumers waiting to receive elements
function TransferQueue.getWaitingConsumerCount() end
