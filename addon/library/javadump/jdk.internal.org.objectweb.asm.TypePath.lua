...
function TypePath.getLength(self, ) end
...
function TypePath.getStep(self, index) end

---@param index int an index between 0 and {@link #getLength()}, exclusive.
---@return int # the index of the type argument that the given step is stepping into.
function TypePath.getStepArgument(self, index) end
...
function TypePath.fromString(self, typePath) end

---@return java.lang.String # 
function TypePath.toString(self, ) end
...
---@return void # 
function TypePath.put(self, typePath,output) end
