...
function DateTimeTextProvider.getInstance(self, ) end
...
function DateTimeTextProvider.getText(self, field,value,style,locale) end
...
---@param locale java.util.Locale the locale to get text for, not null
---@return java.lang.String # the text for the field value, null if no text found
function DateTimeTextProvider.getText(self, chrono,field,value,style,locale) end
...
function DateTimeTextProvider.getTextIterator(self, field,style,locale) end
...
---@param locale java.util.Locale the locale to get text for, not null
---@return java.util.Iterator # the iterator of text to field pairs, in order from longest text to shortest text,  null if the field or style is not parsable
function DateTimeTextProvider.getTextIterator(self, chrono,field,style,locale) end

---@param field java.time.temporal.TemporalField 
---@param locale java.util.Locale 
---@return java.lang.Object # 
function DateTimeTextProvider.findStore(self, field,locale) end

---@param calWeekDay int 
---@return int # 
function DateTimeTextProvider.toWeekDay(self, calWeekDay) end

---@param field java.time.temporal.TemporalField 
---@param locale java.util.Locale 
---@return java.lang.Object # 
function DateTimeTextProvider.createStore(self, field,locale) end

---@param text A the text, not null
---@param field B the field, not null
---@return java.util.Map.Entry # the entry, not null
function DateTimeTextProvider.createEntry(self, text,field) end
...
function DateTimeTextProvider.getLocalizedResource(self, key,locale) end
