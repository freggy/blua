...
---@return void # 
function DESedeKeyGenerator.engineInit(random) end
...
---@return void # 
function DESedeKeyGenerator.engineInit(params,random) end
...
---@param random java.security.SecureRandom the source of randomness for this key generator
---@return void # 
function DESedeKeyGenerator.engineInit(keysize,random) end

---@return javax.crypto.SecretKey # the new Triple DES key
function DESedeKeyGenerator.engineGenerateKey() end
