...
function HandshakeCompletedEvent.getSession() end

---@return java.lang.String # the name of the cipher suite negotiated during this session.
function HandshakeCompletedEvent.getCipherSuite() end
...
function HandshakeCompletedEvent.getLocalCertificates() end
...
function HandshakeCompletedEvent.getPeerCertificates() end
...
function HandshakeCompletedEvent.getPeerCertificateChain() end
...
function HandshakeCompletedEvent.getPeerPrincipal() end
...
function HandshakeCompletedEvent.getLocalPrincipal() end

---@return javax.net.ssl.SSLSocket # the socket on which the connection was made.
function HandshakeCompletedEvent.getSocket() end
