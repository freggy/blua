...
---@return void # 
function StaticInitMerger.visit(version,access,name,signature,superName,interfaces) end
...
function StaticInitMerger.visitMethod(access,name,descriptor,signature,exceptions) end

---@return void # 
function StaticInitMerger.visitEnd() end
