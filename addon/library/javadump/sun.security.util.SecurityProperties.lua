...
function SecurityProperties.privilegedGetOverridable(propName) end

---@param propName java.lang.String 
---@return java.lang.String # 
function SecurityProperties.getOverridableProperty(propName) end
...
function SecurityProperties.includedInExceptions(refName) end
