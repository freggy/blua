...
function SecretKeyFactorySpi.engineGenerateSecret(self, keySpec) end
...
function SecretKeyFactorySpi.engineGetKeySpec(self, key,keySpec) end
...
function SecretKeyFactorySpi.engineTranslateKey(self, key) end
