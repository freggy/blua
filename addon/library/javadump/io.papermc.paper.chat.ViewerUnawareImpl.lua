...
function ViewerUnawareImpl.render(self, source,sourceDisplayName,message,viewer) end

---@param source org.bukkit.entity.Player 
---@param sourceDisplayName net.kyori.adventure.text.Component 
---@param message net.kyori.adventure.text.Component 
---@return net.kyori.adventure.text.Component # 
function ViewerUnawareImpl.render(self, source,sourceDisplayName,message) end
