...
function Validator.getInstance(self, type,variant,ks) end

---@param type java.lang.String 
---@param variant java.lang.String 
---@param trustedCerts java.util.Collection 
---@return sun.security.validator.Validator # 
function Validator.getInstance(self, type,variant,trustedCerts) end

---@param type java.lang.String 
---@param variant java.lang.String 
---@param params java.security.cert.PKIXBuilderParameters 
---@return sun.security.validator.Validator # 
function Validator.getInstance(self, type,variant,params) end

---@param chain X509Certificate[] 
---@return X509Certificate[] # 
function Validator.validate(self, chain) end

---@param chain X509Certificate[] 
---@param otherCerts java.util.Collection 
---@return X509Certificate[] # 
function Validator.validate(self, chain,otherCerts) end
...
function Validator.validate(self, chain,otherCerts,parameter) end
...
---@return X509Certificate[] # a non-empty chain that was used to validate the path. The        end entity cert is at index 0, the trust anchor at index n-1.
function Validator.validate(self, chain,otherCerts,responseList,constraints,parameter) end
...
---@param parameter java.lang.Object 
---@return X509Certificate[] # 
function Validator.engineValidate(self, chain,otherCerts,responseList,constraints,parameter) end

---@return java.util.Collection # 
function Validator.getTrustedCertificates(self, ) end

---@param validationDate java.util.Date 
---@return void # 
function Validator.setValidationDate(self, validationDate) end
