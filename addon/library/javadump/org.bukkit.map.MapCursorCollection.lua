...
function MapCursorCollection.addCursor(self, x,y,direction) end
...
---@return org.bukkit.map.MapCursor # The newly added MapCursor.
function MapCursorCollection.addCursor(self, x,y,direction,type) end
...
---@return org.bukkit.map.MapCursor # The newly added MapCursor.
function MapCursorCollection.addCursor(self, x,y,direction,type,visible) end
...
---@return org.bukkit.map.MapCursor # The newly added MapCursor.
function MapCursorCollection.addCursor(self, x,y,direction,type,visible,caption) end
