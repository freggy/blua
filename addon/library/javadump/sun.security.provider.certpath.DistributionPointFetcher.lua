...
function DistributionPointFetcher.getCRLs(selector,signFlag,prevKey,prevCert,provider,certStores,reasonsMask,trustAnchors,validity,variant,anchor) end
...
---@param anchor java.security.cert.TrustAnchor 
---@return java.util.Collection # 
function DistributionPointFetcher.getCRLs(selector,certImpl,point,reasonsMask,signFlag,prevKey,prevCert,provider,certStores,trustAnchors,validity,variant,anchor) end

---@param name sun.security.x509.URIName 
---@return java.security.cert.X509CRL # 
function DistributionPointFetcher.getCRL(name) end

---@param name sun.security.x509.X500Name 
---@param certIssuer javax.security.auth.x500.X500Principal 
---@param certStores java.util.List 
---@return java.util.Collection # 
function DistributionPointFetcher.getCRLs(name,certIssuer,certStores) end
...
function DistributionPointFetcher.verifyCRL(certImpl,point,crl,reasonsMask,signFlag,prevKey,prevCert,provider,trustAnchors,certStores,validity,variant,anchor) end

---@param issuer sun.security.x509.X500Name 
---@param rdn sun.security.x509.RDN 
---@return sun.security.x509.GeneralNames # 
function DistributionPointFetcher.getFullNames(issuer,rdn) end
...
---@return boolean # 
function DistributionPointFetcher.issues(cert,crl,provider) end
