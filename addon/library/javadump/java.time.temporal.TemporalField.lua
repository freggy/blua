...
function TemporalField.getDisplayName(locale) end
...
function TemporalField.isSupportedBy(temporal) end
...
function TemporalField.rangeRefinedBy(temporal) end

---@param temporal java.time.temporal.TemporalAccessor the temporal object to query, not null
---@return long # the value of this field, not null
function TemporalField.getFrom(temporal) end
...
function TemporalField.adjustInto(temporal,newValue) end
...
function TemporalField.resolve(fieldValues,partialTemporal,resolverStyle) end
