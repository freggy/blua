...
function ConfirmationCallback.getPrompt(self, ) end

---@return int # the message type ({@code INFORMATION},          {@code WARNING} or {@code ERROR}).
function ConfirmationCallback.getMessageType(self, ) end
...
function ConfirmationCallback.getOptionType(self, ) end
...
function ConfirmationCallback.getOptions(self, ) end
...
function ConfirmationCallback.getDefaultOption(self, ) end
...
---@return void # 
function ConfirmationCallback.setSelectedIndex(self, selection) end
...
function ConfirmationCallback.getSelectedIndex(self, ) end
