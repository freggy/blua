...
---@return void # 
function Printer.visit(self, version,access,name,signature,superName,interfaces) end
...
---@return void # 
function Printer.visitSource(self, source,debug) end
...
function Printer.visitModule(self, name,access,version) end

---@param nestHost java.lang.String the internal name of the host class of the nest.
---@return void # 
function Printer.visitNestHost(self, nestHost) end
...
---@return void # 
function Printer.visitOuterClass(self, owner,name,descriptor) end
...
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitClassAnnotation(self, descriptor,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitClassTypeAnnotation(self, typeRef,typePath,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute an attribute.
---@return void # 
function Printer.visitClassAttribute(self, attribute) end

---@param nestMember java.lang.String the internal name of a nest member.
---@return void # 
function Printer.visitNestMember(self, nestMember) end

---@param permittedSubclass java.lang.String the internal name of a permitted subclass.
---@return void # 
function Printer.visitPermittedSubclass(self, permittedSubclass) end
...
---@return void # 
function Printer.visitInnerClass(self, name,outerName,innerName,access) end
...
function Printer.visitRecordComponent(self, name,descriptor,signature) end
...
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitField(self, access,name,descriptor,signature,value) end
...
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitMethod(self, access,name,descriptor,signature,exceptions) end

---@return void # 
function Printer.visitClassEnd(self, ) end

---@param mainClass java.lang.String the internal name of the main class of the current module.
---@return void # 
function Printer.visitMainClass(self, mainClass) end

---@param packaze java.lang.String the internal name of a package.
---@return void # 
function Printer.visitPackage(self, packaze) end
...
---@return void # 
function Printer.visitRequire(self, module,access,version) end
...
---@return void # 
function Printer.visitExport(self, packaze,access,modules) end
...
---@return void # 
function Printer.visitOpen(self, packaze,access,modules) end

---@param service java.lang.String the internal name of the service.
---@return void # 
function Printer.visitUse(self, service) end

---@param service java.lang.String the internal name of the service.
---@param providers java.lang.String the internal names of the implementations of the service (there is at least     one provider).
---@return void # 
function Printer.visitProvide(self, service,providers) end

---@return void # 
function Printer.visitModuleEnd(self, ) end

---@param name java.lang.String 
---@param value java.lang.Object 
---@return void # 
function Printer.visit(self, name,value) end
...
---@return void # 
function Printer.visitEnum(self, name,descriptor,value) end

---@param name java.lang.String the value name.
---@param descriptor java.lang.String the class descriptor of the nested annotation class.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitAnnotation(self, name,descriptor) end

---@param name java.lang.String the value name.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitArray(self, name) end

---@return void # 
function Printer.visitAnnotationEnd(self, ) end
...
function Printer.visitRecordComponentAnnotation(self, descriptor,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # a visitor to visit the annotation values, or {@literal null} if this visitor is not     interested in visiting this annotation.
function Printer.visitRecordComponentTypeAnnotation(self, typeRef,typePath,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute an attribute.
---@return void # 
function Printer.visitRecordComponentAttribute(self, attribute) end

---@return void # 
function Printer.visitRecordComponentEnd(self, ) end

---@param descriptor java.lang.String the class descriptor of the annotation class.
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitFieldAnnotation(self, descriptor,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitFieldTypeAnnotation(self, typeRef,typePath,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute an attribute.
---@return void # 
function Printer.visitFieldAttribute(self, attribute) end

---@return void # 
function Printer.visitFieldEnd(self, ) end
...
---@return void # 
function Printer.visitParameter(self, name,access) end

---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitAnnotationDefault(self, ) end

---@param descriptor java.lang.String the class descriptor of the annotation class.
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitMethodAnnotation(self, descriptor,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitMethodTypeAnnotation(self, typeRef,typePath,descriptor,visible) end
...
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitAnnotableParameterCount(self, parameterCount,visible) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitParameterAnnotation(self, parameter,descriptor,visible) end

---@param attribute jdk.internal.org.objectweb.asm.Attribute an attribute.
---@return void # 
function Printer.visitMethodAttribute(self, attribute) end

---@return void # 
function Printer.visitCode(self, ) end
...
---@return void # 
function Printer.visitFrame(self, type,numLocal,local,numStack,stack) end
...
---@return void # 
function Printer.visitInsn(self, opcode) end
...
---@return void # 
function Printer.visitIntInsn(self, opcode,operand) end
...
---@return void # 
function Printer.visitVarInsn(self, opcode,varIndex) end
...
---@return void # 
function Printer.visitTypeInsn(self, opcode,type) end
...
---@param descriptor java.lang.String the field's descriptor (see {@link jdk.internal.org.objectweb.asm.Type}).
---@return void # 
function Printer.visitFieldInsn(self, opcode,owner,name,descriptor) end
...
---@param descriptor java.lang.String the method's descriptor (see {@link jdk.internal.org.objectweb.asm.Type}).
---@return void # 
function Printer.visitMethodInsn(self, opcode,owner,name,descriptor) end
...
---@return void # 
function Printer.visitMethodInsn(self, opcode,owner,name,descriptor,isInterface) end
...
---@return void # 
function Printer.visitInvokeDynamicInsn(self, name,descriptor,bootstrapMethodHandle,bootstrapMethodArguments) end
...
---@return void # 
function Printer.visitJumpInsn(self, opcode,label) end

---@param label jdk.internal.org.objectweb.asm.Label a {@link Label} object.
---@return void # 
function Printer.visitLabel(self, label) end
...
---@return void # 
function Printer.visitLdcInsn(self, value) end
...
---@return void # 
function Printer.visitIincInsn(self, varIndex,increment) end
...
---@return void # 
function Printer.visitTableSwitchInsn(self, min,max,dflt,labels) end
...
---@return void # 
function Printer.visitLookupSwitchInsn(self, dflt,keys,labels) end
...
---@return void # 
function Printer.visitMultiANewArrayInsn(self, descriptor,numDimensions) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitInsnAnnotation(self, typeRef,typePath,descriptor,visible) end
...
---@return void # 
function Printer.visitTryCatchBlock(self, start,end,handler,type) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitTryCatchAnnotation(self, typeRef,typePath,descriptor,visible) end
...
---@return void # 
function Printer.visitLocalVariable(self, name,descriptor,signature,start,end,index) end
...
---@param visible boolean {@literal true} if the annotation is visible at runtime.
---@return jdk.internal.org.objectweb.asm.util.Printer # the printer.
function Printer.visitLocalVariableAnnotation(self, typeRef,typePath,start,end,index,descriptor,visible) end
...
---@return void # 
function Printer.printList(self, printWriter,list) end
...
---@return void # 
function Printer.appendString(self, stringBuilder,string) end
...
---@return void # 
function Printer.main(self, args,usage,printer,output,logger) end
