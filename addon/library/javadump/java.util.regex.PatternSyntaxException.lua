...
function PatternSyntaxException.getIndex() end

---@return java.lang.String # The description of the error
function PatternSyntaxException.getDescription() end

---@return java.lang.String # The erroneous pattern
function PatternSyntaxException.getPattern() end

---@return java.lang.String # The full detail message
function PatternSyntaxException.getMessage() end
