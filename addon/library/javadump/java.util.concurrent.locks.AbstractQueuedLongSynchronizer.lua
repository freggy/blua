...
function AbstractQueuedLongSynchronizer.getState(self, ) end

---@param newState long the new state value
---@return void # 
function AbstractQueuedLongSynchronizer.setState(self, newState) end
...
function AbstractQueuedLongSynchronizer.compareAndSetState(self, expect,update) end
...
---@return boolean # 
function AbstractQueuedLongSynchronizer.casTail(self, c,v) end

---@return java.util.concurrent.locks.AbstractQueuedLongSynchronizer.Node # 
function AbstractQueuedLongSynchronizer.tryInitializeHead(self, ) end

---@param node java.util.concurrent.locks.AbstractQueuedLongSynchronizer.ConditionNode 
---@return void # 
function AbstractQueuedLongSynchronizer.enqueue(self, node) end

---@param node java.util.concurrent.locks.AbstractQueuedLongSynchronizer.Node 
---@return boolean # 
function AbstractQueuedLongSynchronizer.isEnqueued(self, node) end

---@param h java.util.concurrent.locks.AbstractQueuedLongSynchronizer.Node 
---@return void # 
function AbstractQueuedLongSynchronizer.signalNext(self, h) end

---@param h java.util.concurrent.locks.AbstractQueuedLongSynchronizer.Node 
---@return void # 
function AbstractQueuedLongSynchronizer.signalNextIfShared(self, h) end
...
function AbstractQueuedLongSynchronizer.acquire(self, node,arg,shared,interruptible,timed,time) end

---@param shared boolean 
---@param arg long 
---@return int # 
function AbstractQueuedLongSynchronizer.acquireOnOOME(self, shared,arg) end

---@return void # 
function AbstractQueuedLongSynchronizer.cleanQueue(self, ) end
...
---@return int # 
function AbstractQueuedLongSynchronizer.cancelAcquire(self, node,interrupted,interruptible) end
...
function AbstractQueuedLongSynchronizer.tryAcquire(self, arg) end
...
function AbstractQueuedLongSynchronizer.tryRelease(self, arg) end
...
function AbstractQueuedLongSynchronizer.tryAcquireShared(self, arg) end
...
function AbstractQueuedLongSynchronizer.tryReleaseShared(self, arg) end

---@return boolean # {@code true} if synchronization is held exclusively;         {@code false} otherwise
function AbstractQueuedLongSynchronizer.isHeldExclusively(self, ) end
...
---@return void # 
function AbstractQueuedLongSynchronizer.acquire(self, arg) end

---@param arg long the acquire argument.  This value is conveyed to        {@link #tryAcquire} but is otherwise uninterpreted and        can represent anything you like.
---@return void # 
function AbstractQueuedLongSynchronizer.acquireInterruptibly(self, arg) end
...
function AbstractQueuedLongSynchronizer.tryAcquireNanos(self, arg,nanosTimeout) end
...
function AbstractQueuedLongSynchronizer.release(self, arg) end
...
---@return void # 
function AbstractQueuedLongSynchronizer.acquireShared(self, arg) end

---@param arg long the acquire argument. This value is conveyed to {@link #tryAcquireShared} but is otherwise uninterpreted and can represent anything you like.
---@return void # 
function AbstractQueuedLongSynchronizer.acquireSharedInterruptibly(self, arg) end

---@param arg long the acquire argument.  This value is conveyed to        {@link #tryAcquireShared} but is otherwise uninterpreted        and can represent anything you like.
---@param nanosTimeout long the maximum number of nanoseconds to wait
---@return boolean # {@code true} if acquired; {@code false} if timed out
function AbstractQueuedLongSynchronizer.tryAcquireSharedNanos(self, arg,nanosTimeout) end
...
function AbstractQueuedLongSynchronizer.releaseShared(self, arg) end

---@return boolean # {@code true} if there may be other threads waiting to acquire
function AbstractQueuedLongSynchronizer.hasQueuedThreads(self, ) end

---@return boolean # {@code true} if there has ever been contention
function AbstractQueuedLongSynchronizer.hasContended(self, ) end

---@return java.lang.Thread # the first (longest-waiting) thread in the queue, or         {@code null} if no threads are currently queued
function AbstractQueuedLongSynchronizer.getFirstQueuedThread(self, ) end

---@param thread java.lang.Thread the thread
---@return boolean # {@code true} if the given thread is on the queue
function AbstractQueuedLongSynchronizer.isQueued(self, thread) end

---@return boolean # 
function AbstractQueuedLongSynchronizer.apparentlyFirstQueuedIsExclusive(self, ) end
...
function AbstractQueuedLongSynchronizer.hasQueuedPredecessors(self, ) end

---@return int # the estimated number of threads waiting to acquire
function AbstractQueuedLongSynchronizer.getQueueLength(self, ) end

---@return java.util.Collection # the collection of threads
function AbstractQueuedLongSynchronizer.getQueuedThreads(self, ) end

---@return java.util.Collection # the collection of threads
function AbstractQueuedLongSynchronizer.getExclusiveQueuedThreads(self, ) end

---@return java.util.Collection # the collection of threads
function AbstractQueuedLongSynchronizer.getSharedQueuedThreads(self, ) end

---@return java.lang.String # a string identifying this synchronizer, as well as its state
function AbstractQueuedLongSynchronizer.toString(self, ) end
...
function AbstractQueuedLongSynchronizer.owns(self, condition) end

---@param condition java.util.concurrent.locks.AbstractQueuedLongSynchronizer.ConditionObject the condition
---@return boolean # {@code true} if there are any waiting threads
function AbstractQueuedLongSynchronizer.hasWaiters(self, condition) end

---@param condition java.util.concurrent.locks.AbstractQueuedLongSynchronizer.ConditionObject the condition
---@return int # the estimated number of waiting threads
function AbstractQueuedLongSynchronizer.getWaitQueueLength(self, condition) end

---@param condition java.util.concurrent.locks.AbstractQueuedLongSynchronizer.ConditionObject the condition
---@return java.util.Collection # the collection of threads
function AbstractQueuedLongSynchronizer.getWaitingThreads(self, condition) end
