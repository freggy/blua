...
function ClassReader.readStream(self, inputStream,close) end

---@param inputStream java.io.InputStream 
---@return int # 
function ClassReader.computeBufferSize(self, inputStream) end

---@return int # the class access flags.
function ClassReader.getAccess(self, ) end

---@return java.lang.String # the internal class name.
function ClassReader.getClassName(self, ) end

---@return java.lang.String # the internal name of the super class, or {@literal null} for {@link Object} class.
function ClassReader.getSuperName(self, ) end
...
function ClassReader.getInterfaces(self, ) end
...
---@return void # 
function ClassReader.accept(self, classVisitor,parsingOptions) end
...
---@param parsingOptions int the options to use to parse this class. One or more of {@link     #SKIP_CODE}, {@link #SKIP_DEBUG}, {@link #SKIP_FRAMES} or {@link #EXPAND_FRAMES}.
---@return void # 
function ClassReader.accept(self, classVisitor,attributePrototypes,parsingOptions) end
...
---@return void # 
function ClassReader.readModuleAttributes(self, classVisitor,context,moduleOffset,modulePackagesOffset,moduleMainClass) end
...
function ClassReader.readRecordComponent(self, classVisitor,context,recordComponentOffset) end
...
function ClassReader.readField(self, classVisitor,context,fieldInfoOffset) end
...
function ClassReader.readMethod(self, classVisitor,context,methodInfoOffset) end
...
---@return void # 
function ClassReader.readCode(self, methodVisitor,context,codeOffset) end
...
function ClassReader.readLabel(self, bytecodeOffset,labels) end
...
function ClassReader.createLabel(self, bytecodeOffset,labels) end

---@param bytecodeOffset int a bytecode offset in a method.
---@param labels Label[] the already created labels, indexed by their offset.
---@return void # 
function ClassReader.createDebugLabel(self, bytecodeOffset,labels) end
...
function ClassReader.readTypeAnnotations(self, methodVisitor,context,runtimeTypeAnnotationsOffset,visible) end
...
function ClassReader.getTypeAnnotationBytecodeOffset(self, typeAnnotationOffsets,typeAnnotationIndex) end
...
function ClassReader.readTypeAnnotationTarget(self, context,typeAnnotationOffset) end
...
---@return void # 
function ClassReader.readParameterAnnotations(self, methodVisitor,context,runtimeParameterAnnotationsOffset,visible) end
...
function ClassReader.readElementValues(self, annotationVisitor,annotationOffset,named,charBuffer) end
...
function ClassReader.readElementValue(self, annotationVisitor,elementValueOffset,elementName,charBuffer) end

---@param context jdk.internal.org.objectweb.asm.Context information about the class being parsed.
---@return void # 
function ClassReader.computeImplicitFrame(self, context) end
...
function ClassReader.readStackMapFrame(self, stackMapFrameOffset,compressed,expand,context) end
...
function ClassReader.readVerificationTypeInfo(self, verificationTypeInfoOffset,frame,index,charBuffer,labels) end

---@return int # the offset in {@link #classFileBuffer} of the first ClassFile's 'attributes' array     field entry.
function ClassReader.getFirstAttributeOffset(self, ) end
...
function ClassReader.readBootstrapMethodsAttribute(self, maxStringLength) end
...
function ClassReader.readAttribute(self, attributePrototypes,type,offset,length,charBuffer,codeAttributeOffset,labels) end

---@return int # the number of entries in the class's constant pool table.
function ClassReader.getItemCount(self, ) end
...
function ClassReader.readUTF8(self, offset,charBuffer) end
...
function ClassReader.readUtf(self, constantPoolEntryIndex,charBuffer) end
...
function ClassReader.readUtf(self, utfOffset,utfLength,charBuffer) end
...
function ClassReader.readStringish(self, offset,charBuffer) end
...
function ClassReader.readClass(self, offset,charBuffer) end
...
function ClassReader.readModule(self, offset,charBuffer) end
...
function ClassReader.readPackage(self, offset,charBuffer) end
...
function ClassReader.readConstantDynamic(self, constantPoolEntryIndex,charBuffer) end
...
function ClassReader.readConst(self, constantPoolEntryIndex,charBuffer) end
