...
function ModuleOpenInfo.openedPackage() end

---@return int # 
function ModuleOpenInfo.opensFlagsMask() end

---@return java.util.Set # 
function ModuleOpenInfo.opensFlags() end

---@param flag java.lang.reflect.AccessFlag the access flag
---@return boolean # 
function ModuleOpenInfo.has(flag) end

---@return java.util.List # the modules to which this package is opened
function ModuleOpenInfo.opensTo() end
...
function ModuleOpenInfo.of(opens,opensFlags,opensTo) end
