...
function ReentrantLock.tryLock(timeout,unit) end
...
function ReentrantLock.getOwner() end
...
function ReentrantLock.hasQueuedThread(thread) end
...
function ReentrantLock.getQueuedThreads() end
...
function ReentrantLock.hasWaiters(condition) end

---@param condition java.util.concurrent.locks.Condition the condition
---@return int # the estimated number of waiting threads
function ReentrantLock.getWaitQueueLength(condition) end

---@param condition java.util.concurrent.locks.Condition the condition
---@return java.util.Collection # the collection of threads
function ReentrantLock.getWaitingThreads(condition) end
