...
function LazyLoggers.accessLoggerFinder(self, ) end
...
function LazyLoggers.getLoggerFromFinder(self, name,module) end
...
function LazyLoggers.getLogger(self, name,module) end

---@param name java.lang.String the logger name
---@param module java.lang.Module the module on behalf of which the logger is created.
---@return java.lang.System.Logger # a (possibly lazy) Logger instance.
function LazyLoggers.getLazyLogger(self, name,module) end
