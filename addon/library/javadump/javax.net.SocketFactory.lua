...
function SocketFactory.getDefault(self, ) end

---@return java.net.Socket # the unconnected socket
function SocketFactory.createSocket(self, ) end
...
function SocketFactory.createSocket(self, host,port) end
...
---@return java.net.Socket # the <code>Socket</code>
function SocketFactory.createSocket(self, host,port,localHost,localPort) end
...
---@return java.net.Socket # the <code>Socket</code>
function SocketFactory.createSocket(self, address,port,localAddress,localPort) end
