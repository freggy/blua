...
function TypeAnnotation.targetInfo(self, ) end

---@return java.util.List # 
function TypeAnnotation.targetPath(self, ) end
...
function TypeAnnotation.of(self, targetInfo,targetPath,annotationClassUtf8Entry,annotationElements) end
...
---@return jdk.internal.classfile.TypeAnnotation # 
function TypeAnnotation.of(self, targetInfo,targetPath,annotationClass,annotationElements) end
