...
function LoggingMXBean.getLoggerNames() end
...
function LoggingMXBean.getLoggerLevel(loggerName) end
...
---@return void # 
function LoggingMXBean.setLoggerLevel(loggerName,levelName) end
...
function LoggingMXBean.getParentLoggerName(loggerName) end
