...
function PolicySpi.engineImplies(self, domain,permission) end

---@return void # 
function PolicySpi.engineRefresh(self, ) end
...
function PolicySpi.engineGetPermissions(self, codesource) end
...
function PolicySpi.engineGetPermissions(self, domain) end
