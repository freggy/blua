...
function Trie2_16.createFromSerialized(self, bytes) end

---@param codePoint int the code point
---@return int # the value
function Trie2_16.get(self, codePoint) end

---@param codeUnit char a 16 bit code unit or lead surrogate value.
---@return int # the value
function Trie2_16.getFromU16SingleLead(self, codeUnit) end

---@return int # the number of bytes of the serialized trie
function Trie2_16.getSerializedLength(self, ) end
