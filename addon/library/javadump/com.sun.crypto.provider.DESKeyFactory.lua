...
function DESKeyFactory.engineGenerateSecret(self, keySpec) end
...
function DESKeyFactory.engineGetKeySpec(self, key,keySpec) end
...
function DESKeyFactory.engineTranslateKey(self, key) end
