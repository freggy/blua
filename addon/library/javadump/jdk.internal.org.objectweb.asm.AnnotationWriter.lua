...
function AnnotationWriter.create(self, symbolTable,descriptor,previousAnnotation) end
...
function AnnotationWriter.create(self, symbolTable,typeRef,typePath,descriptor,previousAnnotation) end

---@param name java.lang.String 
---@param value java.lang.Object 
---@return void # 
function AnnotationWriter.visit(self, name,value) end

---@param name java.lang.String 
---@param descriptor java.lang.String 
---@param value java.lang.String 
---@return void # 
function AnnotationWriter.visitEnum(self, name,descriptor,value) end

---@param name java.lang.String 
---@param descriptor java.lang.String 
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # 
function AnnotationWriter.visitAnnotation(self, name,descriptor) end

---@param name java.lang.String 
---@return jdk.internal.org.objectweb.asm.AnnotationVisitor # 
function AnnotationWriter.visitArray(self, name) end

---@return void # 
function AnnotationWriter.visitEnd(self, ) end
...
function AnnotationWriter.computeAnnotationsSize(self, attributeName) end
...
function AnnotationWriter.computeAnnotationsSize(self, lastRuntimeVisibleAnnotation,lastRuntimeInvisibleAnnotation,lastRuntimeVisibleTypeAnnotation,lastRuntimeInvisibleTypeAnnotation) end
...
---@return void # 
function AnnotationWriter.putAnnotations(self, attributeNameIndex,output) end
...
---@return void # 
function AnnotationWriter.putAnnotations(self, symbolTable,lastRuntimeVisibleAnnotation,lastRuntimeInvisibleAnnotation,lastRuntimeVisibleTypeAnnotation,lastRuntimeInvisibleTypeAnnotation,output) end
...
function AnnotationWriter.computeParameterAnnotationsSize(self, attributeName,annotationWriters,annotableParameterCount) end
...
---@param output jdk.internal.org.objectweb.asm.ByteVector where the attribute must be put.
---@return void # 
function AnnotationWriter.putParameterAnnotations(self, attributeNameIndex,annotationWriters,annotableParameterCount,output) end
