...
function PipelineHelper.getSourceShape() end

---@return int # the combined stream and operation flags
function PipelineHelper.getStreamAndOpFlags() end
...
function PipelineHelper.exactOutputSizeIfKnown(spliterator) end
...
---@return S # 
function PipelineHelper.wrapAndCopyInto(sink,spliterator) end
...
---@return void # 
function PipelineHelper.copyInto(wrappedSink,spliterator) end

---@param wrappedSink java.util.stream.Sink the destination {@code Sink}
---@param spliterator java.util.Spliterator the source {@code Spliterator}
---@return boolean # true if the cancellation was requested
function PipelineHelper.copyIntoWithCancel(wrappedSink,spliterator) end
...
function PipelineHelper.wrapSink(sink) end

---@param spliterator java.util.Spliterator 
---@return java.util.Spliterator # 
function PipelineHelper.wrapSpliterator(spliterator) end
...
function PipelineHelper.makeNodeBuilder(exactSizeIfKnown,generator) end
...
function PipelineHelper.evaluate(spliterator,flatten,generator) end
