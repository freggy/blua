...
---@return void # 
function JSRInlinerAdapter.visitJumpInsn(opcode,label) end

---@return void # 
function JSRInlinerAdapter.visitEnd() end

---@return void # 
function JSRInlinerAdapter.findSubroutinesInsns() end
...
---@return void # 
function JSRInlinerAdapter.findSubroutineInsns(startInsnIndex,subroutineInsns,visitedInsns) end

---@param insnIndex int the index of an instruction of the subroutine.
---@param subroutineInsns java.util.BitSet where the indices of the instructions of the subroutine must be stored.
---@param visitedInsns java.util.BitSet the indices of the instructions that have been visited so far (including in     previous calls to this method). This bitset is updated by this method each time a new     instruction is visited. It is used to make sure each instruction is visited at most once.
---@return void # 
function JSRInlinerAdapter.findReachableInsns(insnIndex,subroutineInsns,visitedInsns) end

---@return void # 
function JSRInlinerAdapter.emitCode() end
...
---@return void # 
function JSRInlinerAdapter.emitInstantiation(instantiation,worklist,newInstructions,newTryCatchBlocks,newLocalVariables) end
