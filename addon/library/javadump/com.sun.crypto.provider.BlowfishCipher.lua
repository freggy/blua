...
function BlowfishCipher.engineGetIV(self, ) end
...
function BlowfishCipher.engineGetParameters(self, ) end
...
---@return void # 
function BlowfishCipher.engineInit(self, opmode,key,random) end
...
---@param random java.security.SecureRandom the source of randomness
---@return void # 
function BlowfishCipher.engineInit(self, opmode,key,params,random) end
...
function BlowfishCipher.engineUpdate(self, input,inputOffset,inputLen) end
...
function BlowfishCipher.engineUpdate(self, input,inputOffset,inputLen,output,outputOffset) end

---@param input byte[] the input buffer
---@param inputOffset int the offset in <code>input</code> where the input starts
---@param inputLen int the input length
---@return byte[] # the new buffer with the result
function BlowfishCipher.engineDoFinal(self, input,inputOffset,inputLen) end
...
---@param outputOffset int the offset in <code>output</code> where the result is stored
---@return int # the number of bytes stored in <code>output</code>
function BlowfishCipher.engineDoFinal(self, input,inputOffset,inputLen,output,outputOffset) end

---@param key java.security.Key the key object.
---@return int # the key size of the given key object.
function BlowfishCipher.engineGetKeySize(self, key) end

---@param key java.security.Key the key to be wrapped.
---@return byte[] # the wrapped key.
function BlowfishCipher.engineWrap(self, key) end
...
function BlowfishCipher.engineUnwrap(self, wrappedKey,wrappedKeyAlgorithm,wrappedKeyType) end
