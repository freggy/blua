...
function ResourceDecompressorRepository.newResourceDecompressor(self, properties,name) end

---@param factory jdk.internal.jimage.decompressor.ResourceDecompressorFactory 
---@return void # 
function ResourceDecompressorRepository.registerReaderProvider(self, factory) end
