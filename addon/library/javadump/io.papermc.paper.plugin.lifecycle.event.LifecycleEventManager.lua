...
---@return void # 
function LifecycleEventManager.registerEventHandler(self, eventType,eventHandler) end
...
---@return void # 
function LifecycleEventManager.registerEventHandler(self, handlerConfiguration) end
