...
function FieldRepository.parse(self, s) end
...
function FieldRepository.make(self, rawSig,f) end

---@return java.lang.reflect.Type # 
function FieldRepository.getGenericType(self, ) end

---@return java.lang.reflect.Type # 
function FieldRepository.computeGenericType(self, ) end
