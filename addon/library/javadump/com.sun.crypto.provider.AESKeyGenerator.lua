...
---@return void # 
function AESKeyGenerator.engineInit(self, random) end
...
---@return void # 
function AESKeyGenerator.engineInit(self, params,random) end

---@param keysize int the keysize. This is an algorithm-specific metric specified in number of bits.
---@param random java.security.SecureRandom the source of randomness for this key generator
---@return void # 
function AESKeyGenerator.engineInit(self, keysize,random) end

---@return javax.crypto.SecretKey # the new AES key
function AESKeyGenerator.engineGenerateKey(self, ) end
