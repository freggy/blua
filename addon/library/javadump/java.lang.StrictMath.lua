...
function StrictMath.ceil(a) end
...
function StrictMath.floor(a) end
...
---@return double # 
function StrictMath.floorOrCeil(a,negativeBoundary,positiveBoundary,sign) end

---@param a double a value.
---@return double # the closest floating-point value to {@code a} that is          equal to a mathematical integer.
function StrictMath.rint(a) end
...
function StrictMath.round(a) end
...
function StrictMath.random() end

---@param x int the first value
---@param y int the second value
---@return int # the result
function StrictMath.addExact(x,y) end
...
---@return int # the result
function StrictMath.subtractExact(x,y) end
...
---@param y int the second value
---@return int # the result
function StrictMath.multiplyExact(x,y) end
...
function StrictMath.divideExact(x,y) end
...
function StrictMath.floorDivExact(x,y) end
...
function StrictMath.ceilDivExact(x,y) end
...
---@return int # the result
function StrictMath.incrementExact(a) end
...
---@return int # the result
function StrictMath.decrementExact(a) end
...
---@return int # the result
function StrictMath.negateExact(a) end
...
function StrictMath.toIntExact(value) end

---@param x int the first value
---@param y int the second value
---@return long # the result
function StrictMath.multiplyFull(x,y) end

---@param x long the first value
---@param y long the second value
---@return long # the result
function StrictMath.multiplyHigh(x,y) end

---@param x long the first value
---@param y long the second value
---@return long # the result
function StrictMath.unsignedMultiplyHigh(x,y) end

---@param x int the dividend
---@param y int the divisor
---@return int # the largest (closest to positive infinity) {@code int} value that is less than or equal to the algebraic quotient.
function StrictMath.floorDiv(x,y) end
...
function StrictMath.floorMod(x,y) end
...
---@param y int the divisor
---@return int # the smallest (closest to negative infinity) {@code int} value that is greater than or equal to the algebraic quotient.
function StrictMath.ceilDiv(x,y) end
...
function StrictMath.ceilMod(x,y) end
...
function StrictMath.max(a,b) end
...
function StrictMath.min(a,b) end
...
function StrictMath.clamp(value,min,max) end
...
function StrictMath.fma(a,b,c) end
...
function StrictMath.hypot(x,y) end
...
function StrictMath.copySign(magnitude,sign) end
...
function StrictMath.getExponent(f) end

---@param d double a {@code double} value
---@return int # the unbiased exponent of the argument
function StrictMath.getExponent(d) end
...
function StrictMath.nextAfter(start,direction) end
...
function StrictMath.scalb(d,scaleFactor) end
...
function StrictMath.scalb(f,scaleFactor) end
