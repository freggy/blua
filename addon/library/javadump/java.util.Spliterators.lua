...
function Spliterators.emptySpliterator(self, ) end

---@return java.util.Spliterator.OfInt # An empty spliterator
function Spliterators.emptyIntSpliterator(self, ) end

---@return java.util.Spliterator.OfLong # An empty spliterator
function Spliterators.emptyLongSpliterator(self, ) end

---@return java.util.Spliterator.OfDouble # An empty spliterator
function Spliterators.emptyDoubleSpliterator(self, ) end
...
function Spliterators.spliterator(self, array,additionalCharacteristics) end
...
---@param additionalCharacteristics int Additional spliterator characteristics        of this spliterator's source or elements beyond {@code SIZED} and        {@code SUBSIZED} which are always reported
---@return java.util.Spliterator # A spliterator for an array
function Spliterators.spliterator(self, array,fromIndex,toIndex,additionalCharacteristics) end
...
---@return void # 
function Spliterators.checkFromToBounds(self, arrayLength,origin,fence) end
...
function Spliterators.spliterator(self, c,characteristics) end
...
---@param characteristics int Characteristics of this spliterator's source or        elements.  The characteristics {@code SIZED} and {@code SUBSIZED}        are additionally reported unless {@code CONCURRENT} is supplied.
---@return java.util.Spliterator # A spliterator from an iterator
function Spliterators.spliterator(self, iterator,size,characteristics) end
...
---@return java.util.Spliterator # A spliterator from an iterator
function Spliterators.spliteratorUnknownSize(self, iterator,characteristics) end
...
function Spliterators.iterator(self, spliterator) end
