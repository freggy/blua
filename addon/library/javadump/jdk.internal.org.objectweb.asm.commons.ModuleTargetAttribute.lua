...
function ModuleTargetAttribute.read(classReader,offset,length,charBuffer,codeOffset,labels) end
...
function ModuleTargetAttribute.write(classWriter,code,codeLength,maxStack,maxLocals) end
