...
function DualPivotQuicksort.getDepth(self, parallelism,size) end
...
---@return void # 
function DualPivotQuicksort.sort(self, a,parallelism,low,high) end
...
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.sort(self, sorter,a,bits,low,high) end
...
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.mixedInsertionSort(self, a,low,end,high) end

---@param a int[] the array to be sorted
---@param low int the index of the first element, inclusive, to be sorted
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.insertionSort(self, a,low,high) end

---@param a int[] the array to be sorted
---@param low int the index of the first element, inclusive, to be sorted
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.heapSort(self, a,low,high) end
...
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.pushDown(self, a,p,value,low,high) end
...
function DualPivotQuicksort.tryMergeRuns(self, sorter,a,low,size) end
...
function DualPivotQuicksort.mergeRuns(self, a,b,offset,aim,parallel,run,lo,hi) end
...
---@return void # 
function DualPivotQuicksort.mergeParts(self, merger,dst,k,a1,lo1,hi1,a2,lo2,hi2) end
...
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.sort(self, a,low,high) end
...
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.countingSort(self, a,low,high) end
...
---@param high int the index of the last element, exclusive, to be sorted
---@return void # 
function DualPivotQuicksort.sort(self, a,bits,low,high) end
