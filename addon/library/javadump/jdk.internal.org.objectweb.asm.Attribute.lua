...
function Attribute.getLabels() end
...
function Attribute.read(classReader,offset,length,charBuffer,codeAttributeOffset,labels) end
...
function Attribute.write(classWriter,code,codeLength,maxStack,maxLocals) end

---@return int # the number of attributes of the attribute list that begins with this attribute.
function Attribute.getAttributeCount() end
...
function Attribute.computeAttributesSize(symbolTable) end
...
---@return int # the size of all the attributes in this attribute list. This size includes the size of     the attribute headers.
function Attribute.computeAttributesSize(symbolTable,code,codeLength,maxStack,maxLocals) end
...
function Attribute.computeAttributesSize(symbolTable,accessFlags,signatureIndex) end

---@param symbolTable jdk.internal.org.objectweb.asm.SymbolTable where the constants used in the attributes must be stored.
---@param output jdk.internal.org.objectweb.asm.ByteVector where the attributes must be written.
---@return void # 
function Attribute.putAttributes(symbolTable,output) end
...
---@param output jdk.internal.org.objectweb.asm.ByteVector where the attributes must be written.
---@return void # 
function Attribute.putAttributes(symbolTable,code,codeLength,maxStack,maxLocals,output) end
...
---@param output jdk.internal.org.objectweb.asm.ByteVector where the attributes must be written.
---@return void # 
function Attribute.putAttributes(symbolTable,accessFlags,signatureIndex,output) end
