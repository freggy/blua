...
function MethodHandles.lookup(self, ) end

---@param caller java.lang.Class 
---@return java.lang.invoke.MethodHandles.Lookup # 
function MethodHandles.lookup(self, caller) end

---@return java.lang.invoke.MethodHandles.Lookup # a lookup object which is trusted minimally
function MethodHandles.publicLookup(self, ) end
...
function MethodHandles.privateLookupIn(self, targetClass,caller) end
...
function MethodHandles.classData(self, caller,name,type) end

---@param c java.lang.Class 
---@return java.lang.Object # 
function MethodHandles.classData(self, c) end
...
function MethodHandles.classDataAt(self, caller,name,type,index) end
...
function MethodHandles.reflectAs(self, expected,target) end
...
function MethodHandles.arrayElementSetter(self, arrayClass) end
...
function MethodHandles.arrayElementVarHandle(self, arrayClass) end
...
function MethodHandles.byteArrayViewVarHandle(self, viewArrayClass,byteOrder) end
...
function MethodHandles.byteBufferViewVarHandle(self, viewArrayClass,byteOrder) end
...
function MethodHandles.spreadInvoker(self, type,leadingArgCount) end

---@param type java.lang.invoke.MethodType the desired target type
---@return java.lang.invoke.MethodHandle # a method handle suitable for invoking any method handle of the given type
function MethodHandles.exactInvoker(self, type) end
...
function MethodHandles.invoker(self, type) end
...
function MethodHandles.varHandleExactInvoker(self, accessMode,type) end
...
function MethodHandles.varHandleInvoker(self, accessMode,type) end

---@param type java.lang.invoke.MethodType 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.basicInvoker(self, type) end
...
function MethodHandles.explicitCastArguments(self, target,newType) end

---@param target java.lang.invoke.MethodHandle 
---@param newType java.lang.invoke.MethodType 
---@return void # 
function MethodHandles.explicitCastArgumentsChecks(self, target,newType) end
...
function MethodHandles.permuteArguments(self, target,newType,reorder) end

---@param reorder int[] 
---@param newArity int 
---@return int # 
function MethodHandles.findFirstDupOrDrop(self, reorder,newArity) end

---@param reorder int[] 
---@param newType java.lang.invoke.MethodType 
---@param oldType java.lang.invoke.MethodType 
---@return boolean # 
function MethodHandles.permuteArgumentChecks(self, reorder,newType,oldType) end
...
function MethodHandles.constant(self, type,value) end
...
function MethodHandles.identity(self, type) end
...
function MethodHandles.zero(self, type) end

---@param type java.lang.Class 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.identityOrVoid(self, type) end
...
function MethodHandles.empty(self, type) end

---@param ptype java.lang.Class 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.makeIdentity(self, ptype) end

---@param btw sun.invoke.util.Wrapper 
---@param rtype java.lang.Class 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.zero(self, btw,rtype) end

---@param rtype java.lang.Class 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.makeZero(self, rtype) end

---@param cache MethodHandle[] 
---@param pos int 
---@param value java.lang.invoke.MethodHandle 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.setCachedMethodHandle(self, cache,pos,value) end
...
function MethodHandles.insertArguments(self, target,pos,values) end
...
function MethodHandles.insertArgumentPrimitive(self, result,pos,ptype,value) end

---@param target java.lang.invoke.MethodHandle 
---@param insCount int 
---@param pos int 
---@return Class<?>[] # 
function MethodHandles.insertArgumentsChecks(self, target,insCount,pos) end
...
function MethodHandles.dropArguments(self, target,pos,valueTypes) end

---@param target java.lang.invoke.MethodHandle 
---@param pos int 
---@param valueTypes Class<?>[] 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.dropArgumentsTrusted(self, target,pos,valueTypes) end

---@param oldType java.lang.invoke.MethodType 
---@param pos int 
---@param valueTypes Class<?>[] 
---@return int # 
function MethodHandles.dropArgumentChecks(self, oldType,pos,valueTypes) end
...
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.dropArguments(self, target,pos,valueType1) end
...
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.dropArguments(self, target,pos,valueType1,valueType2) end
...
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.dropArgumentsToMatch(self, target,skip,newTypes,pos,nullOnFailure) end
...
function MethodHandles.dropArgumentsToMatch(self, target,skip,newTypes,pos) end

---@param target java.lang.invoke.MethodHandle the method handle to adapt
---@return java.lang.invoke.MethodHandle # a possibly adapted method handle
function MethodHandles.dropReturn(self, target) end
...
function MethodHandles.filterArguments(self, target,pos,filters) end

---@param adapter java.lang.invoke.MethodHandle 
---@param filter java.lang.invoke.MethodHandle 
---@param positions int[] 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.filterRepeatedArgument(self, adapter,filter,positions) end

---@param target java.lang.invoke.MethodHandle 
---@param pos int 
---@param filter java.lang.invoke.MethodHandle 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.filterArgument(self, target,pos,filter) end

---@param target java.lang.invoke.MethodHandle 
---@param pos int 
---@param filters MethodHandle[] 
---@return void # 
function MethodHandles.filterArgumentsCheckArity(self, target,pos,filters) end

---@param target java.lang.invoke.MethodHandle 
---@param pos int 
---@param filter java.lang.invoke.MethodHandle 
---@return void # 
function MethodHandles.filterArgumentChecks(self, target,pos,filter) end
...
function MethodHandles.collectArguments(self, target,pos,filter) end

---@param target java.lang.invoke.MethodHandle 
---@param pos int 
---@param filter java.lang.invoke.MethodHandle 
---@return java.lang.invoke.MethodType # 
function MethodHandles.collectArgumentsChecks(self, target,pos,filter) end
...
function MethodHandles.filterReturnValue(self, target,filter) end

---@param targetType java.lang.invoke.MethodType 
---@param filterType java.lang.invoke.MethodType 
---@return void # 
function MethodHandles.filterReturnValueChecks(self, targetType,filterType) end

---@param target java.lang.invoke.MethodHandle 
---@param filter java.lang.invoke.MethodHandle 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.collectReturnValue(self, target,filter) end
...
function MethodHandles.foldArguments(self, target,combiner) end
...
---@param combiner java.lang.invoke.MethodHandle method handle to call initially on the incoming arguments
---@return java.lang.invoke.MethodHandle # method handle which incorporates the specified argument folding logic
function MethodHandles.foldArguments(self, target,pos,combiner) end

---@param foldPos int 
---@param targetType java.lang.invoke.MethodType 
---@param combinerType java.lang.invoke.MethodType 
---@return java.lang.Class # 
function MethodHandles.foldArgumentChecks(self, foldPos,targetType,combinerType) end
...
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.filterArgumentsWithCombiner(self, target,position,combiner,argPositions) end
...
---@param argPositions int 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.foldArgumentsWithCombiner(self, target,position,combiner,argPositions) end
...
---@param argPositions int 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.argumentsWithCombiner(self, filter,target,position,combiner,argPositions) end
...
---@param argPos int 
---@return java.lang.Class # 
function MethodHandles.argumentsWithCombinerChecks(self, position,filter,targetType,combinerType,argPos) end
...
function MethodHandles.guardWithTest(self, test,target,fallback) end

---@param what java.lang.String 
---@param t1 T 
---@param t2 T 
---@return java.lang.RuntimeException # 
function MethodHandles.misMatchedTypes(self, what,t1,t2) end
...
function MethodHandles.catchException(self, target,exType,handler) end
...
function MethodHandles.throwException(self, returnType,exType) end
...
function MethodHandles.loop(self, clauses) end

---@param clauses MethodHandle[][] 
---@return void # 
function MethodHandles.loopChecks0(self, clauses) end

---@param i int 
---@param in java.lang.invoke.MethodHandle 
---@param st java.lang.invoke.MethodHandle 
---@return void # 
function MethodHandles.loopChecks1a(self, i,in,st) end

---@param mhs java.util.stream.Stream 
---@param skipSize int 
---@return java.util.List # 
function MethodHandles.longestParameterList(self, mhs,skipSize) end
...
---@param cpSize int 
---@return java.util.List # 
function MethodHandles.buildCommonSuffix(self, init,step,pred,fini,cpSize) end

---@param init java.util.List 
---@param commonSuffix java.util.List 
---@return void # 
function MethodHandles.loopChecks1b(self, init,commonSuffix) end

---@param pred java.util.List 
---@param fini java.util.List 
---@param loopReturnType java.lang.Class 
---@return void # 
function MethodHandles.loopChecks1cd(self, pred,fini,loopReturnType) end
...
---@return void # 
function MethodHandles.loopChecks2(self, step,pred,fini,commonParameterSequence) end

---@param hs java.util.List 
---@param targetParams java.util.List 
---@return java.util.List # 
function MethodHandles.fillParameterTypes(self, hs,targetParams) end

---@param hs java.util.List 
---@return java.util.List # 
function MethodHandles.fixArities(self, hs) end
...
function MethodHandles.whileLoop(self, init,pred,body) end

---@param init java.lang.invoke.MethodHandle optional initializer, providing the initial value of the loop variable.             May be {@code null}, implying a default initial value.  See above for other constraints.
---@param body java.lang.invoke.MethodHandle body of the loop, which may not be {@code null}. It controls the loop parameters and result type.             See above for other constraints.
---@param pred java.lang.invoke.MethodHandle condition for the loop, which may not be {@code null}. Its result type must be {@code boolean}. See             above for other constraints.
---@return java.lang.invoke.MethodHandle # a method handle implementing the {@code while} loop as described by the arguments.
function MethodHandles.doWhileLoop(self, init,body,pred) end

---@param init java.lang.invoke.MethodHandle 
---@param pred java.lang.invoke.MethodHandle 
---@param body java.lang.invoke.MethodHandle 
---@return void # 
function MethodHandles.whileLoopChecks(self, init,pred,body) end
...
function MethodHandles.countedLoop(self, iterations,init,body) end
...
---@param body java.lang.invoke.MethodHandle body of the loop, which may not be {@code null}.             It controls the loop parameters and result type in the standard case (see above for details).             It must accept its own return type (if non-void) plus an {@code int} parameter (for the counter),             and may accept any number of additional types.             See above for other constraints.
---@return java.lang.invoke.MethodHandle # a method handle representing the loop.
function MethodHandles.countedLoop(self, start,end,init,body) end
...
---@param body java.lang.invoke.MethodHandle 
---@return void # 
function MethodHandles.countedLoopChecks(self, start,end,init,body) end
...
function MethodHandles.iteratedLoop(self, iterator,init,body) end

---@param iterator java.lang.invoke.MethodHandle 
---@param init java.lang.invoke.MethodHandle 
---@param body java.lang.invoke.MethodHandle 
---@return java.lang.Class # 
function MethodHandles.iteratedLoopChecks(self, iterator,init,body) end

---@param mh java.lang.invoke.MethodHandle 
---@param i int 
---@param j int 
---@return java.lang.invoke.MethodHandle # 
function MethodHandles.swapArguments(self, mh,i,j) end
...
function MethodHandles.tryFinally(self, target,cleanup) end

---@param target java.lang.invoke.MethodHandle 
---@param cleanup java.lang.invoke.MethodHandle 
---@return void # 
function MethodHandles.tryFinallyChecks(self, target,cleanup) end
...
function MethodHandles.tableSwitch(self, fallback,targets) end

---@param defaultCase java.lang.invoke.MethodHandle 
---@param caseActions MethodHandle[] 
---@return java.lang.invoke.MethodType # 
function MethodHandles.tableSwitchChecks(self, defaultCase,caseActions) end
...
function MethodHandles.memorySegmentViewVarHandle(self, layout) end
...
function MethodHandles.filterValue(self, target,filterToTarget,filterFromTarget) end
...
function MethodHandles.filterCoordinates(self, target,pos,filters) end
...
function MethodHandles.insertCoordinates(self, target,pos,values) end
...
function MethodHandles.permuteCoordinates(self, target,newCoordinates,reorder) end
...
function MethodHandles.collectCoordinates(self, target,pos,filter) end
...
function MethodHandles.dropCoordinates(self, target,pos,valueTypes) end
