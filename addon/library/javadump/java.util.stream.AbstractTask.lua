...
local AbstractTask = {}
---@return int # 
function AbstractTask.getLeafTarget() end
...
function AbstractTask.makeChild(spliterator) end

---@return R # the computed result of a leaf node
function AbstractTask.doLeaf() end

---@param sizeEstimate long 
---@return long # suggested target leaf size
function AbstractTask.suggestTargetSize(sizeEstimate) end

---@param sizeEstimate long 
---@return long # 
function AbstractTask.getTargetSize(sizeEstimate) end

---@return R # local result for this node previously stored with {@link #setLocalResult}
function AbstractTask.getRawResult() end
...
---@return void # 
function AbstractTask.setRawResult(result) end

---@return R # local result for this node previously stored with {@link #setLocalResult}
function AbstractTask.getLocalResult() end

---@param localResult R local result for this node
---@return void # 
function AbstractTask.setLocalResult(localResult) end

---@return boolean # {@code true} if this task is a leaf node
function AbstractTask.isLeaf() end

---@return boolean # {@code true} if this task is the root node.
function AbstractTask.isRoot() end

---@return K # the parent of this task, or null if this task is the root
function AbstractTask.getParent() end

---@return void # 
function AbstractTask.compute() end

---@param caller java.util.concurrent.CountedCompleter 
---@return void # 
function AbstractTask.onCompletion(caller) end

---@return boolean # {@code true} if this node is a "leftmost" node
function AbstractTask.isLeftmostNode() end
