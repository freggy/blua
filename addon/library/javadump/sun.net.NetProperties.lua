...
local NetProperties = {}
---@return void # 
function NetProperties.loadDefaultProperties() end
...
function NetProperties.get(key) end
...
function NetProperties.getInteger(key,defval) end

---@param key java.lang.String the property name.
---@return java.lang.Boolean # the <code>Boolean</code> value for the property,         or <code>null</code>
function NetProperties.getBoolean(key) end
