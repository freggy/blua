...
function SymbolLookup.find(name) end
...
function SymbolLookup.or(other) end
...
function SymbolLookup.loaderLookup() end
...
function SymbolLookup.libraryLookup(name,arena) end
...
function SymbolLookup.libraryLookup(path,arena) end

---@param libDesc Z 
---@param loadLibraryFunc java.util.function.BiFunction 
---@param libArena java.lang.foreign.Arena 
---@return java.lang.foreign.SymbolLookup # 
function SymbolLookup.libraryLookup(libDesc,loadLibraryFunc,libArena) end
