...
function LocaleNameProvider.getDisplayLanguage(self, languageCode,locale) end
...
function LocaleNameProvider.getDisplayScript(self, scriptCode,locale) end
...
function LocaleNameProvider.getDisplayCountry(self, countryCode,locale) end
...
function LocaleNameProvider.getDisplayVariant(self, variant,locale) end
...
function LocaleNameProvider.getDisplayUnicodeExtensionKey(self, key,locale) end
...
function LocaleNameProvider.getDisplayUnicodeExtensionType(self, type,key,locale) end
