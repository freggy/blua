...
---@return void # 
function DHParameterGenerator.checkSupport(self, keysize,exponentSize) end
...
---@return void # 
function DHParameterGenerator.engineInit(self, keysize,random) end

---@param genParamSpec java.security.spec.AlgorithmParameterSpec the set of parameter generation values
---@param random java.security.SecureRandom the source of randomness
---@return void # 
function DHParameterGenerator.engineInit(self, genParamSpec,random) end

---@return java.security.AlgorithmParameters # the new AlgorithmParameters object
function DHParameterGenerator.engineGenerateParameters(self, ) end
