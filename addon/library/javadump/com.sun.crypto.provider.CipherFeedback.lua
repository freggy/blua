...
function CipherFeedback.getFeedback() end
...
---@return void # 
function CipherFeedback.init(decrypting,algorithm,key,iv) end

---@return void # 
function CipherFeedback.reset() end

---@return void # 
function CipherFeedback.save() end

---@return void # 
function CipherFeedback.restore() end
...
function CipherFeedback.encrypt(plain,plainOffset,plainLen,cipher,cipherOffset) end
...
function CipherFeedback.encryptFinal(plain,plainOffset,plainLen,cipher,cipherOffset) end
...
function CipherFeedback.decrypt(cipher,cipherOffset,cipherLen,plain,plainOffset) end
...
---@param plainOffset int the offset in <code>plain</code>
---@return int # the length of the decrypted data
function CipherFeedback.decryptFinal(cipher,cipherOffset,cipherLen,plain,plainOffset) end
