...
function Set.toArray(self, a) end
...
function Set.remove(self, o) end
...
function Set.containsAll(self, c) end
...
function Set.of(self, e1,e2) end

---@param e1 E the first element
---@param e2 E the second element
---@param e3 E the third element
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3) end
...
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3,e4) end
...
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3,e4,e5) end
...
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3,e4,e5,e6) end
...
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3,e4,e5,e6,e7) end
...
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3,e4,e5,e6,e7,e8) end
...
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3,e4,e5,e6,e7,e8,e9) end
...
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, e1,e2,e3,e4,e5,e6,e7,e8,e9,e10) end

---@param elements E the elements to be contained in the set
---@return java.util.Set # a {@code Set} containing the specified elements
function Set.of(self, elements) end
...
function Set.copyOf(self, coll) end
