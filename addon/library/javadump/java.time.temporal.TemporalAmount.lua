...
function TemporalAmount.get(unit) end

---@return java.util.List # the List of {@code TemporalUnits}; not null
function TemporalAmount.getUnits() end
...
function TemporalAmount.addTo(temporal) end
...
function TemporalAmount.subtractFrom(temporal) end
