...
function NativeConstructorAccessorImpl.newInstance(args) end

---@return jdk.internal.reflect.DelegatingConstructorAccessorImpl # 
function NativeConstructorAccessorImpl.getParent() end

---@param c java.lang.reflect.Constructor 
---@param args Object[] 
---@return java.lang.Object # 
function NativeConstructorAccessorImpl.newInstance0(c,args) end
