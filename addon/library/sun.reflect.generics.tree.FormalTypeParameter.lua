...
function FormalTypeParameter.make(n,bs) end

---@return FieldTypeSignature[] # 
function FormalTypeParameter.getBounds() end

---@return java.lang.String # 
function FormalTypeParameter.getName() end

---@param v sun.reflect.generics.visitor.TypeTreeVisitor 
---@return void # 
function FormalTypeParameter.accept(v) end
