...
local StringReader = {}
---@return void # 
function StringReader.ensureOpen() end
...
function StringReader.read(cbuf,off,len) end

---@param n long {@inheritDoc}
---@return long # {@inheritDoc}
function StringReader.skip(n) end

---@return boolean # True if the next read() is guaranteed not to block for input
function StringReader.ready() end

---@return boolean # 
function StringReader.markSupported() end
...
---@return void # 
function StringReader.mark(readAheadLimit) end

---@return void # 
function StringReader.reset() end
