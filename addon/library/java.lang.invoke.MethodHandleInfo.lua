...
function MethodHandleInfo.reflectAs(expected,lookup) end

---@return int # the Java language modifiers for underlying member,         or -1 if the member cannot be accessed
function MethodHandleInfo.getModifiers() end

---@return boolean # 
function MethodHandleInfo.isVarArgs() end
...
function MethodHandleInfo.referenceKindToString(referenceKind) end
...
function MethodHandleInfo.toString(kind,defc,name,type) end
