...
function StatusResponseManager.getIgnoreExtensions() end

---@return void # 
function StatusResponseManager.clear() end

---@return int # the number of valid objects in the response cache.
function StatusResponseManager.size() end
...
function StatusResponseManager.getURI(cert) end

---@return void # 
function StatusResponseManager.shutdown() end
...
function StatusResponseManager.get(type,request,chain,delay,unit) end
...
function StatusResponseManager.getFromCache(cid,ocspRequest) end

---@return java.lang.String # 
function StatusResponseManager.toString() end

---@param shc sun.security.ssl.ServerHandshakeContext 
---@return sun.security.ssl.StatusResponseManager.StaplingParameters # 
function StatusResponseManager.processStapling(shc) end
