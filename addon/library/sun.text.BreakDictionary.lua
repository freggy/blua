...
---@return void # 
function BreakDictionary.setupDictionary(dictionaryName,dictionaryData) end
...
function BreakDictionary.getNextStateFromCharacter(row,ch) end
...
function BreakDictionary.getNextState(row,col) end

---@param row int 
---@param col int 
---@return boolean # 
function BreakDictionary.cellIsPopulated(row,col) end
...
function BreakDictionary.internalAt(row,col) end
