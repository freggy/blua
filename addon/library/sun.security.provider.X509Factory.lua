...
function X509Factory.engineGenerateCertificate(is) end

---@param encoding byte[] 
---@return sun.security.x509.X509CertImpl # 
function X509Factory.cachedGetX509Cert(encoding) end

---@param in java.io.InputStream 
---@param bout java.io.ByteArrayOutputStream 
---@param length int 
---@return int # 
function X509Factory.readFully(in,bout,length) end
...
function X509Factory.intern(c) end
...
---@param encoding byte[] 
---@return V # 
function X509Factory.getFromCache(cache,encoding) end

---@param cache sun.security.util.Cache 
---@param encoding byte[] 
---@param value V 
---@return void # 
function X509Factory.addToCache(cache,encoding,value) end
...
function X509Factory.engineGenerateCertPath(inStream) end

---@param inStream java.io.InputStream an <code>InputStream</code> containing the data
---@param encoding java.lang.String the encoding used for the data
---@return java.security.cert.CertPath # a <code>CertPath</code> initialized with the data from the   <code>InputStream</code>
function X509Factory.engineGenerateCertPath(inStream,encoding) end
...
function X509Factory.engineGenerateCertPath(certificates) end
...
function X509Factory.engineGetCertPathEncodings() end
...
function X509Factory.engineGenerateCertificates(is) end
...
function X509Factory.engineGenerateCRL(is) end
...
function X509Factory.engineGenerateCRLs(is) end

---@param is java.io.InputStream 
---@return java.util.Collection # 
function X509Factory.parseX509orPKCS7Cert(is) end

---@param is java.io.InputStream 
---@return java.util.Collection # 
function X509Factory.parseX509orPKCS7CRL(is) end

---@param is java.io.InputStream the InputStream
---@return byte[] # byte block or null if end of stream
function X509Factory.readOneBlock(is) end

---@param header java.lang.String 
---@param footer java.lang.String 
---@return void # 
function X509Factory.checkHeaderFooter(header,footer) end
...
function X509Factory.readBERInternal(is,bout,tag) end
