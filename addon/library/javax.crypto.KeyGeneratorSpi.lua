...
---@return void # 
function KeyGeneratorSpi.engineInit(random) end
...
---@return void # 
function KeyGeneratorSpi.engineInit(params,random) end

---@param keysize int the keysize. This is an algorithm-specific metric, specified in number of bits.
---@param random java.security.SecureRandom the source of randomness for this key generator
---@return void # 
function KeyGeneratorSpi.engineInit(keysize,random) end

---@return javax.crypto.SecretKey # the new key
function KeyGeneratorSpi.engineGenerateKey() end
