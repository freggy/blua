...
function LinuxRISCV64CallArranger.getBindings(mt,cDesc,forUpcall) end
...
---@return jdk.internal.foreign.abi.riscv64.linux.LinuxRISCV64CallArranger.Bindings # 
function LinuxRISCV64CallArranger.getBindings(mt,cDesc,forUpcall,options) end

---@param mt java.lang.invoke.MethodType 
---@param cDesc java.lang.foreign.FunctionDescriptor 
---@param options jdk.internal.foreign.abi.LinkerOptions 
---@return java.lang.invoke.MethodHandle # 
function LinuxRISCV64CallArranger.arrangeDowncall(mt,cDesc,options) end

---@param mt java.lang.invoke.MethodType 
---@param cDesc java.lang.foreign.FunctionDescriptor 
---@param options jdk.internal.foreign.abi.LinkerOptions 
---@return <unresolved> # 
function LinuxRISCV64CallArranger.arrangeUpcall(mt,cDesc,options) end

---@param returnLayout java.util.Optional 
---@return boolean # 
function LinuxRISCV64CallArranger.isInMemoryReturn(returnLayout) end
