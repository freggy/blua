...
local DigitList = {}
---@return boolean # 
function DigitList.isZero() end

---@param r java.math.RoundingMode 
---@return void # 
function DigitList.setRoundingMode(r) end
...
---@param digit char 
---@return void # 
function DigitList.append(digit) end
...
function DigitList.fitsIntoLong(isPositive,ignoreNegativeZero) end
...
---@return void # 
function DigitList.set(isNegative,source,maximumFractionDigits) end
...
---@return void # 
function DigitList.set(isNegative,source,maximumDigits,fixedPoint) end
...
---@return void # 
function DigitList.set(isNegative,s,roundedUp,valueExactAsDecimal,maximumDigits,fixedPoint) end
...
---@return void # 
function DigitList.round(maximumDigits,alreadyRounded,valueExactAsDecimal) end
...
function DigitList.shouldRoundUp(maximumDigits,alreadyRounded,valueExactAsDecimal) end

---@param isNegative boolean 
---@param source long 
---@return void # 
function DigitList.set(isNegative,source) end
...
---@return void # 
function DigitList.set(isNegative,source,maximumDigits) end
...
---@return boolean # 
function DigitList.equals(obj) end
...
---@return boolean # 
function DigitList.isLongMIN_VALUE() end

---@param str char[] 
---@param offset int 
---@param strLen int 
---@return int # 
function DigitList.parseInt(str,offset,strLen) end

---@return java.lang.String # 
function DigitList.toString() end

---@return java.lang.StringBuilder # 
function DigitList.getStringBuilder() end

---@param len int 
---@return void # 
function DigitList.extendDigits(len) end

---@param length int 
---@return char[] # 
function DigitList.getDataChars(length) end
