...
function Carriers.reshapeInitializer(carrierShape,initializer) end
...
function Carriers.reshapeComponents(carrierShape,components) end
...
function Carriers.carrierClass(methodType) end

---@param methodType java.lang.invoke.MethodType {@link MethodType} whose parameter types supply the shape of the                    carrier's components
---@return java.lang.invoke.MethodHandle # 
function Carriers.constructor(methodType) end

---@param methodType java.lang.invoke.MethodType {@link MethodType} whose parameter types supply the shape of the                    carrier's components
---@return java.lang.invoke.MethodHandle # 
function Carriers.initializer(methodType) end

---@param methodType java.lang.invoke.MethodType {@link MethodType} whose parameter types supply the shape of the                    carrier's components
---@return java.lang.invoke.MethodHandle # 
function Carriers.initializingConstructor(methodType) end

---@param methodType java.lang.invoke.MethodType {@link MethodType} whose parameter types supply the shape of the                    carrier's components
---@return java.util.List # 
function Carriers.components(methodType) end

---@param methodType java.lang.invoke.MethodType {@link MethodType} whose parameter types supply the shape of the                    carrier's components
---@param i int component index
---@return java.lang.invoke.MethodHandle # 
function Carriers.component(methodType,i) end
