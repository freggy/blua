...
---@return void # 
function DTDHandler.notationDecl(name,publicId,systemId) end
...
---@return void # 
function DTDHandler.unparsedEntityDecl(name,publicId,systemId,notationName) end
...
---@return void # 
function DTDHandler.startDTD(name,publicId,systemId) end

---@return void # 
function DTDHandler.startInternalSub() end
