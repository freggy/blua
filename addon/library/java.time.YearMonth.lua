...
function YearMonth.of(year,month) end
...
---@return java.time.YearMonth # the year-month, not null
function YearMonth.from(temporal) end
...
function YearMonth.parse(text) end
...
---@return java.time.YearMonth # the parsed year-month, not null
function YearMonth.parse(text,formatter) end
...
---@return java.time.YearMonth # the year-month, not null
function YearMonth.with(newYear,newMonth) end
...
function YearMonth.isSupported(field) end
...
function YearMonth.isSupported(unit) end
...
function YearMonth.isValidDay(dayOfMonth) end

---@return int # the length of the month in days, from 28 to 31
function YearMonth.lengthOfMonth() end

---@return int # 366 if the year is leap, 365 otherwise
function YearMonth.lengthOfYear() end
...
function YearMonth.with(adjuster) end
...
function YearMonth.with(field,newValue) end
...
function YearMonth.withYear(year) end
...
function YearMonth.withMonth(month) end
...
function YearMonth.plus(amountToAdd) end
...
function YearMonth.plus(amountToAdd,unit) end
...
function YearMonth.plusYears(yearsToAdd) end
...
function YearMonth.plusMonths(monthsToAdd) end
...
function YearMonth.minus(amountToSubtract) end
...
function YearMonth.minus(amountToSubtract,unit) end
...
function YearMonth.minusYears(yearsToSubtract) end
...
function YearMonth.minusMonths(monthsToSubtract) end
...
function YearMonth.query(query) end
...
function YearMonth.adjustInto(temporal) end
...
function YearMonth.until(endExclusive,unit) end

---@param formatter java.time.format.DateTimeFormatter the formatter to use, not null
---@return java.lang.String # the formatted year-month string, not null
function YearMonth.format(formatter) end
...
function YearMonth.atDay(dayOfMonth) end

---@return java.time.LocalDate # the last valid date of this year-month, not null
function YearMonth.atEndOfMonth() end
