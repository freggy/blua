...
local OCSPResponse = {}
---@return int # 
function OCSPResponse.initializeClockSkew() end
...
---@return void # 
function OCSPResponse.verify(certIds,issuerInfo,responderCert,date,nonce,variant) end

---@return sun.security.provider.certpath.OCSPResponse.ResponseStatus # the {@code ResponseStatus} for this OCSP response
function OCSPResponse.getResponseStatus() end

---@param cert java.security.cert.X509Certificate 
---@return boolean # 
function OCSPResponse.verifySignature(cert) end
...
function OCSPResponse.getSingleResponse(certId) end

---@return java.util.Set # an unmodifiable set containing every {@code CertId} in this      response.
function OCSPResponse.getCertIds() end

---@return java.security.cert.X509Certificate # 
function OCSPResponse.getSignerCertificate() end
...
function OCSPResponse.parseExtensions(derVal) end
