...
function CertificateFactorySpi.engineGenerateCertificate(inStream) end
...
function CertificateFactorySpi.engineGenerateCertPath(inStream) end

---@param inStream java.io.InputStream an {@code InputStream} containing the data
---@param encoding java.lang.String the encoding used for the data
---@return java.security.cert.CertPath # a {@code CertPath} initialized with the data from the   {@code InputStream}
function CertificateFactorySpi.engineGenerateCertPath(inStream,encoding) end
...
function CertificateFactorySpi.engineGenerateCertPath(certificates) end
...
function CertificateFactorySpi.engineGenerateCertificates(inStream) end
...
function CertificateFactorySpi.engineGenerateCRL(inStream) end
...
function CertificateFactorySpi.engineGenerateCRLs(inStream) end
