...
function TimeZone.getOffset(era,year,month,day,dayOfWeek,milliseconds) end
...
function TimeZone.getOffset(date) end
...
function TimeZone.getOffsets(date,offsets) end

---@param offsetMillis int the given base time zone offset to GMT.
---@return void # 
function TimeZone.setRawOffset(offsetMillis) end
...
---@return void # 
function TimeZone.setID(ID) end
...
function TimeZone.getDisplayName(locale) end
...
---@return java.lang.String # the human-readable name of this time zone in the default locale.
function TimeZone.getDisplayName(daylight,style) end

---@param daylight boolean {@code true} specifying a Daylight Saving Time name, or                 {@code false} specifying a Standard Time name
---@param style int either {@link #LONG} or {@link #SHORT}
---@param locale java.util.Locale the locale in which to supply the display name.
---@return java.lang.String # the human-readable name of this time zone in the given locale.
function TimeZone.getDisplayName(daylight,style,locale) end

---@param id java.lang.String 
---@param locale java.util.Locale 
---@return String[] # 
function TimeZone.getDisplayNames(id,locale) end
...
function TimeZone.inDaylightTime(date) end
...
function TimeZone.toZoneId0() end

---@param ID java.lang.String 
---@param fallback boolean 
---@return java.util.TimeZone # 
function TimeZone.getTimeZone(ID,fallback) end
...
function TimeZone.getAvailableIDs(rawOffset) end
...
function TimeZone.getSystemTimeZoneID(javaHome) end

---@return java.lang.String # 
function TimeZone.getSystemGMTOffsetID() end

---@return java.util.TimeZone # the default {@code TimeZone}
function TimeZone.getDefault() end

---@return java.util.TimeZone # 
function TimeZone.getDefaultRef() end

---@return java.util.TimeZone # 
function TimeZone.setDefaultZone() end

---@param zone java.util.TimeZone the new default {@code TimeZone}, or null
---@return void # 
function TimeZone.setDefault(zone) end
...
function TimeZone.hasSameRules(other) end
...
function TimeZone.parseCustomTimeZone(id) end
