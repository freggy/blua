...
---@return void # 
function OIDMap.addInternal(name,oid,className) end
...
---@return void # 
function OIDMap.addAttribute(name,oid,clazz) end
...
function OIDMap.getName(oid) end
...
function OIDMap.getOID(name) end

---@param name java.lang.String the user-friendly name.
---@return java.lang.Class # 
function OIDMap.getClass(name) end

---@param oid sun.security.util.ObjectIdentifier the name of the object identifier to be returned.
---@return java.lang.Class # 
function OIDMap.getClass(oid) end
