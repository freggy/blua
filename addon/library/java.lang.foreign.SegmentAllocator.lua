...
function SegmentAllocator.allocateUtf8String(str) end
...
function SegmentAllocator.allocate(layout,value) end
...
---@return java.lang.foreign.MemorySegment # a segment for the newly allocated memory block.
function SegmentAllocator.allocateArray(elementLayout,elements) end
...
function SegmentAllocator.slicingAllocator(segment) end
...
function SegmentAllocator.prefixAllocator(segment) end
