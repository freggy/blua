...
function SecureDirectoryStream.newDirectoryStream(path,options) end
...
function SecureDirectoryStream.newByteChannel(path,options,attrs) end

---@param path T the path of the file to delete
---@return void # 
function SecureDirectoryStream.deleteFile(path) end

---@param path T the path of the directory to delete
---@return void # 
function SecureDirectoryStream.deleteDirectory(path) end
...
---@return void # 
function SecureDirectoryStream.move(srcpath,targetdir,targetpath) end
...
function SecureDirectoryStream.getFileAttributeView(type) end

---@param path T the path of the file
---@param type java.lang.Class the {@code Class} object corresponding to the file attribute view
---@param options java.nio.file.LinkOption options indicating how symbolic links are handled
---@return V # a new file attribute view of the specified type bound to          this directory stream, or {@code null} if the attribute view          type is not available
function SecureDirectoryStream.getFileAttributeView(path,type,options) end
