...
---@param def int 
---@return int # 
function URICertStore.initializeTimeout(prop,def) end

---@param params java.security.cert.URICertStoreParameters 
---@return java.security.cert.CertStore # 
function URICertStore.getInstance(params) end

---@param ad sun.security.x509.AccessDescription 
---@return java.security.cert.CertStore # 
function URICertStore.getInstance(ad) end
...
function URICertStore.engineGetCertificates(selector) end

---@param certs java.util.Collection 
---@param selector java.security.cert.CertSelector 
---@return java.util.Collection # 
function URICertStore.getMatchingCerts(certs,selector) end
...
function URICertStore.engineGetCRLs(selector) end

---@param crl java.security.cert.X509CRL 
---@param selector java.security.cert.CRLSelector 
---@return java.util.Collection # 
function URICertStore.getMatchingCRLs(crl,selector) end
