...
function AbstractQueue.add(e) end

---@return E # the head of this queue
function AbstractQueue.remove() end

---@return E # the head of this queue
function AbstractQueue.element() end

---@return void # 
function AbstractQueue.clear() end
...
function AbstractQueue.addAll(c) end
