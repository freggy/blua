...
function TypeReference.newTypeReference(sort) end
...
function TypeReference.newTypeParameterReference(sort,paramIndex) end
...
function TypeReference.newTypeParameterBoundReference(sort,paramIndex,boundIndex) end
...
function TypeReference.newSuperTypeReference(itfIndex) end
...
function TypeReference.newFormalParameterReference(paramIndex) end
...
function TypeReference.newExceptionReference(exceptionIndex) end
...
---@return jdk.internal.org.objectweb.asm.TypeReference # a reference to the type of the given exception.
function TypeReference.newTryCatchReference(tryCatchBlockIndex) end
...
function TypeReference.newTypeArgumentReference(sort,argIndex) end
...
function TypeReference.getSort() end

---@return int # a type parameter index.
function TypeReference.getTypeParameterIndex() end

---@return int # a type parameter bound index.
function TypeReference.getTypeParameterBoundIndex() end
...
function TypeReference.getSuperTypeIndex() end

---@return int # a formal parameter index.
function TypeReference.getFormalParameterIndex() end

---@return int # the index of an exception in the 'throws' clause of a method.
function TypeReference.getExceptionIndex() end

---@return int # the index of an exception in the 'throws' clause of a method.
function TypeReference.getTryCatchBlockIndex() end

---@return int # a type parameter index.
function TypeReference.getTypeArgumentIndex() end

---@return int # the int encoded value of this type reference.
function TypeReference.getValue() end
...
---@return void # 
function TypeReference.putTarget(targetTypeAndInfo,output) end
