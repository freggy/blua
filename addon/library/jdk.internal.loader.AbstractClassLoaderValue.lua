...
function AbstractClassLoaderValue.sub(key) end
...
function AbstractClassLoaderValue.isEqualOrDescendantOf(clv) end
...
function AbstractClassLoaderValue.get(cl) end

---@param cl java.lang.ClassLoader the ClassLoader for the associated value
---@param v V the value to associate
---@return V # previously associated value or null if there was none
function AbstractClassLoaderValue.putIfAbsent(cl,v) end
...
function AbstractClassLoaderValue.remove(cl,v) end
...
function AbstractClassLoaderValue.extractValue(memoizerOrValue) end
