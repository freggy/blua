...
function TypeAnnotationParser.buildAnnotatedType(rawAnnotations,cp,decl,container,type,filter) end
...
function TypeAnnotationParser.buildAnnotatedTypes(rawAnnotations,cp,decl,container,types,filter) end

---@param rawAnnotations byte[] the byte[] encoding of all type annotations on this declaration
---@param cp jdk.internal.reflect.ConstantPool the ConstantPool needed to parse the embedded Annotation
---@param decl java.lang.Class the Class which annotated supertype is being built
---@return java.lang.reflect.AnnotatedType # 
function TypeAnnotationParser.buildAnnotatedSuperclass(rawAnnotations,cp,decl) end

---@param rawAnnotations byte[] the byte[] encoding of all type annotations on this declaration
---@param cp jdk.internal.reflect.ConstantPool the ConstantPool needed to parse the embedded Annotation
---@param decl java.lang.Class the Class whose annotated implemented interfaces is being built
---@return AnnotatedType[] # 
function TypeAnnotationParser.buildAnnotatedInterfaces(rawAnnotations,cp,decl) end
...
---@return Annotation[] # 
function TypeAnnotationParser.parseTypeVariableAnnotations(genericDecl,typeVarIndex) end
...
---@return AnnotatedType[] # 
function TypeAnnotationParser.parseAnnotatedBounds(bounds,decl,typeVarIndex) end
...
---@return AnnotatedType[] # 
function TypeAnnotationParser.parseAnnotatedBounds(bounds,decl,typeVarIndex,loc) end

---@param decl D 
---@return java.util.List # 
function TypeAnnotationParser.fetchBounds(decl) end

---@param decl java.lang.reflect.AnnotatedElement 
---@return TypeAnnotation[] # 
function TypeAnnotationParser.parseAllTypeAnnotations(decl) end
...
---@return TypeAnnotation[] # 
function TypeAnnotationParser.parseTypeAnnotations(rawAnnotations,cp,baseDecl,container) end

---@param typeAnnos TypeAnnotation[] 
---@return java.util.Map # 
function TypeAnnotationParser.mapTypeAnnotations(typeAnnos) end
...
function TypeAnnotationParser.parseTypeAnnotation(buf,cp,baseDecl,container) end

---@param buf java.nio.ByteBuffer 
---@return sun.reflect.annotation.TypeAnnotation.TypeAnnotationTargetInfo # 
function TypeAnnotationParser.parseTargetInfo(buf) end

---@param target sun.reflect.annotation.TypeAnnotation.TypeAnnotationTarget 
---@param buf java.nio.ByteBuffer 
---@return sun.reflect.annotation.TypeAnnotation.TypeAnnotationTargetInfo # 
function TypeAnnotationParser.parseShortTarget(target,buf) end

---@param target sun.reflect.annotation.TypeAnnotation.TypeAnnotationTarget 
---@param buf java.nio.ByteBuffer 
---@return sun.reflect.annotation.TypeAnnotation.TypeAnnotationTargetInfo # 
function TypeAnnotationParser.parse2ByteTarget(target,buf) end
