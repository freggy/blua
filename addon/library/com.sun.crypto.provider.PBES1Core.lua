...
function PBES1Core.getParameters() end
...
---@return void # 
function PBES1Core.init(opmode,key,params,random) end

---@param passwdBytes byte[] 
---@return byte[] # 
function PBES1Core.deriveCipherKey(passwdBytes) end
...
function PBES1Core.update(input,inputOffset,inputLen) end
...
function PBES1Core.update(input,inputOffset,inputLen,output,outputOffset) end

---@param input byte[] the input buffer
---@param inputOffset int the offset in <code>input</code> where the input starts
---@param inputLen int the input length
---@return byte[] # the new buffer with the result
function PBES1Core.doFinal(input,inputOffset,inputLen) end
...
---@param outputOffset int the offset in <code>output</code> where the result is stored
---@return int # the number of bytes stored in <code>output</code>
function PBES1Core.doFinal(input,inputOffset,inputLen,output,outputOffset) end

---@param key java.security.Key the key to be wrapped.
---@return byte[] # the wrapped key.
function PBES1Core.wrap(key) end
...
function PBES1Core.unwrap(wrappedKey,wrappedKeyAlgorithm,wrappedKeyType) end
