...
function ModuleHashesAttribute.read(classReader,offset,length,charBuffer,codeAttributeOffset,labels) end
...
function ModuleHashesAttribute.write(classWriter,code,codeLength,maxStack,maxLocals) end
