...
---@param seedLen int 
---@return BigInteger[] # 
function DSAParameterGenerator.generatePandQ(random,valueL,valueN,seedLen) end

---@param p java.math.BigInteger 
---@param q java.math.BigInteger 
---@return java.math.BigInteger # 
function DSAParameterGenerator.generateG(p,q) end

---@param bigInt java.math.BigInteger 
---@return byte[] # 
function DSAParameterGenerator.toByteArray(bigInt) end
