...
function ResponderId.getEncoded() end
...
function ResponderId.getType() end

---@return int # the length of the encoded {@code ResponderId}
function ResponderId.length() end
...
function ResponderId.getResponderName() end
...
function ResponderId.getKeyIdentifier() end
