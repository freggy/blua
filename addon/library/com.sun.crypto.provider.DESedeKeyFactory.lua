...
function DESedeKeyFactory.engineGenerateSecret(keySpec) end
...
function DESedeKeyFactory.engineGetKeySpec(key,keySpec) end
...
function DESedeKeyFactory.engineTranslateKey(key) end
