...
---@class java.time.chrono.ChronoLocalDateTime: java.time.temporal.Temporal 
...
function ChronoLocalDateTime.from(temporal) end
...
function ChronoLocalDateTime.isSupported(field) end
...
function ChronoLocalDateTime.isSupported(unit) end

---@param adjuster java.time.temporal.TemporalAdjuster 
---@return java.time.chrono.ChronoLocalDateTime # 
function ChronoLocalDateTime.with(adjuster) end

---@param field java.time.temporal.TemporalField 
---@param newValue long 
---@return java.time.chrono.ChronoLocalDateTime # 
function ChronoLocalDateTime.with(field,newValue) end

---@param amount java.time.temporal.TemporalAmount 
---@return java.time.chrono.ChronoLocalDateTime # 
function ChronoLocalDateTime.plus(amount) end

---@param amountToAdd long 
---@param unit java.time.temporal.TemporalUnit 
---@return java.time.chrono.ChronoLocalDateTime # 
function ChronoLocalDateTime.plus(amountToAdd,unit) end

---@param amount java.time.temporal.TemporalAmount 
---@return java.time.chrono.ChronoLocalDateTime # 
function ChronoLocalDateTime.minus(amount) end

---@param amountToSubtract long 
---@param unit java.time.temporal.TemporalUnit 
---@return java.time.chrono.ChronoLocalDateTime # 
function ChronoLocalDateTime.minus(amountToSubtract,unit) end
...
function ChronoLocalDateTime.query(query) end
...
function ChronoLocalDateTime.adjustInto(temporal) end
...
function ChronoLocalDateTime.format(formatter) end
...
function ChronoLocalDateTime.atZone(zone) end
...
function ChronoLocalDateTime.toInstant(offset) end

---@param offset java.time.ZoneOffset the offset to use for the conversion, not null
---@return long # the number of seconds from the epoch of 1970-01-01T00:00:00Z
function ChronoLocalDateTime.toEpochSecond(offset) end
