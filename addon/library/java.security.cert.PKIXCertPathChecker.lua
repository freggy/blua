...
---@return void # 
function PKIXCertPathChecker.init(forward) end

---@return boolean # {@code true} if forward checking is supported, {@code false} otherwise
function PKIXCertPathChecker.isForwardCheckingSupported() end
...
function PKIXCertPathChecker.getSupportedExtensions() end
...
---@return void # 
function PKIXCertPathChecker.check(cert,unresolvedCritExts) end

---@param cert java.security.cert.Certificate 
---@return void # 
function PKIXCertPathChecker.check(cert) end

---@return java.lang.Object # a copy of this {@code PKIXCertPathChecker}
function PKIXCertPathChecker.clone() end
