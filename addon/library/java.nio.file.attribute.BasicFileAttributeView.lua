...
function BasicFileAttributeView.name() end

---@return java.nio.file.attribute.BasicFileAttributes # the file attributes
function BasicFileAttributeView.readAttributes() end
...
---@return void # 
function BasicFileAttributeView.setTimes(lastModifiedTime,lastAccessTime,createTime) end
